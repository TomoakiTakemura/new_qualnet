...
/// AppAggregateTable column constants values
enum
{
    ...
    APP_AGGREGATE_TABLE_INTERVAL_BASED_UNI_MCR    = 22,
    APP_AGGREGATE_TABLE_INTERVAL_BASED_MULTI_MCR  = 23,
    APP_AGGREGATE_TABLE_INTERVAL_BASED_AVG_MCR    = 24,
    APP_AGGREGATE_TABLE_INTERVAL_BASED_AVG_DELAY  = 25,
    APP_AGGREGATE_TABLE_UNI_DELAY                 = 26,
    APP_AGGREGATE_TABLE_MULTI_DELAY               = 27,
    APP_AGGREGATE_TABLE_UNI_HOPCOUNT              = 28,
    APP_AGGREGATE_TABLE_MULTI_HOPCOUNT            = 29,
    APP_AGGREGATE_TABLE_AVG_DELAY                 = 30,
    APP_AGGREGATE_TABLE_AVG_THROUGHPUT            = 31,
    APP_AGGREGATE_TABLE_AVG_OFFERLOAD             = 32,
    APP_AGGREGATE_TABLE_UNI_JITTER                = 33,
    APP_AGGREGATE_TABLE_MULTI_JITTER              = 34,
    APP_AGGREGATE_TABLE_AVG_JITTER                = 35,

    APP_AGGREGATE_TABLE_MAX_COLUMNS               = 36,
    APP_AGGREGATE_TABLE_MAX_FIXED_COLUMNS         = 25
};
...
class STAT_GlobalAppStatisticsBridge : public DB_API_Bridge{
    ...
    public:
        ...
        std::string composeGlobalAppStatisticsUpdateSQLString(
            Node* node,
            PartitionData* partition,
            Int64 size,
            clocktype interval);  // compose the sql string;
