...
/// Structure storing MAODV option fields for IP header
typedef struct
{
    unsigned int pktId;
    NodeAddress srcId;
...
/// Structure storing Node address and sequence number
...
/// Structure storing neighbor information
...
/// Structure storing neighbor information table
...
/// Structure storing list for RST structure
typedef struct
{
...
/// Structure storing list for message buffer
typedef struct
{
...
/// Structure to store link list for Sent node entries
typedef struct
{
...
/// Direction of the link relative to the location of the group
/// leader
typedef enum
{
...
/// Structure to store next hops list
...
/// Structure to multicast route entry
...
/// Structure to multicast route table
...
/// Maodv structure for passing next hop
...
/// Multicast Group Leader Table or request table
...
/// route request packet type
#define MAODV_RREQ     1

/// route reply packet type
#define MAODV_RREP     2

/// Multicast group leader extension format
#define MAODV_MGLEXT   3

/// Multicast group Rebuild extension format
#define MAODV_MGREXT   4

/// Multicast group information extension format
...
/// Maodv route request message format
...
/// Maodv multicast group leader extension format
...
/// Maodv multicast group Rebuild extension format
...
/// Maodv route reply message format
...
/// Maodv multicast group Information extension format
...
/// Multicst Activation (MACT) Message Format
...
/// Structure to store the statistical informations of MAodv
typedef struct
{
...
/// maodv main structure to store all necessary informations
/// for MAodv
