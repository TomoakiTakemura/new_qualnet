...
void STAT_NetSummaryStatistics::InitializeFromOneHop(Node* node, OneHopNetworkData* stats)
{
    ...
    dataPacketsSent = (double)stats->oneHopStats.uDataPacketsSent;
    dataPacketsRecd = (double)stats->oneHopStats.uDataPacketsRecd;
    dataPacketsForward = (double)stats->oneHopStats.uDataPacketsForward;
    controlPacketsSent = (double)stats->oneHopStats.uControlPacketsSent;
    controlPacketsRecd = (double)stats->oneHopStats.uControlPacketsRecd;
    controlPacketsForward =
              (double)stats->oneHopStats.uControlPacketsForward;
    dataBytesSent = (double)stats->oneHopStats.uDataBytesSent;
    dataBytesRecd = (double)stats->oneHopStats.uDataBytesRecd;
    dataBytesForward = (double)stats->oneHopStats.uDataBytesForward;
    controlBytesSent = (double)stats->oneHopStats.uControlBytesSent;
    controlBytesRecd = (double)stats->oneHopStats.uControlBytesRecd;
    controlBytesForward = (double)stats->oneHopStats.uControlBytesForward;
