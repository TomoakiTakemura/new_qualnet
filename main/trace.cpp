...
// Write trace header information to the trace file
//
// \param nodeInput  Pointer to NodeInput
// \param fp         : FILE*  Trace file pointer
//
...
// Write trace Tail information to the trace file
//
// \param fp         : FILE*  Trace file pointer
//
...
void TRACE_Initialize(Node* node, const NodeInput* nodeInput)
{
    ...
    // Set layer tracing to FALSE by default.
    for (i = 0; i < TRACE_ALL_LAYERS; i++)
    {
        node->traceData->layer[i] = FALSE;
    }
...
// \param xmlPrintFn  protocol callback function
...
// Print XML trace information to file.
//
// \param node  Pointer to node, doing the packet trace
// \param message  packet to print trace info from
// \param layerType  what layer is calling this function
...
// \param message  packet to print trace info from
// \param layerType  what layer is calling this function
// \param pktDirection  in which direction trace will be done
// \param actionData  more details about the packet action
//
