...
{
    static const std::string sUnicast("Unicast");
    static const std::string sBroadcast("Broadcast");
    ...
    else
    {
        ...
        return sEmpty; // To remove warning
    }
}
...
void STAT_Statistic::AddToHierarchy(D_Hierarchy* h, const std::string& path)
{
...
void STAT_AggregatedSumVariant::AddDataPoint(clocktype /* now */, double val)
{
    m_Value += val;
    m_NumDataPoints++;
}
...
void STAT_AggregatedAverageVariant::AddDataPoint(clocktype /* now */, double val)
{
    m_Value += val;
    m_NumDataPoints++;
}
...
void STAT_AggregatedSumVariant::Serialize(clocktype /* now */, char** data, int* size)
{
    *data = (char*) MEM_malloc(sizeof(STAT_SimpleAggregationData));
    *size = sizeof(STAT_SimpleAggregationData);
    STAT_SimpleAggregationData* agg = (STAT_SimpleAggregationData*) *data;
    agg->m_Value = m_Value - old_Value;
    agg->m_NumDataPoints = m_NumDataPoints;
}

void STAT_AggregatedSumVariant::DeserializeAndUpdate(
    clocktype /* now */,
    char* data,
    int size)
{
...
void STAT_AggregatedSumVariant::Aggregate(clocktype /* now */)
{
    // No need to do anything here.
}


void STAT_AggregatedAverageVariant::Serialize(clocktype /* now */, char** data, int* size)
{
    *data = (char*) MEM_malloc(sizeof(STAT_SimpleAggregationData));
    *size = sizeof(STAT_SimpleAggregationData);
    STAT_SimpleAggregationData* agg = (STAT_SimpleAggregationData*) *data;
...
void STAT_AggregatedAverageVariant::DeserializeAndUpdate(
    clocktype /* now */,
    char* data,
    int size)
{
...
void STAT_AggregatedAverageVariant::Aggregate(clocktype /* now */)
{
    // No need to do anything here.
}
    ...
    int size)
{
    ...
    int totalStatistics = m_NumStatistics + agg->m_Value2;
    if (totalStatistics > 0)
    {
        ...
        m_NumDataPoints += agg->m_NumDataPoints;
        m_NumStatistics = totalStatistics;
    }
}
