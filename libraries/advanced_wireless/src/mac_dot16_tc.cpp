...
// belongs.
//
// \param tc  pointer to the traffic conditioner state
//    variables
...
// Returns station class info by class name.
//
// \param tc  pointer to the traffic conditioner state
//    variables
...
// check the packet tos and return which service class it is
// assigned to.
//
// \param service  tos to remap
//
// \return return service class or zero (BE).
static
...
// returns destination port of the message.
//
// \param node  pointer to the node,
// \param msg  application packet.
//
...
// check whether the node specified in the input file for
// traffic conditioning is valid or not.
//
// \param node  pointer to the node,
// \param inputString  the input file.
// \param addressString  the source address string.
// \param nodeId  nodeId of the source Node.
...
// determin in which color the incoming packet is marked by
...
// \param sfDirection  direction of the
//    service flow
...
// initializing and return next service class record.
//
// \param node  pointer to the node,
// \param tc  pointer to the traffic conditioner state
//    variables
...
//
// \return next empty station class record.
static
...
// initializing the parameters for profiling traffic.
//
// \param node  pointer to the node,
// \param tc  pointer to the traffic conditioner state
//    variables
// \param conditionClass  condition class value,
// \param packetProfile  packet profile type
// \param tosToMark  tos to remark
//
static
...
// adding the tc parameter structure information
// 
//
// \param node  pointer to the node
// \param tc  pointer to the traffic conditioner state
//    variables
// \param srcNode  address of the source node
//    + destNode NodeAddress : address of destination node
// \param tos  the tos field
// \param protocolId  protocol for which the packet is meant
// \param srcPort  source port of the packet
// \param destPort  destination port of the application
...
// \param tc  pointer to the traffic conditioner state
//    variables
// \param inputString  information string to parse
//
static
...
// initialize the classifiers/services from the qos file
//
// \param node  pointer to the node,
// \param tc  pointer to the traffic conditioner state
//    variables
// \param nodeInput  application packet or fragments.
...
// initialize the classifiers/services
//
// \param node  pointer to the node,
// \param tc  pointer to the traffic conditioner state
//    variables
...
// Initialize DOT16 traffic conditioner at a given interface.
//
...
// return the service class for the given tos.
// PARAMETERS:
...
// analyze incomming packet to determine whether or not it
...
// \param tc  pointer to the traffic conditioner state
//    variables
// \param msg  application packet or fragments.
// \param stationClassName  condition class
// \param sfDirection  service flow direction
// \param packetWasDropped  packet was droped
...
// \param int  index to the mac interface
//
