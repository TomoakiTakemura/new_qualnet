...
/// Type of the CID in 802.16 MAC. It is a 16bit integer
/// So a MAC domain can only have upto 64K CIDs
typedef UInt16 Dot16CIDType;

/// In 802.16 MAC, each node has a unique MAC address
/// as 48 bits long
#define DOT16_MAC_ADDRESS_LENGTH   6

/// Length of the base station ID. Should be 48-bit.
...
/// Max size of a management message
#define DOT16_MAX_MGMT_MSG_SIZE    3000

/// Default value of the interval for timeout a
/// service flow
#define DOT16_DEFAULT_SERVICE_FLOW_TIMEOUT_INTERVAL   (15 * SECOND)

/// Max value of the timeout interval for waitting the
/// DSx response
#define DOT16_MAX_T7_INTERVAL    (1 * SECOND)

/// Default value of the timeout interval for waitting the
/// DSx response
...
/// The starting number of transaction id at SS
#define  DOT16_SS_TRANSACTION_ID_START 0x0000

/// The ending number of transaction id at SS
...
/// The invlaid transaction id
#define  DOT16_INVALID_TRANSACTION_ID (unsigned int)-1

/// default number of DSx request retries
#define DOT16_DEFAULT_DSX_REQ_RETRIES    3

/// default number of DSx response retries
#define DOT16_DEFAULT_DSX_RSP_RETRIES    3


/// Copy a station ID from src to dst
...
/// Determine if the two MAC addresses are exactly same
#define MacDot16SameMacAddress(addr1, addr2) \
            ((addr1)[0] == (addr2)[0] && (addr1)[1] == (addr2)[1] && \
             (addr1)[2] == (addr2)[2] && (addr1)[3] == (addr2)[3] && \
             (addr1)[4] == (addr2)[4] && (addr1)[5] == (addr2)[5])

/// Convert an IPv4 address to MAC address
...
/// The DIUC indicasting the DL burst profile for broadcast
...
/// The DIUC for Gap/PAPR reduction
#define DOT16_DIUC_GAP_PAPR    13

/// The DIUC of end of map.
#define DOT16_DIUC_END_OF_MAP    14

/// UIUC of the most reliable burst profile
#define DOT16_UIUC_MOST_RELIABLE    1

/// UIUC of the End of MAP IE
#define DOT16_UIUC_END_OF_MAP   11

/// UIUC for initial ranging
#define DOT16_UIUC_RANGE    10

/// UIUC for contention based request
#define DOT16_UIUC_REQUEST    9

/// UIUC for CDMA initial ranging
...
/// Variable length packing indication
#define DOT16_VARIABLE_LENGTH_SDU       0

/// Fixed length packing indication
#define DOT16_FIXED_LENGTH_SDU          1

/// Default fixed lengthSDU size
...
/// Downlink or uplink part of the frame
typedef enum
{
...
/// Max number of PHY TYPE supported
#define DOT16_MAX_PHY_TYPE   4

/// Type of the PHY model
typedef enum
{
...
/// Max number of service type supported
...
/// purpose of the rangeing request
typedef enum
{
...
/// Data structure for a timer info field
typedef struct
{
...
/// Type of various MAC management messages
typedef enum
{
...
/// Type of various UCD channel encoding TLVs
typedef enum
{
...
/// Type of various UCD message Burse profile TLVs
typedef enum
{
    // PHY OFDMA
...
/// Type of various UCD message channel codeing TLVs
typedef enum
{
...
/// TLV types for triggers in DCD msg
typedef enum
{
...
/// Type of various UCD message burst profile TLVs
typedef enum
{
    // PHY-common
...
/// Type of various SBC-REQ/RSP TLVs
typedef enum
{
...
/// Type of TLVs used in REP-REQ msg
typedef enum
{
...
/// Type of TLVs used in REP-RSP msg
typedef enum
{
...
/// Type of various packet CS TLVs
typedef enum
{
...
/// Subtype of various packet CS error parameter TLVs
typedef enum
{
...
/// Subtype of various packet CS classfier rule TLVs
typedef enum
{
...
/// HMAC (hash message authentication ocde) Key seq number
...
/// Type of response from BS carried in REG-RSP
typedef enum
{
    DOT16_REG_RSP_OK = 0,
...
/// Status of a service flow transacction
typedef enum
{
    DOT16_FLOW_DSX_NULL,
...
/// Confirm code of a service flow transacction
typedef enum
{
...
/// MAC header of the 802.16 MAC. It could be the generic
...
/// Data grant subheader of the 802.16 MAC.
typedef struct
{
...
/// Fragmentation subheader of the 802.16 MAC.
...
/// Get transaction ID from a mgmt message structure above
#define MacDot16GetTransId(mgmtMsg) \
            ((msmtMsg)->transId[0] * 256 + (mgmtMsg)->transId[1])

/// Set transaction ID from a mgmt message structure above
...
/// Possible power saving class type
typedef enum
{
...
/// Structure of the DL-MAP message.
...
/// Structure of the UL-MAP message.
typedef struct
{
...
/// This msg is canned to implement CDMA range
typedef struct
{
...
/// Structure of the ranging request message
typedef struct
{
...
/// Ranging status to be included in RNG-RSP message
/// as one TLV value
typedef enum
{
...
/// Structure of the cdma information
typedef struct
{
...
/// Structure of the SS's basic capability request message
typedef struct
{
...
/// Structure of the basic capability response message
typedef struct
{
    unsigned char type;   // message type, must be DOT16_SBC_REQ
...
/// Structure of the public key management request message
typedef struct
{
...
/// SStructure of the public key management response message
typedef struct
{
...
/// Structure of the registration request message
typedef struct
{
...
/// Structure of the registration response message
typedef struct
{
...
/// Structure of the REP-REQ message
typedef struct
{
...
/// Structure of the padded msg
typedef struct
{
    unsigned char type;  // message type, must be DOT16_PADDED_DATA
} MacDot16PaddedMsg;

/// Structure of the DSA request message
typedef struct
{
...
/// Structure of the DSA response message
typedef struct
{
...
/// Structure of the DSA ACK message
...
/// Structure of the DSC request message
typedef struct
{
...
/// Structure of the DSC response message
typedef struct
{
...
/// Structure of the DSC ACK message
typedef struct
{
...
/// Structure of the DSD request message
typedef struct
{
...
/// Structure of the DSD response message
typedef struct
{
...
/// Structure of the DSX-RVD message
typedef struct
{
...
/// Structure of the MCA request message
typedef struct
{
...
/// Structure of the MCA response message
typedef struct
{
...
/// Structure of SS basic capbility
typedef struct
{
    // general
...
/// Infomation for Authentication and Key
typedef struct
{
...
/// UL burst profile for OFDMA PHY
typedef struct
{
...
/// DL burst profile for OFDMA PHY
typedef struct
{
    unsigned char fecCodeModuType;
    unsigned char exitThreshold;
...
/// DL burst profile. Union of different PHY specific
typedef union
{
...
/// Structure to store an IPv4 or IPv6 classifier
...
/// QoS parameters of a data service flow
...
/// Service flow ttransaction type
typedef enum
{
    DOT16_FLOW_XACT_Add,
...
/// Information of one service flow
...
/// Structure to keep a list of service flows
typedef struct
{
...
/// Data structure for storing dot16 statistics
typedef struct
{
} MacDot16Stats;

/// Data structure of Dot16 model
...
/// \param msg  If non-NULL, use this message
/// \param infoVal  Additional info if needed
/// \param infoVal2  additional info if needed
///
/// \return Pointer to the timer message
Message* MacDot16SetTimer(Node* node,
                          MacDataDot16* dot16,
...
/// Get the index of a channel in the channel list
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 data struct
/// \param channelIndex  Channel index of the channel
///
/// \return The index of the channel in my channel list
...
/// Check if a CID belongs or applicable to me
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
/// \param cid  CID value
///
/// \return TRUE, if my CID, FALSE, else
BOOL MacDot16IsMyCid(
         Node* node,
         MacDataDot16* dot16,
         Dot16CIDType cid);

/// Check if a CID is a basic CID
///
/// \param cid  CID value
///
/// \return TRUE, if basic CID, FALSE, else
inline
...
/// Check if a CID is a primary CID
///
/// \param cid  CID value
///
/// \return TRUE, if primary CID, FALSE, else
inline
...
/// Check if a CID is a secondary CID
///
/// \param cid  CID value
///
/// \return TRUE, if secondary CID, FALSE, else
inline
...
/// Check if a CID is a management CID
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
/// \param cid  CID value
///
/// \return TRUE, if mgmt CID, FALSE, else
BOOL MacDot16IsManagementCid(
         Node* node,
         MacDataDot16* dot16,
         Dot16CIDType cid);

/// Check if a CID is a transport CID
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
/// \param cid  CID value
...
/// Check if a CID is a multicast CID
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
/// \param cid  CID value
...
/// Check if a given MAC address is multicast address
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
...
/// Check if a given types of burst is allocated to SS
///
/// \param node  Pointer to node
/// \param dot16  Pointer to Dot16 structure
/// \param msgIn  Pointer to the msg to add the data grant subheader
/// \param serviceType  servive type of the msg belongs to
/// \param bwReq  bandwidth request if non UGS service flow
///    poll me or slip indicate for UGS service
///
/// \return the new message with the GrantMgmt subhead
...
/// printf out the node id and  simulation time
///
/// \param node  Pointer to node
/// \param dot16  Pointer to dot16 structure
void MacDot16PrintRunTimeInfo(Node* node, MacDataDot16* dot16);

/// get profile index from the modulation & coding information
///
/// \param node  Pointer to node
/// \param dot16  Pointer to dot16 structure
/// \param frameType  UL or DL frame
///    + codeModType : coding and modulation type
/// \param profIndex  Pointer to the profile index
///
BOOL MacDot16GetProfIndexFromCodeModType(Node* node,
                                         ...
                                         int* profIndex);
/// Get the least robust downlink burst profile
///
/// \param node  Pointer to node
/// \param dot16  Pointer to DOT16 structure
/// \param frameType : MacDot16SubframeType  or DL
/// \param signalMea  SNR in dB
/// \param unsigned char*  Pointer for the least robust DIUC
///
/// \return TRUE, if find one; FALSE, if not find one
...
/// Update the measurement histroy and recalcualte the
/// mean value
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param measInfo  Pointer to the meas. hist.
/// \param signalMea  Pointer to the current measurement
/// \param meanMeas  Pinter to the mean of meas
///
...
/// Put burst information in the info field of the message
///
/// \param node  Pointer to node
/// \param msg  Pointer to the message of the burst
/// \param burstInfo  Information of the burst
///
static
...
/// printf out the modulation and codeing information
///
/// \param node  Pointer to node
/// \param dot16  Pointer to dot16 structure
...
/// Build the DSA-REQ mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
/// \param cid  CID message shall use
/// \param transId  transaction Id
///
/// \return Point to the message containing the DSA-ACK PDU
...
/// Build the DSA-RSP mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
/// \param transId  transId ofr this DSA-RSP
/// \param cid  CID message shall use
/// \param qosChanged  QoS parameters changed or not
///
/// \return Point to the message containing the DSA-REQ PDU
...
/// Build the DSC-REQ mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param sFlow  Pointer to the service flow
/// \param newQoSInfo  Poniter to the new QoS info
/// \param cid  CID message shall use
///
/// \return Point to the message containing the DSA-REQ PDU
...
/// Build the DSC-Rsp mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
...
/// Build the DSD-REQ mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
/// \param cid  CID message shall use
///
/// \return Point to the message containing the DSD-REQ PDU
...
/// Build the DSD_RSP mgmt msg for a service flow
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
...
/// \param transId  transaction Id
///
/// \return Point to the message containing DSD-RSP PDU
...
/// \param dot16  Pointer to DOT16 structure
/// \param serviceFlow  Pointer to the service flow
/// \param dsxInfo  Pointer to the dsx information
///
...
/// Initialize dot16 MAC protocol at a given interface.
///
/// \param node  Pointer to node.
/// \param interfaceIndex  Interface index
/// \param nodeInput  Pointer to node input.
/// \param macProtocolName  Name of different 802.16
///    variants
/// \param numNodesInSubnet  Number of nodes in subnet.
/// \param nodeIndexInSubnet  index of the node in subnet.
///
...
/// React to change in physical status.
///
/// \param node  Pointer to node.
/// \param dot16  Pointer to Dot16 structure
/// \param oldPhyStatus  The previous physical state
/// \param newPhyStatus  New physical state
/// \param receiveDuration  The receiving duration
///
...
/// ARQ set Retry and Block life time timer
...
/// ARQ handle reset message
int MacDot16ARQHandleResetMsg(Node* node,
                              MacDataDot16* dot16,
                              unsigned char* macFrame,
                              int startIndex);

/// ARQ convert parameter in to frame duration
