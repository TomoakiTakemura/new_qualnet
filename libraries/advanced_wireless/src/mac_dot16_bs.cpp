...
// Initialize downlink and uplink burst profiles
//
// \param node  Pointer to node
// \param nodeInput  Pointer to node input
// \param interfaceIndex  Interface Index
...
//
// \param node  Pointer to node
// \param interfaceIndex  Index of the interface where the MAC is running.
// \param nodeInput  Pointer to node input
// \param dot16  Pointer to DOT16 structure
//
static
...
// Allocat a CID for data service flows
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to the SS info
//
// \return Allocated CID for data service flow
static
...
// Free a CID allocated to a data service flows
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  transport cid to free
//
static
...
// Allocat a CID for Secondary connection
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to the SS info
//
// \return Allocated CID for Secondary connection
static
...
// Add a mgmt message to be txed for a SS
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to a SS info record
// \param cid  cid of the connection
// \param pduMsg  Message containing the mgmt PDU
//
...
// Add a new SS into the registered SS list
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param macAddress  SS MAC Address
//
...
// Get a record of the SS using its basic CID or primary CID
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  Basic or primary CID of the SS
//
// \return Pointer to the added entry
...
// Get a service flow & its SS pointer by transaction id
// of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to BsSsInfo
// \param transId  transaction Id assoctated
//    with the service flow
// \param sflowPtr  To return the SFlow pointer
//
...
// Delete a service flow & its SS pointer by transaction
// id of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to BsSsInfo
// \param transId  transaction Id assoctated with
//    the service flow
//
...
// \param ssInfoPtr  To return the SS info pointer
// \param sflowPtr  To return the SFlow pointer
//
...
// Get a service flow & its SS pointer by sfID of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param sfId  sfId of the service flow
// \param ssInfoPtr  To return the SS info pointer
// \param sflowPtr  To return the SFlow pointer
//
static
...
// Get a record of the SS by its MAC address
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param macAddress  MAC address of the SS
//
// \return Pointer to the SS
...
// Remove a record of the SS using its basic CID or
// primary CID
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  Basic or primary CID of the SS
// \param freeIt  Whether free the SS structure
//
// \return Pointer to the SS structure
static
...
// Get Bs index by neighbor BS's Node Id
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param bsNodeId  Node Id of the neighbor BS
// \param bsIndex  Index of the neighbor BS
//
// \return TRUE, if find, FALSE, if not found
static
...
// Get Bs index by neighbor BS's Id (48 bits)
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param bsId  BS Id of the neighbor BS
// \param bsIndex  Index of the neighbor BS
//
// \return TRUE, if find, FALSE, if not found
static
...
// \param dot16  Pointer to DOT16 data struct
//
// \return Number of bytes of the DCD PDU
static
...
// Build a DL-MAP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param dlMapLength  To return the length of the DL-MAP
//
// \return Point to the created message
static
...
// Build a UL-MAP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
// \return Pointe to the created message
static
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param cid  CID in header, indicate ranging type
// \param rngStatus  Ranging status
//
// \return Message containing the PDU
static
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS info
//
// \return Message containing the PDU
static
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param pkmCode  PKM code for this message
// \param ssInfo  Pointer to SS info
//
// \return Message containing the PDU
static
...
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS info
// \param reqResponse  Response to the REG-RSP message
//
// \return Message containing the PDU
static
...
// Build a MOB-SCN-RSP PDU
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS info
// \param scanReq  MOB-SCN-RSP msg
//
// \return Message containing the PDU
static
...
// Build a BSHO-RSP msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to the SS info
//
// \return Point to the MOB_BSHO_RSP msg
static
...
// Build a BSHO-REQ msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to the SS info
// \param bsId  target Bs Id
//
// \return Point to the MOB_BSHO_REQ msg
static
...
// Build a DREG-CMD msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to the SS info
// \param actCode  DREG CMD action code
// \param dregReqDur  DREG-REQ Duration, if used
//
// \return Point to the MOB_BSHO_REQ msg
static
...
// Build and send IM_exit Req to PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS related info
//
// \return Message containing the PDU
static
...
// Build and send Location update Req to PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS related info
...
// Build and send Initiate Paging Req to PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS related info
...
// Build and send Paging Info to PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
...
//--------------------------------------------------------------------------
// Build a MAC frame to be transmitted
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param dlMapLength  To return length of the DL-MAP
//
// \return Point to the first message of the MAC frame
static
...
// Schedule various portion of a MAC frame.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
...
// Enable / Disable Service flow queues
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
...
// EBS need to deactivate PS defined class
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//    +ssInfo     : MacDot16BsSsInfo* : Pointer to SS info
...
// check packet present at BS for given PS class type
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS info
...
// Activate and deactivate PS class
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
...
// Build a MOB-TRF-IND PDU
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
// \return Return length of the message
static
...
// Start the operation of the BS. This is for start/stop
...
// The received signal is strong enough to decode
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param signalMea  Pointer to the received
//    singal strength
//
...
// BS perform periodic ranging receiver process
// after reveiving a signal from phy(pg.203 Fig. 82)
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param cid  basic cid associated with this burst
//    rngReqInData : BOOL         : Is range request received?
// \param signalMea  Pointer to signal strength
//    measurement
//
// \return whether SSInfo should be removed
static
...
// Process when invited inital ranging burst has no RNG-REQ
// (pg.181 Fig. 63)
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to the ssInfo
//
// \return whether ssInfo should be removed
static
...
// Whether BS request SS to move to another dl channel
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
//
...
// Handle CDMA range request
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Pointer to received rng req msg
// \param cdmaInfo  Pointer to CDMA info
//
...
// Handle a RNG-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
...
// Handle a PKM-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  cid of the pkm msg
//
// \return Number of bytes handled
static
...
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the HMAC
// \param hmacLen  length of HMAC
//
// \return TRUE if HMAC pass authentication check,
...
// Determine the service flow can be supported or not
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param bwRequest  Bandwidth requested by the flow
// \param direction  service flow direction
//
// \return TRUE if can support; FALSE if not
static
...
// Handle a DSA-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  cid of the DSA msg
//
// \return Number of bytes handled
static
...
// Handle a DSA-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSA-RSP message
//
// \return Number of bytes handled
static
...
// Handle a DSA-ACK message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSA-ACK message
//
// \return Number of bytes handled
static
...
// Handle a DSC-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  cid of the DSC msg
//
// \return Number of bytes handled
static
...
// Handle a DSC-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSC-RSP message
//
// \return Number of bytes handled
static
...
// Handle a DSC-ACK message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSC-ACK message
//
// \return Number of bytes handled
static
...
// Handle a DSD-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSD-REQ message
//
// \return Number of bytes handled
static
...
// Handle a DSD-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param macFrame  Pointer to the mac PDU
// \param startIndex  start of the payload in the PDU
// \param cid  Cid of the DSD-RSP message
//
// \return Number of bytes handled
static
...
//--------------------------------------------------------------------------
#if 0
// Suspend serive flow queue in case of scan
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to SS's info structure
// \param isEnable  TRUE if to suspend;
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param Message*  hello msg from neighboring BS
// \param msgSrcNodeId  BS node address of src of the hello msg
//
...
// update the signal meas for the nbr BS of a SS
// The NBR BS may not in the list of BS's own nrb list
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param ssInfo  Pointer to the ssInfo
// \param reportMeteric  reprot metric regardign the signal
// \param bsId  NBR Bs Id
// \param meanMeas  measurement
//
static
...
// Handle a IM Entry response from PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the PDU
//
...
// Handle a IM Exit response from PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the PDU
...
// Handle a Initiate Paging response from PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the PDU
...
// Handle a Paging announce message from PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the PDU
...
// Handle a Delete MS entry msg from PC
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the PDU
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 data struct
// \param msg  Message containing the data PDU
//
// \return Number of bytes handled
static
...
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param macAddress  MAC address of nextHop
...
// \param transId  transaction id for this service flow,
//    it is only meaningful for uplink service flow
// \param sfDirection  Service flow direction,
//    ul or dl
// \param sfInitial  Locally initiated or
//    remotely initaited
// \param ssCid  SS's primary cid
// \param transportCid  Pointer to the transport Cid
...
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  Basic CID of the SS or multicast CID
...
// Update measurement of SS signal quality
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to SS info
...
// BS initiates Idle mode
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pointer to SS info
// \param dregReqDur  Dreg-Req Duration, 0 = BS initiated
//
...
// SS handle Mgmt Resource Holding timer
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
//  Key API functions
//------------------------------------------------------------------------
// Initialize DOT16 BS at a given interface.
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface index
// \param nodeInput  Pointer to node input.
