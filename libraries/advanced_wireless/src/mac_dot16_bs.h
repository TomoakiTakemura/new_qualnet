...
/// Default value of the MAC frame duration
#define DOT16_BS_DEFAULT_FRAME_DURATION    (20 * MILLI_SECOND)

/// Default value of the duration of DL part in a MAC frame
#define DOT16_BS_DEFAULT_TDD_DL_DURATION    (10 * MILLI_SECOND)

/// Default value of the transmit/receive transition gap
#define DOT16_BS_DEFAULT_TTG    (10 * MICRO_SECOND)

/// Default value of the receive/transmit transition gap
#define DOT16_BS_DEFAULT_RTG    (10 * MICRO_SECOND)

/// Default value of the subscriber station transition gap
#define DOT16_BS_DEFAULT_SSTG    (4 * MICRO_SECOND)

/// Maximum interval between transmissions of DCD messages
#define DOT16_BS_MAX_DCD_INTERVAL    (10 * SECOND)

/// Default interval between transmissions of DCD messages
#define DOT16_BS_DEFAULT_DCD_INTERVAL    (5 * SECOND)

/// Maximum interval between transmissions of UCD messages
#define DOT16_BS_MAX_UCD_INTERVAL    (10 * SECOND)

/// Default interval between transmissions of UCD messages
#define DOT16_BS_DEFAULT_UCD_INTERVAL    (5 * SECOND)

/// Max time between initial ranging regions assigned by the
/// BS
#define DOT16_BS_MAX_INIT_RANGING_INTERVAL    (2 * SECOND)

/// Default time between initial ranging regions assigned by
/// the BS
...
/// Default Interval for BS to request SS report the DL
/// measurement
...
/// Nominal time between transmission of MOB_NBR_ADV msg
#define DOT16_BS_MOB_ADV_ADV_INTERVAL   (3 * SECOND)

/// Number of retries on paging transmission.
#define DOT16e_BS_PAGING_RETRY_COUNT   3

/// Timer interval to receive MS location update
#define DOT16e_BS_IDLE_MODE_SYSTEM_TIMEOUT   (4096 * SECOND)

/// Time the BS maintains connection info with MS after DREG
#define DOT16e_BS_MGMT_RSRC_HOLDING_TIMEOUT   (500 * MILLI_SECOND)

/// Number of retries for DREG-CMD
#define DOT16e_BS_DREG_REQ_RETRY_COUNT   3

/// Default waiting time for receiving DREG-REQ
#define DOT16e_BS_DEFAULT_T46_INTERVAL   (250 * MILLI_SECOND)

/// The maximum number of Paging groups to which a BS might be
/// associated
...
/// Size of the hash table to hold registered SS list
#define DOT16_BS_SS_HASH_SIZE    DOT16_CID_BLOCK_M

/// Max number of Channel description sent in transition
#define DOT16_MAX_CH_DESC_SENT_IN_TRANSITION    2

/// Hash a basic CID to its index in the SS table
#define MacDot16BsHashBasicCid(cid) (cid - DOT16_BASIC_CID_START)

/// Hash a primary CID to its index in the SS table
#define MacDot16BsHashPrimaryCid(cid) (cid - DOT16_PRIMARY_CID_START)

/// Hash a transport CID to its storage index
...
/// Data structure for keeping info of a registered SS
...
/// Data structure for storing dot16 BS parameters
typedef struct
{
...
/// Data structure for storing dot16 BS statistics
typedef struct
{
...
/// Data structure of Dot16 BS node
...
/// Add a new service flow to a SS
///
/// \param node  Pointer to node
/// \param dot16  Pointer to DOT16 structure
...
/// \param transId  trnasaction id for this service flow,
///    it is only meaningful for uplink service flow
/// \param sfDirection  flow direction, ul or dl
/// \param sfInitial  Locally/remotely initaited
/// \param ssCid  SS's primary cid
/// \param transportCid  Pointer to the trans. Cid for the flow
...
/// \param node  Pointer to node
/// \param dot16  Pointer to DOT16 structure
/// \param basicCid  basic CID of the SS
