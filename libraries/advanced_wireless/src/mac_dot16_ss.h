...
/// Max value of the timeout interval for waiting DCD
...
/// Max value of the timeout interval for waiting UCD
#define DOT16_SS_MAX_T12_INTERVAL    (5 * DOT16_BS_MAX_UCD_INTERVAL)

/// Default value of the timeout interval for waiting DSX-RVD
#define DOT16_SS_DEFAULT_T14_INTERVAL    (200 * MILLI_SECOND)

/// Max value of the timeout interval for waiting DSX-RVD
...
/// Max value of time for searching DL-MAP
#define DOT16_SS_MAX_T21_INTERVAL    (10 * SECOND)

/// Default value of the Lost DL-MAP Interval.
...
/// Default value of the Lost UL-MAP Interval.
...
/// Default waiting time for MOB_BSHO_RSP
#define DOT16e_SS_DEFAULT_T41_INTERVAL   (1 * SECOND)

/// Default waiting time for ending handoff in holding down
#define DOT16e_SS_DEFAULT_T42_INTERVAL   (1 * SECOND)

/// Default waiting time for MOB_SCN_RSP
#define DOT16e_SS_DEFAULT_T44_INTERVAL   (1 * SECOND)

/// Default waiting time for receiving DREG-CMD
#define DOT16e_SS_DEFAULT_T45_INTERVAL   (250 * MILLI_SECOND)

/// Timer interval to send MS location update
...
/// Number of retries for DREG-REQ
...
/// Network entry and initialization staus
typedef enum
{
    //PMP status
...
/// Data structure for storing dot16 SS parameters
typedef struct
{
...
/// The information of SS's initilization
...
/// anomalies infomation in ranging
typedef enum
{
    ANOMALY_NO_ERROR,
    ANOMALY_ERROR
...
/// Infomation for periodic ranging
...
/// A structure keeps tracking timers fired in order to
...
/// UL burst allocation assigned to me
...
/// The information of a BS maintained at the SS
...
/// Status of the neighbor BS scan
typedef enum
{
...
/// Idle mode intermediate/sub status
typedef enum
{
...
/// Data structure of Dot16 SS node
...
/// \param transId  transaction Id, no meaning for ul flow
/// \param sfDirection  Direction of flow
/// \param sfInitial  Locally/remotely initiated
