...
// printf out the modulation and coding information
//
...
// Init the operational channel list
//
// \param node  Pointer to node.
...
// \param msg  If non-NULL, use this message
// \param infoVal  Additional info if needed
// \param infoVal2  Another additional info if needed
//
// \return Pointer to the timer message
Message* MacDot16SetTimer(Node* node,
                          MacDataDot16* dot16,
...
// \param pktInfo  Pointer to classifier
...
// Build the DSA-ACK mgmt msg for a service flow
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param serviceFlow  Pointer to the service flow
...
//
// \return Point to the message containing DSA-ACK PDU
...
// \param dot16  Pointer to DOT16 structure
// \param serviceFlow  Pointer to the service flow
// \param transId  transId of this DSA-RSP
// \param qosChanged  QoS parameters changed or not
// \param cid  CID message shall use
//
// \return Point to the message containing DSA-RSP PDU
...
// \param cid  CID message shall use
//
// \return Point to the message containing DSC-RSP PDU
...
// Build the DSC-ACK mgmt msg for a service flow
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param serviceFlow  Pointer to the service flow
...
// \param cid  CID message shall use
//
// \return Point to the message containing DSD-REQ PDU
...
// Convert an IPv6 address to MAC address
...
// Convert an MAC address to IPv6 address
                              ...
                              MacDot16Timer* timerInfo)
{
    ...
    else if (timerInfo->timerType == DOT16_ARQ_RX_PURGE_TIMER)
    {
        ...
        for (tempIndex = DOT16_ARQ_RX_WINDOW_START %
