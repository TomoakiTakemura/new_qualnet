...
// Remove Message Layer 3 header.
//
// \param node  Pointer to node.
// \param msg  Point to message
//    : for node to process.
// \param msgType  Type of mgmt message
//
static
...
// Add Message Layer 3 header.
//
// \param node  Pointer to node.
// \param msg  Point to message for
//    : node to process.
// \param msgType  Type of mgmt message
//
//*************************************************************************
...
// Send a MAC msg to nbr BS over backbone for
//            :: management purpose
// currently only IP is supported
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param destNodeAddress  Node Id of the beighboring BS
...
// Broadcast Paging Announce to all the BS in the paging grp
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
// \param msg  Message for node to interpret
// \param pgGrpId  Paging Group Id
//
static
...
// Add SS info to Paging Controller cache on IM entry
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
// \param msg  Message for node to interpret
...
// Delete Node related info from PC on IM exit
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
// \param msg  Message for node to interpret
...
// Update Paging group id for the node
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
// \param msg  Message for node to interpret
...
// Send paging anounce to the paging group in which the node
// was last reported.
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
...
// Populate PC with BS Info (paging group id)
//
// \param node  Pointer to node.
// \param dot16  Pointer to dot16 data structure
// \param msg  Message for node to interpret
