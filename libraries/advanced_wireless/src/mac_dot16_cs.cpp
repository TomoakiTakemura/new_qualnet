...
// Remove invalidated classifier record.
...
// Builds the fragment classifier for IPv4 fragmented packets
// which in turn will be used to fill the classifier 
// info structure
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param ipHeader  Pointer to IPv4 header
...
// Builds the fragment classifier for IPv6 fragmented packets
// which in turn will be used to fill the classifier 
// info structure
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param ipv6Header  Pointer to IPv6 header
// \param payload  Packet payload
//    + ipFragmentClassifierValue : MacDot16CsIPFragmentClassifierValue*    :
//    Pointer to Classifier value for this fragment
//
...
// \param macAddress  Nodes MAC address
// \param msg  Packet from upper layer
// \param priority  Priority of packet
// \param classifierInfo  classifer info of this flow
// \param payload  Packet payload
// \param fragment  packet is a fragment
//
static
...
// \param serviceType  Data service type of this flow
// \param msg  Packet from upper layer
// \param macAddress  MAC address of node
// \param nextHop  Next hop address
// \param qosInfo  QOS info of this flow
// \param classifierInfo  Classifer info of this flow
//
// \return MacDot16CsClassifierRecord
...
// \param networkType  Type of network originated from
...
// \param msgDropped  Parameter to determine whether msg was dropped
//
// \return TRUE, packet is handled, ie enqueued, dropped, etc
