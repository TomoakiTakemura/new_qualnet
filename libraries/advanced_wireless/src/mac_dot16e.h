...
/// Report Metric used in MSHO_REQ
typedef enum
{
...
/// mode used in BSHO_RSP/BSHO-REQ
typedef enum
{
...
/// serving BS retain resource or not when rcvd HoReq
typedef enum
{
...
/// TLV types for triggers in MOB_NBR_ADV msg
typedef enum
{
...
/// Structure of the neighbor advertisement message
typedef  struct
{
...
/// Structure of the scanning interval request msg
typedef struct
{
...
/// Structure of the scanning interval response msg
typedef struct
{
...
/// Description of the allocated scanning interval
typedef struct
{
...
/// Structure of the MOB_MSHO-REQ message
...
/// Structure of the MOB_BSHO_REQ message
...
/// Structure of the MOB_BSHO_RSP message
...
/// Structure of the MOB_HO-IND message
...
/// Structure of the fields when mode field is 0b00 in
...
/// Structure of the DREG-REQ message
typedef struct
{
    unsigned char type;
...
/// Structure of the DREG-CMD message
typedef struct
{
    unsigned char type;
...
//--------------------------------------------------------------------------
/// Calculate MAC Hash value from Mac Address using D24
///
/// \param macAddress  MAC Address
///
/// \return MAC Hash value
static
