...
// Convert a cid to queue priority. We try to generate
...
// \param serviceType  service type of the connection
//
// \return priority for queue associated with the conn.
static inline
...
// Convert to queue priority to service type.
//
// \param priority  priority for queue associated with the conn.
//
// \return service type associated
// with the conn.
static inline
...
// Convert to queue priority to cid.
//
// \param priority  priority for queue associated with the conn.
//
// \return cid with the conn.
//static inline
...
// Decide the weight of a service flow. This weight is useful
...
//
// \return Weight of the service flow
static
...
// BS node check the dequeued packet and take certain action
// for certain types of message, only mgmt msg are supported
//
// \param node  Pointer to the node
// \param dot16  Pointer to DOT16 structure
// \param msg  message going to be sent out
// \param msgType  message type
//
// \return TRUE  if it is the specified type;
// FASLE if not
...
// Add Generic and data grant management (if needed) header
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param sFlow  Pointer to the service flow
// \param msgIn  incoming msg
// \param pduSize  incoming msg PDU size
//
// \return Return msg pointer
static
...
// SS puts packet in to output buffer
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param msgIn  incoming msg
...
// BS puts packet in to output buffer
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param ssInfo  Pinter to SS Info
// \param msgIn  incoming msg
// \param pduSizeInPs  incoming msg PDU size in PS
// \param isBroadCastMsg  TRUE / FALSE
//
static inline
...
// \param node  Pointer to node.
// \param sFlow  Pointer to service flow
// \param sduPacket  Pointer to msg
//
static
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param scheduler  Pointer to service type Scheduler
// \param sFlow  Pointer to service flow
...
// ARQ build PDU data packet
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param sFlow  Pointer to service flow
// \param ssInfo  Pointer to SS Info
// \param numFreeBytes  Free bytes
// \param sduSize  SDU size
//
static
...
// Check incoming BSN id present in ARQ window
//
// \param sFlow  Pointer to service flow
// \param incomingBsnId  Incoming BSN ID
//
// \return TRUE / FALSE
...
// Check new SDu started
//
// \param arqBlockPtr  Pointer to an ARQ block
//
// \return TRUE / FALSE
static
...
// To make an SDU block out of ARQ blocks that have been
...
// \param sFlow  Pointer to service flow
// \param incomingBsnId  Incoming BSN ID
// \param incomingFcVal  Incoming FC val
// \param numARQBlocksInPDU  No of ARQ blocks in PDU
//
// \return Return msg pointer
static
...
// \param isPackingHeaderPresent  TRUE if packing header present
//
// \return Return msg pointer
...
// ARQ build and send feedback msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param sFlow  Pointer to service flow
...
// ARQ handle discard msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to an unsigned character
...
// ARQ build and send discard msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param sFlow  Pointer to service flow
...
// check all the arq enabled service flows
// which have the same service type as "serviceType"
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param numFreePs  num of free Ps
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param numFreeBytes  num of free bytes
// \param serviceType  Service type
//
static
...
// Node will call this function to pack the data packets.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param sFlow  Pointer to service flow
// \param scheduler  Pointer to scheduler, from where data
//    packets need to retrieved
// \param msgIn  Incoming msg
// \param pduSize  Pdu size
// \param numFreeBytes  no of free bytes # of bytes
//
// \return Return the MAC PDU
static
...
// BS node will call this function to check if first packet
// can be scheduled when fragmentation is enabled
//
// \param node  Pointer to node.
// \param dot16Bs  Pointer to DOT16 BS structure
// \param numFreePs  Number of free PS
// \param dlMapIESizeInPs  Size of dlMapIE in PS
//
// \return when packet can be scheduled
...
//
// \return Actualy size in bytes allocated
