...
// Print current neighbor BS list learned through scanning
//
// \param node  Poointer to node
// \param dot16  Pointer to dot16 structure
//
...
//
// \param node  Pointer to node
// \param interfaceIndex  Interface where the MAC is running
// \param dot16  Pointer to DOT16 structure
//
static
...
// Tell whether an UL burst is data grant burst based UIUC
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param uiuc  UIUC of the UL burst
//
...
// Get a service flow & its SS pointer by
// transaction ID of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param transId  Trans. Id assoctated w/ the service flow
//
// \return Point to the sflow if found
...
// Delete a service flow & its SS pointer by one
// transaction Id of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param transId  Trans. Id of the service flow
//
// \return TRUE = deletion success; FALSE = deletion failed
static
...
// Get a service flow & its SS pointer by CID of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  CID of the service flow
//
// \return Point to the sflow if found
...
// Delete a service flow & its SS pointer by CID of the flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  CID assoctated with the service flow
//
// \return TRUE = deletion success; FALSE = deletion failed
#if 0
static
...
#endif
// Get a service flow & its SS pointer by flow id
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param sfId  flow Id of the service flow
// \param sflowPtr  Pointer to the Service flow
//
// \return Point to the sflow if found
static
...
#if 0
// Delete a service flow & its SS pointer by flow id
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param sfId  flow Id assoctated with the service flow
//
// \return TRUE = deletion success; FALSE = deletion failed
static
...
//--------------------------------------------------------------------------
// Get the UL burst allocation from the burst list
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param index  index of the burst
//
// \return Pointer to burst, NULL if not found
static
...
// Build the burst information to be passed to PHY
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param burst  Pointer to allocated burst
// \param sizeInBytes  Size in bytes of PDUs to be txed
// \param burstInfo  For returning burst info
//
// \return Return delay in PS that the signal will last
...
// Re-compute the actual start time for my transmission
// inside the burst. This is for contention based tx.
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param burst  Pointer to allocated burst
// \param offset  Offset to my transmission opp in PS
// \param newDuration  Duration of the transmission opp size
//
static
...
// Network entry
//--------------------------------------------------------------------------
// Perform PMP mode network entry procedures of the SS.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 SS data struct
//
static
...
// Perform network entry procedures of the SS.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 SS data struct
//
...
// Perform Location update of the SS.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 SS data struct
//
...
// Get a neighboring BS from the neighbor list by dl channel
// Add it if not found
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param dlChannel  Downlink channel of the BS
//
// \return Pointer to the BS info structure
static
...
// Remove a BS from the neighbor BS list
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param dlChannel  Downlink channel of the BS
//
// \return The pointer to the removed BS
static
...
#endif
// Get a neighboring BS from the neighbor list by Bs Id
// Add it if not found
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param bsId  Pointer to the BS Id
//
// \return Pointer to the BS info structure
static
...
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param bsId  Pointer ti the nbr Bs's Id
//
// \return The pointer to the removed BS
static
...
// Select the best BS in the nbr BS list for handover
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Create a bandwidth request record to be sent at proper time
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param cid  CID that BW is requested for
// \param bandwidth  Requested bandwidth
// \param serviceType  Service type of the flow
//    for which the BW req is sent
// \param isInc  Whether the BW is for incremental or agg.
//
static
...
// Queue a management message to be txed
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param cidType  Type of the cid for txing the msg
// \param mgmtMsg  Pointer to the mgmt msg to be enqueued
//
//static
...
// Reallocate the asigned bandwidth among multiple flows
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param bwGranted  Number of byte  can be transmitted
//
static
...
// Refresh the current need of bandwidth for each flow
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Schedule a list of bandwidth requests to be transmittd
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param numFreeBytes  Size of the available space
// \param isUnicastRequestOpp  Is this an unicast request opp?
// \param bwMsgSize  Return total size in bytes of bw requests
//
// \return Point to the first bw request msg
...
// Calculate MS paging unavailable interval
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return MS Paging unavailable interval
static
...
// Handle a received MAC PDU containing DL-MAP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
// \param startIndex  Start of the PDU in the frame
// \param rxBeginTime  Signal arrival time of the received frame
//
// \return Length of this PDU
static
...
// Handle a received MAC PDU containing UL-MAP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DCD message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Determne whether SS can use this ulplink  channel
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param ucd  Pointer to the uplink channel descriptor
//
// \return Usable or not
static
...
// Handle a received MAC PDU containing UCD message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Adjust/correct local params, includes power level,
// timimg and freqency offset
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param timingAdjust  in PHY specific unit
// \param powLevelAdjust  could be +/-, in uint of 0.25dB(m)?
// \param freqOffsetAdjust  in Hz
//
// \return Correction successful or not
static
...
// Create a SBC-REQ msg to be sent at proper time
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return Point to the message containing SBC-REQ PDU
static
...
// Build a PKM request message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param pkmCode  PKM code
//
// \return Point to the message containing the PKM-REQ PDU
static
...
// Create a REG-REQ msg to be sent at proper time
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return Point to the message containing REG-REQ PDU
static
...
// Create a REP-RSP msg to be sent at proper time
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param reportType  report type
//
// \return Point to the message containing REP-RSP PDU
static
...
// Build the DREG-REQ mgmt msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return Pointer to the MOB-SCN-REQ msg
static
...
// Build the MOB-SCN-REQ mgmt msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param scanDuration  Poitert to scan duration
//    if NULL, use default
...
// Build the MOB-MSHO_REQ mgmt msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return Pointer to the MOB_MSHO_REQ msg
static
...
// Build the MOB-SCN-REP mgmt msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param reportMode  report mode
// \param reportMetric  report metric
//
// \return Pointer to the MOB-SCN-REQ msg
static
...
// Build the MOB-SLP-REQ mgmt msg
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
// \return Pointer to the MOB-SLP-REQ msg
static
...
// Handle a received MAC PDU containing MOB-TRF-IND message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing MOB-SLP-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing RNG-RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing SBC-REQ
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Determine the SBC negotiation is OK or not
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Perform registration with the BS
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Handle a received MAC PDU containing PKM-RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing REG-RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing REP-REQ
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSX-RVD message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSA-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSA-ACK message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSC-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSC-ACK message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSD-REQ message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DSD-RSP message
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
//--------------------------------------------------------------------------
// Handle a received MAC PDU containing MOB-NBR-ADV
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing MOB-SCN-RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing MOB-BSHO-RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing MOB-BSHO-REQ
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing DREG-CMD
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing MOB-PAG-ADV
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param macFrame  Pointer to the start of the MAC frame
...
// Handle a received MAC PDU containing data
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param msg  Pointer to the message containing the PDU
//
// \return Length of this PDU
static
...
// Buffer this received MAC PDU,
// if classI is waiting for SLP RSP
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param msg  Message contains the PDU
//
// \return TRUE/FALSE
...
// Handle a receive MAC PDU
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param msg  Message contains the PDU
// \param rxBeginTime  Signal arrival time of the receive frame
//
// \return Length of this PDU
static
...
// Send a RNG-REQ message to BS
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param cid  CID of the ranging
// \param burst  The burst for tx opp
//
static
void MacDot16SsSendRangeRequest(Node* node,
                                MacDataDot16* dot16,
...
// Send a bandwidth request to BS
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param burst  The burst for tx opp
...
// Send a padded data to BS in case no pDU to send in the
// allocated tx Opps
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param cid  SS's basic CID
// \param burst  The burst for tx opp
//
static
...
// Go through the list of outgoing messages before
// being passed to the PHY. This gives a chance to
// update proper state variables, timers etc.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param firstMsg  Point to the first msg of the list of PDUs
//
static
...
// Schedule and transmit during my UL burst
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
// \param burst  Description of a UL burst
//
static
...
// Go through the service flow list and delete old flows
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
// Free the queued control msg in mgmt scheudler
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
// Perform handover while SS is in scan mode if needed
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param targetBs  Pointer to the target BS
//
static
...
// Update measurement of BS signal quality
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param signalMea  singal meaurement info
//
static
...
// Update the neighbor scanning status
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
//
...
// Re-start operation of the SS in handover.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 SS data struct
//
...
// Finish the handover procedure. Basically switch target BS
// as the serving BS.
//
// \param node  Pointer to node.
// \param dot16  Pointer to DOT16 structure
...
// \param dot16  Pointer to DOT16 structure
// \param serviceType  Service type of the flow
// \param csfId  Classifier ID
// \param qosInfo  QoS parameter of the flow
// \param pktInfo  Classifier of the flow
// \param transId  Trans Id of flow
// \param sfDirection  Direction of service flow
// \param sfInitial  Local or remote initaited
// \param isARQEnabled  Indicates whether ARQ is to be enabled for the
//    flow
// \param arqParam  Pointer to the structure containing the
//    ARQ Parameters to be used in case ARQ is
//    enabled.
//
// \return Basic CID of SS that the flow intended for
...
// Enqueue packet of a service flow
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
// \param macAddress  MAC address of next hop
// \param csfId  ID of the classifier at CS sublayer
// \param serviceType  Type of the data service flow
// \param msg  The PDU from upper layer
// \param flow  Pointer to the service flow
// \param msgDropped  Parameter to determine whether msg was dropped
//
// \return successfully enqueued, FALSE, dropped
...
//
// \param node  Pointer to node.
// \param dot16  Interface index
// \param unicastBurst  Unicast burst or not
// \param codeModyType  coding modulation used
//
static
...
// SS handle Dreg Req Duration timeout
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
// SS handle Location update timeout
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
*/
// To wake up the node and listen to BS Paging Adv
//
// \param node  Pointer to node
// \param dot16  Pointer to DOT16 structure
//
...
// Initialize DOT16 SS at a given interface.
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface index
// \param nodeInput  Pointer to node input.
