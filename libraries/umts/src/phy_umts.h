...
/// \defgroup Package_PHY_UMTS PHY_UMTS

/// \file
/// \ingroup Package_PHY_UMTS
...
// CONSTANT
/// Some constants defined for radio Tx/Rx
...
/// Parmeters controlingthe Cqi reporting mechanism
...
/// Secondary scrambiling code group sequence
const unsigned char
...
/// statistics in general phy umts
...
/// Physical Channel data of the cellular UMTS
...
/// NodeB data of the cellular UMTS at UE
...
/// stat data of the cellular UMTS at UE
typedef struct
{
    int totalTxSignals;
...
/// UL dedicated physical channel config at UE
typedef struct
{
...
/// random access procedure at PHY
typedef struct
{
...
/// HSDPA related information at UE pHY
typedef struct
{
    BOOL rcvdHspdschSig;
    BOOL repCqiNeeded;
...
/// PHY data of the cellular UMTS at UE
typedef struct
{
...
/// Dat structure to store the CQI info for UE at nodeB
typedef struct
{
...
/// stat data of the cellular UMTS at NodeB
typedef struct
{
    int totalTxSignals;
    double energyConsumed;
...
/// PHY data of the cellular UMTS at NodeB
typedef struct
{
...
/// Finalize the UMTS PHY, print out statistics
///
/// \param node  Pointer to node.
/// \param phyIndex  Index of the PHY
///
...
/// \param useMacLayerSpecifiedDelay  Use MAC specified delay or calculate it
...
/// Set teh BER table for UMTS
///
/// \param thisPhy  Pointer to PHY data.
///
void PhyUmtsAddBerTable(PhyData* thisPhy);

/// Get the ModcodeType and the coding rate.
///
...
/// Handle interference signal arrival from the channel
///
/// \param node  Pointer to node.
/// \param phyIndex  Index of the PHY
/// \param channelIndex  Index of the channel receiving signal from
/// \param propRxInfo  Propagation information
/// \param sigPower_mw  The inband interference signalmpower in mW
///
