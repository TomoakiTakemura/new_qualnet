...
/// \defgroup Package_UMTS_QOS UMTS_QOS

/// \file
/// \ingroup Package_UMTS_QOS
...
/// UMTS QOS peak throughput  (up to  x octet/s)
...
/// UMTS QOS mean throughput  (up to  x octet/h)
...
/// SM signalling IE :: Quality of service
struct UmtsSmIeQos
{
    UInt8 iei;
    UInt8 len;
