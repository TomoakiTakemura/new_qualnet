...
// Print out the burst detailed info for debug purpose.
//
// \param node  Pointer to node.
// \param burstInfo  Pointer to info of a burst
//
static
...
//
// \param node  Pointer to node.
// \param PhyUmts  Pointer to the UMTS PHY structure
...
// \param node  Pointer to node.
// \param rxMsgList  List of signal info structures
// \param propRxInfo  prop Info of  this propagation
// \param removeIt  Indicate whether remove from the list
//
// \return Pointer to the structure if found
static
...
// \param rxMsgInfo  Info of signal containing the burst
// \param cdmaBurst  Info of the cdma burst to be checked
//
static
...
// Compute the interference power on each burst
// 
//
...
// Compute the total interference power on each burst
// 
//
// \param node  Pointer to node.
// \param rxMsgInfoL  Pointer to PhyUmtsRxMsgInfo
// \param cdmaBurst  Pointer to PhyUmtsCdmaBurstInfo
// \param iflist  Select the print out info
//    
//
...
// Recompute the interference power on each burst
...
//
// \param node  Pointer to node
// \param phyIndex  Interface index where UMTS PHY is running
// \param phyUmts  Pointer to PHY UMTS structure
// \param phyUeData  POinter to PHY UMTS UE data
//
static
...
// \param node  Pointer to node.
// \param phyIndex  Index of the PHY
// \param phyUmts  Pointer to PhyUmtsData
...
// \param phyIndex  Interface index where UMTS PHY is running
// \param phyUmts  Pointer to PHY UMTS structure
// \param phyNodeBData  POinter to PHY UMTS NodeB data
//
static
