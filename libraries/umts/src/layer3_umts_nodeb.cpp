...
// Configurate the common Radio Link
//
// \param node  Pointer to node.
// \param umtsL3  Point to the umts layer3 data
//
...
// Setup signalling RB 1-3 for a UE at the NodeB
// + node      : Node* : Pointer to node.
// + umtsL3    : UmtsLayer3Data * : Pointer to the umts layer3 data
// + ueId      : NodeId : The UE ID associated with this signalling RB
// + srbConfig : const UmtsNodebSrcConfigPara*  : 
...
// Setup data HSDPA RB for a UE at the NodeB
// + node      : Node*  : Pointer to node.
// + umtsL3    : UmtsLayer3Data * : Pointer to the umts layer3 data
...
// Setup data RB for a UE at the NodeB
// + node      : Node*  : Pointer to node.
// + umtsL3    : UmtsLayer3Data * : Pointer to the umts layer3 data
...
// Setup HSDPA data RB for a UE at the NodeB
// + node      : Node* : Pointer to node.
// + umtsL3    : UmtsLayer3Data * : Pointer to the umts layer3 data
...
// Print out NodeB specific parameters
//
// \param node  Pointer to node.
// \param nodebL3  Pointer to UMTS NodeB Layer3 data
//
static
...
// Initialize NodeB specific parameters
//
// \param node  Pointer to node.
...
// Print out NodeB specific statistics
//
// \param node  Pointer to node.
// \param nodebL3  Pointer to UMTS NodeB Layer3 data
//
...
// Send a NBAP message to the RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the NBAP message
// \param msgType  NBAP message type
// \param transctId  The message transaction ID
// \param ueId  The UE ID the message associated with
//
static
...
// Handle a hello packet from neighbor RNCs. This is used to
...
// Handle a RRC_SETUP_RELEASE from RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RRC_SETUP_REQUEST from RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Radio Bearer Release from RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Radio Bearer Setup from RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Join active set message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Leave active set message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a protocol message from RNC, it may be a NBAP
// message or a RRC message to be forwarded to an UE
//
// \param node  Pointer to node.
// \param msg  Message containing the packet
// \param umtsL3  Pointer to UMTS Layer3 data
// \param destNodeId  The destination of the message
...
// Handle a SIB timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebL3  NodeB data
// \param msg  Message containing the packet
//
static
...
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface from which the packet
//    is received
// \param umtsL3  Pointer to UMTS Layer3 data
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebL3  Pointer to L3 UMTS NodeB data
//
static
                                     ...
                                     UmtsLayer3Nodeb *nodebL3)
{
    ...
    nodebL3->stat.numUeInConnectedGuiId =
        GUI_DefineMetric(
            "UMTS NodeB: Number of UEs in Connected Mode in the Cell",
            node->nodeId,
            GUI_NETWORK_LAYER,
            interfaceIndex,
            GUI_INTEGER_TYPE,
...
// Initialize NodeB data at UMTS layer 3 data.
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to node input.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle NodeB specific timers and layer messages.
//
// \param node  Pointer to node.
// \param msg  Message for node to interpret
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Print NodeB specific stats and clear protocol variables.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
