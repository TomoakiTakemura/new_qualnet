...
// Handle MM state update
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param eventType  MM event type
//
static
...
//
// Initiate RRC connection request by MM/GMM
//
...
//
// \return TRUE if RRC conn req has been sent
static
...
// Notify MM/GMM whether the RRC conn. has been established
//
//    +node      : Node*               : Pointer to node.
//    +umtsL3    : UmtsLayer3Data *    : Pointer to UMTS Layer3 data
...
// Notify CM whether the MM connection has been established
//
//    +node      : Node*               : Pointer to node.
//    +umtsL3    : UmtsLayer3Data *    : Pointer to UMTS Layer3 data
...
// Notify CM an active MM connection is released
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param pd  Protocol discriminator
// \param BOOL  Whether RRC connection has
//    been established or not
//
static
...
// Send PDP activation request
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to node input.
// \param umtsL3  Pint to the umts L3 data
// \param ueL3  Pointer to UMTS UE Layer3 data
// \param srcDestType  PDP context source/destination
...
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param locUpdateType  Location update type
//
static
...
// Get the size of Status Set Size of the UE
// + node      : Node*             : Pointer to node.
...
// \return the size of the status set
static
...
// Get the pointer which points to the NodeB layer 3 data.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
...
//
// \param node  Pointer to node.
// \param umtsL3  pointer to UMTS layer 3 data
// \param ueL3  Pointer to UMTS UE Layer3 data
//
static
...
// Initialize UE Call Control entity
//
// \param node  Pointer to node.
// \param ueL3  Pointer to UMTS UE Layer3 data
//
...
// Finnalize UE Call Control entity
//
// \param node  Pointer to node.
// \param ueL3  Pointer to UMTS UE Layer3 data
//
...
// Add a new Flow Info to the AppList
// + node      : Node*             : Pointer to node.
...
// Finalize a Flow info item in the appList
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
...
// Remove a Flow info item from the appList
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
// + srcDestType : UmtsFlowSrcDestType  : applicaiton src dest type
// + transId   : unsigned char      : transactionId
...
// Look for the app Info from the appList
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
// + srcDestType : UmtsFlowSrcDestType  : applicaiton src dest type
// + transId   : unsigned char      : transactionId
...
// Enqueue PS packet from upper lyer
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
...
// Look for the umts call app Info from the appList
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
...
// release the CCCH, RACH and PRACH used for random access
// + node      : Node*             : Pointer to node.
// + umtsL3    : UmtsLayer3Data *  : Pointer to the umts layer3 data
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
static
...
// Release low layer resources by RB ID
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  Ue data
...
// Release downlink decdicated physical channel listening to
// + node      : Node*             : Pointer to node.
// + umtsL3    : UmtsLayer3Data *  : Pointer to the umts layer3 data
// + ueL3      : UmtsLayer3Ue*     : Pointer to the UE umts layer3 data
static
...
// Print out UE specific parameters
//
// \param node  Pointer to node.
// \param ueL3  Pointer to UMTS UE Layer3 data
//
...
// Search new available cell if RRC
...
// Print out UE specific statistics
//
// \param node  Pointer to node.
//    +umtsL3     : UmtsLayer3Data * : Pointer to UMTS Layer3 data
// \param ueL3  Pointer to UMTS UE Layer3 data
...
// Build MM/GMM Msg
//
// Send a combined location update
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param locUpdateType  Location update type
...
// Send a CM SERVICE REQUEST to initiate MM connection
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueMm  Pointer to the UE MM data
// \param pd  Protocol discriminator
...
// Send a paging response message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param attachType  attach request type
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param followOn  follow on service or not
//
static
...
// Handle GMM state update
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param followUp  Follow up service or not
// \param combineAttach  Combined attach or not
//
static
...
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param estCause  Est. casue
// \param servicetType  service tytpe
// \param transId  transaction id
//
static
...
// Build CC Msg
///****************************************************************
// Send mobile originated call setup
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ti  transaction Id
// \param ueCC  UC CC data
//
static
...
// Send a CALL CONFIRMED message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueFlow  Pointer to the UE application data
//
static
...
// Send an ALERTING message to the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueFlow  Pointer to the UE application data
...
// Send an CONNECT message to the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueFlow  Pointer to the UE application data
...
// Send a DISCONNECT message to the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pinter to the UMTS L3 data
// \param ueFlow  Pointer to the UE application data
...
// Initiate mobile originated call setup
//
// \param node  Pointer to node.
// \param umtsL3  Pint to the umts L3 data
// \param ueL3  Pointer to UMTS UE Layer3 data
...
// Initiate mobile originated call clearing
//
// \param node  Pointer to node.
// \param umtsL3  Pinter to the UMTS L3 data
// \param ueFlow  Pointer to the UE application data
// \param clearType  Type of clearing action
//
static
...
// \param srcDestType  PDP context source/destination
// \param transId  transaction Id
// \param deactCause  deactivete cause
//
static
...
// Build RRC_CONNECTION_REQUEST message
//
// \param node  Pointer to node.
// \param cause  Establishment Cause
// \param initUeId  Initial UE identifier
// \param protErrIndi  Protocol Error indicator
// \param domainIndi  Domain indicator
//
...
// Build RRC_CONNECTION_SETUP_COMPLETE message
//
// \param node  Pointer to node.
...
#if 0
// Build RRC_CONNECTION_RELEASE_COMPLETE message
//
// \param node  Pointer to node.
// \param transctId  transaction id
//
...
// Send RRC CONNECTION RELEASE COMPLETE message to RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
...
// Send a RRC STATUS message to RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param rcvMsgType  The received message type
// \param transctId  Transaction ID of received message
// \param errCause  Protocol error cause for
...
// Send a SIGNAL_CONNECTION_RELEASE_INDICATION
// message to the RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
//--------------------------------------------------------------------------
// Handle Call start msg from APP.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle Call answered msg from APP.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message for node to interpret.
...
#if 0
// Handle Transaction ID presented in certain messages
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
// \param msgType  RRC message type.
//
// \return Whether to discard the message
static
...
// Erase Transaction associate with a message type
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msgType  RRC message type.
//
// \return Whether this transaction exists
static
...
// Handle RRC_CONNECTION_SETUP message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle RRC_CONNECTION_REJECT message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle RRC_CONNECTION_RELEASE message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle DOWNLINK_DIRECT_TRANSFER message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle PAGING_TYPE_1/2 message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
// Handle RADIO_BEARER_SETUP message for regular RB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle RADIO_BEARER_SETUP message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle RADIO_BEARER_RELEASE message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
// Handle active Set setup message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
...
//
// Handle RR SIB type 3 msg.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param mibInfo  sib Message to interpret.
//
static
...
//
// Handle RR SIB type 1 msg.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param cellId  cellId
// \param sibType1  sib Message to interpret.
//
static
...
// \param ueL3  Pointer to l3 Ue data
// \param cellId  cellId
// \param sibType2  sib Message to interpret.
//
static
...
// \param sibType3  sib Message to interpret.
//
static
...
// Handle RR SIB type 5 msg.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param cellId  cell Id
// \param sibType5  sib Message to interpret.
//
static
...
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param msg  sib Message to interpret.
//
static
...
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
// \param cmd  measurement report to interpret.
//
static
...
// Check whether physical links are broken
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param ueL3  Pointer to l3 Ue data
...
// Handle a T300 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a T308 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a RRC_CONNECTION_REQUEST waittime timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
//
// \return TRUE if RRC connection request
// has been sent
static
...
// handle MM Msg
//
// Handle a T3212 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a T3230 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a T3240 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a Location update Accept message .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle a Location update Reject message.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
// \param msg  Pointer to the message contents
// \param msgSize  Message size
//
static
...
// Handle a CM Service Acpt message.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
// \param msg  Pointer to the CM message contents
// \param msgSize  Message size
//
static
...
// Handle a Mobility Management message from the network .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle a T3310 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a service Accept message .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a T3317 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a GPRS Mobility Management message from the network .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msgType  Message type
...
// handle CC Msg
//
// Handle a T303 CC timer
//
// \param node  Pointer to node.
// \param ueL3  Pointer to UMTS Layer3 data
// \param msg  Pointer to the NAS message contents
//
static
...
// handle SM Msg
//
// Handle a deactivate PDP context accept message .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a deactivate PDP context request message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a activate PDP context accept message .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a activate PDP context reject message .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a Request PDP Context Activation message.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a T3380 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// Handle a T3390 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  UE data
...
// init deactivate PDP context .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
// \param srcDestType  src dest type
//
static
...
// Power On /Off
//
// UE is powered on. Do all required actions
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
...
// Notify MM/GMM whether the RRC connection has been established
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  Pointer to UE layer3
// \param msg  Mesaget to be handled
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueL3  POinter to PHY UMTS UE data
//
static
...
// Initialize UE data at UMTS layer 3 data.
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to node input.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle UE specific timers and layer messages.
//
// \param node  Pointer to node.
// \param msg  Message for node to interpret
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Print UE specific stats and clear protocol variables.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
...
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface from which the packe
//    it is received
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message for node to interpret.
