...
// Return whether a sequence number is less than the other
//
...
// Copy simulation related message information
...
// Set a timer with given type and delay
//
...
// Get UMTS layer2 pointer from node and interface Id
//
//    +node: Node*:      node pointer
//    +ifac: int:        interface id
//
// \return RLC data pointer
static
...
// store the RLC TM transmission entity
//
//    +node:  Node* : Node Pointer
...
// restore the RLC TM transmission entity
//
//    +node: Node*: Node Pointer
...
// To submit a SDU to upper layer
//
//    +node:   Node*:    node pointer
//    +interfaceIndex: int:  the interface index
...
///////////////////////////////////////////////////////////////////////////
// RLC PDU header class contructor
//
//    +type:  AM/UM
...
// RLC PDU header class destructor
//
//
UmtsRlcHeader::~UmtsRlcHeader()
{
...
// clear all the header data stored
//
//
...
// return a PDU header from the structure
//
//    +hdr: char*: RLC header
//
...
// Add a length indicator and E bit fields in
...
// Construct a UmtsRlcHeader struct from the real header
//
...
// Read the next LI value without moving the seek pointer
//
//    +liVal: unsigned int&:  The LI value
//
// \return success or not
...
// Print out UmtsRlcHeader Struct
//
...
// Search for a RLC TM transmitting entity
//
//    +entity:    UmtsRlcEntity*: RLC entity structure
//
// \return TM transmitting entity
static
...
// Search for a RLC TM receiving entity
//
//    +entity:    UmtsRlcEntity*: RLC entity structure
//
// \return TM receiving entity
static
...
// Search for a RLC UM transmitting entity
//
//    +entity:    UmtsRlcEntity*: RLC entity structure
//
// \return UM transmitting entity
static
...
// Search for a RLC UM receiving entity
//
//    +entity:    UmtsRlcEntity*: RLC entity structure
//
// \return UM receiving entity
static
...
///////////////////////////////////////////////////////////////////////////
// Add a RLC header into the packet header field
// of the PDU message
//
//    +node:          Node pointer
...
// Fragment or concatenate UM/AM SDUs into PDUs
//
//    +node:          Node pointer
...
// Retrieve the last PDU held by the Fragment Entity
...
// Serialze the entity into a string buffer
//
//
...
// UnSerialze the entity from a string buffer
//
//
...
// When receiving a new PDU, the UM receiving entity
...
// When two SDU segment has connected sequence number,
...
// Insert the SDU segments extracted from the
// newly received PDU
    ...
    BOOL pduExpectedNext)
{
    ...
    else
    {
            ...
            ++itPos)
        {
            ...
            {
                ERROR_ReportWarning("Screening procedure fails to "
...
// Create a AM reset/reset ack PDU
//
//    +node:      The node pointer
//    +amEntity:  AM entity
...
// Initiate an AM Reset procedure, invoked due to
...
// Handle a received reset ack PDU
//
//    +node:      The node pointer
//    +rlcData:   The RLC sublayer data
//    +amEntity:  AM entity
...
// Prepare List SUFI for status Pdu
//
//    +amEntity:  The AM entity
...
//    a block of missing PDU and the length of the block
//
// \return TRUE if there is no errorneous
...
// Fill the STATUS PDU per each 4bit
//
...
// Read 4-bit data from the status PDU data at
...
//    +statusPduSize:     The count of PDU size (number of 4-bit)
//
// \return Value of the 4-Bit data
static
...
// Write a 12-bit number into the STATUS PDU
//
//    +currentOctet: The current octet prepared for the STATUS PDU data
//    +statusPduSize: The count of PDU size (number of 4-bit)
...
// Get 12-bit number from the STATUS PDU payload
//
//    +currentOct:        The address of the current seek
//    pointer in STATUS payload
//    +statusPduSize:     The count of PDU size (number of 4-bit)
...
// Add NOMORE SUFI into the status PDU
//
//    +currentOctet: The current octet prepared for the STATUS PDU data
//    +statusPduSize: The count of PDU size (number of 4-bit)
//    +statusData: The vector containing the octets for the STATUS PDU
...
// Add ACK SUFI into the status PDU
//
//    +currentOctet: The current octet prepared for the STATUS PDU data
//    +statusPduSize: The count of PDU size (number of 4-bit)
//    +statusData: The vector containing the octets for the STATUS PDU
...
// Start creating STATUS PDU by adding a new head
//
//    +currentOctet: The current octet prepared for the STATUS PDU data
//    +statusPduSize: The count of PDU size (number of 4-bit)
//    +statusData: The vector containing the octets for the STATUS PDU
...
// Prepare STATUS PDUs for the next transmission
//
//    +node:      The node pointer
//    +amEntity:  The AM entity
//    +statusPduList: STATUS PDU message List
...
// Invoked when number of transmissions of a
...
// Initialize a RLC TM Transmitting entity
//
...
// Finalize a RLC TM transitting entity
//
//    +node:      Node pointer
//    +tmTxEntity:  TM transmitting entity
//
...
// Initialize a RLC TM receiving entity
//
...
// Finalize a RLC TM receiving entity
//
//    +node:      Node pointer
//    +tmRxEntity:  TM receiving entity
//
...
// Initialize a RLC UM Transmitting entity
//
...
// Finalize a RLC UM transitting entity
//
//    +node:      Node pointer
//    +umTxEntity:  UM transmitting entity
//
...
// Initialize a RLC UM receiving entity
//
...
// Finalize a RLC UM receiving entity
//
//    +node:      Node pointer
//    +umRxEntity:  UM receiving entity
//
...
// Config a RLC TM transmitting entity
//
//    +entity:    RLC entity
...
// Config a RLC TM Receiving entity
//
//    +entity:    RLC entity
//    +tmConfig:  TM configuration parameters
//
...
// Config a RLC UM transmitting entity
//
//    +node:      Node pointer
//    +entity:    RLC entity
...
// Config a RLC UM Receiving entity
//
//    +node:      Node pointer
//    +entity:    RLC entity
//    +umConfig:  UM configuration parameters
...
// Deliver RLC TMD PDUs to MAC through TM SAP,
...
// Prepare RLC PDUs sent to MAC through UM SAP,
...
// Add RB information for a PDU list into the
...
// Get RB information for a PDU list from the
// head message of the PDU list
//
//    + node:       pointer to the network node
...
// Pack message before sending RLC PDUs to MAC
//
//    + node:       pointer to the network node
//    + pduList:    A list containing the pdus to be sent
//
...
// Unpack message received from MAC
//
//    + node:       pointer to the network node
...
// Called by RRC to control RLC entities
//
//    +node:        Node pointer
