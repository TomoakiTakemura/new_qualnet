...
// get the pointer of the MAC data structure
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
//
// \return pointer to the MAC data
static
...
// \param chList      :std:  Point to channel List
// \param chType  transport channel type
// \param chId  channel Idetifier
//
...
// Inititate a UE Info data in Nodeb
//
// \param node  Pointer to node.
// \param ueId  The UE Id
// \param priSc  Primary scrambling code
//
// \return The allocated nodeBUeInfo pointer
static
...
// Finalize a UE Info data in Nodeb
//
// \param node  Pointer to node.
// \param nodeBUeInfo  Pointer to the nodeBInfo
//    to be finalized
//
static
...
//
// \param node  Pointer to the node
// \param ueInfoList  : std:  Point to UE Info List
// \param ueId  UE's primary scrambling code
//
// \return pointer to the UE info
static
UmtsMacNodeBUeInfo* UmtsMacNodeBGetUeInfoFromList(
...
// calcualte the TrCh weight.
//
// \param node  Pointer to the node structure
// \param entityInfo  RLC entity information
//
static
...
// Handle RACH access state machine transition
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
...
// \param umtsMacData  Umts Mac Data
// \param ueMacVar  ue mac var
// \param eventType  transition event
//
static
...
// Handle Interlayer PHY-ACCESS-CFN at Ue
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param umtsMacData  Umts Mac Data
...
// Finalize the C-shm MAC enetity at Ue
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param umtsMacData  Umts Mac Data
...
// Update the trnsport channel weight.
//
// \param node  Pointer to node.
// \param interfaceIndex  interface Index
// \param mac  Mac Data
...
// Init the Ue MAC data
//
// \param node  Pointer to node.
// \param umtsMacData  UMTS MAC Data
// \param ueMacVar  UE MAC Data
// \param interfaceIndex  Interface index
// \param nodeInput  Pointer to node input.
//
static
...
// Initialize UMTS MAC sublayer at a given interface.
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface index
// \param nodeInput  Pointer to node input.
