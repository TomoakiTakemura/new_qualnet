...
// Print out HLR specific parameters
//
// \param node  Pointer to node.
// \param hlrL3  Pointer to UMTS HLR Layer3 data
//
static
...
// Print out the entries in HLR data base
//
// \param node  Pointer to node.
...
// Initialize HLR specific parameters
//
// \param node  Pointer to node.
...
// Print out HLR specific statistics
//
// \param node  Pointer to node.
// \param hlrL3  Pointer to UMTS HLR Layer3 data
//
...
// Response a reply message to an HLR request
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Pointer to message to be sent
// \param destAddr  Address of the destination node
// \param destNodeType  Node type of the dest node
...
// \param imsi  IMSI of the related UE
// \param hlrEntry  Point to HLR entry, maybe NULL
// \param destAddr  Address of the destination node
// \param destNodeType  Node type of the dest node
//
static
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param command  Command of the packet
// \param replyInfo  info in carried in the cellReply msg
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param hlrL3  Pointer to the HLR layer3 data
// \param cellId  Cell Id to be queried
// \param queryRncId  NodeId of the querying RNC
// \param destAddr  Address of the destination node
// \param destNodeType  Node type of the dest node
//
static
...
// Handle HLR request packet
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param pktBuff  Point to beginning of the request
// \param interfaceIndex  Interface from which packet was received
// \param srcAddr  Address of the source node
// \param srcNodeType  Node type of the source node
//
static
