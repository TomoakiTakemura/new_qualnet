...
// Lookup VLR information for a given UE indicated by UE ID
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  Identification of the UE
//
// \return Pointer to the VLR entry if found in VLR
// NULL otherwise
static
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  Identification of the UE
// \param rncId  For return ID of the RNC controls UE
// \param cellId  For return cell ID where UE is located
//
// \return TRUE if found in VLR, FALSE otherwise
static
...
// This function is called when getting routing info from HLR
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueImsi  IMSI of the UE
// \param locInfo  Location info of the UE from HLR.
...
// Send a Attach request
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param gsnL3  gsn data
// \param ueId  The UE which are ready for sending the req
//
static
...
// Send a PDU Notification Response to GGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN data
// \param ueInfo  Info of UE at the SGSN
// \param flowInfo  Info of the flow at SGSN
// \param gtpCause  Result of the request
// \param gsnAddr  Address of SGSN/GGSN
//
static
...
//*** Utility Functions
//
// Check if a voice address in the PLMN controled by the GMSC
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to the GSN data
// \param callAddr  The call address to be checked
//
// \return TRUE if the call address in my PLMN, FALSE otherwise
...
// Initialize NW MM data
//
// \param node  Pointer to node.
// \param umtsL3  Pint to the umts L3 data
// \param gsnL3  Pointer to UMTS gdn Layer3 data
...
// Stop active CC timers
//
// \param node  Pointer to node.
// \param ueCc  Pointer to the CC entity data
//
static
...
// Initialize NW CC data
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to UMTS gdn Layer3 data
// \param ueFlow  Pointer to the app flow info
//
...
// UmtsLayer3SgsnFlowInfo destructor
// + node      : Node*             : Pointer to node.
...
// Handle a GTP msg at SGSN
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to the umts gsn L3 data
// \param pdpInfo  poninter to the PDP info
//
static
...
// Enqueue pckets from upper
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to the umts gsn L3 data
// \param appInfo  poninter to the PDP info
...
// Search for a call flow in GMSC by UE ID and TRANSACTION ID
//
// \param node  Pointer to node.
// \param gsnL3  GSN layer 3 data
// \param ueId  UE ID
// \param ti  transaction ID
//
// \return The call flow to be retrieved
static
...
// Search for a UE call flow in GMSC by UE ID and peer address
//
// \param node  Pointer to node.
// \param gsnL3  GSN layer 3 data
// \param ueId  UE ID
...
// Add a new call flow into the list kept at GMSC
//
// \param node  Pointer to node.
// \param gsnL3  GSN layer 3 data
// \param ueId  UE ID
// \param ti  transaction ID
// \param peerAddr  Peer Address
// \param sgsnId  The MSC(sgsn) which the UE
//    is connected with
//
// \return The call flow to be retrieved
static
...
// forward a Iur msg to a sgsn where the target RNC locates
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// \param rncId  The RNC ID the message will be sent to
//
static
...
// Send a RANAP message to the HLR node
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the NBAP message
// \param hlrAddr  Address of the HLR
//
static
...
// Send a hello message to the GGSN node
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ggsnAddr  Address of the GGSN node
//
static
...
// Send a NAS stratum message a UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nasMsg  NAS message content
// \param nasMsgSize  NAS message size
// \param pd  Protocol discriminator
// \param msgType  NAS message type
...
// Print out GSN specific parameters
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to UMTS GSN Layer3 data
//
static
...
// Initialize GSN specific parameters
//
// \param node  Pointer to node.
...
// Print out SGSN specific statistics
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  Pointer to UMTS GSN Layer3 data
...
// Print out GGSN specific statistics
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  Pointer to UMTS GSN Layer3 data
...
// GSN APP
/////////////
// Configurate the CCCH, RACH and PRACH for random access
// + node      : Node*             : Pointer to node.
...
// Find application information from the UE application list
// + node      : Node*             : Pointer to node.
// + gsnL3     : UmtsLayer3Gsn*    : GSN Layer3 data
...
// Find flow info from the list for given GTP tunnel ID
// + node      : Node*          : Pointer to node.
...
// \return Pointer to flow if found
// NULL if not found
static
UmtsLayer3SgsnFlowInfo* UmtsLayer3GsnFindAppInfoFromList(
                            Node* node,
...
// MM
//////////////
// Send a Paging message to one RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID
// \param domain  CN domain ID
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID
// \param updateResult  result of the loc update
// \param raUpTime  update time
//
static
...
// Send a CM SERVICE ACCEPT to one RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueNas  UE data in GSN
// \param pd  Protocol discriminator
// \param ti  transaction Id
//
static
...
// Send an IU_RELEASE_COMMAND to the RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID
...
/// GTP
//////////////
// Send a RAB ASSIGNMENT REQUEST to one RNC for establishing
// a GTP tunnelling
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// \param ulrabPara  UL RAB QoS requirment parameters
// \param dlrabPara  DL RAB QoS requirment parameters
// \param rncId  The RNC ID the msg will be sent to
//
static
...
// Send a RAB ASSIGNMENT Release to one RNC to release
// a RAB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID
// \param rabId  RAB ID to be released
// \param rncId  The RNC ID the message will be sent to
//
static
...
// Send a RAB ASSIGNMENT Release to one RNC for establishing
// a GTP tunnelling
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN data
// \param appInfo  applicaiton info
//
static
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN data
// \param pdpInfo  applicaiton info
// \param gtpCause  GTP cause
//
static
...
// \param gsnL3  GSN data
// \param naspi  NSAPI
// \param ulTeId  UL TeId
// \param dlTeId  DL TeId
// \param gsnAddr  Address of SGSN/GGSN
//
static
...
// Send a PDU (Packet Data Unit) notification to SGSN to init
// PDP context activation by network
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN data
// \param pdpInfo  PDP info
//
static
...
// Tunnel a data packet to RNC via SGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN data
// \param pdpInfo  PDP Context info
// \param msg  Data packet to be forwarde3d
//
static
...
/// VLR/HLR
//////////////
// Print out the entries in VLR data base
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
...
// Update information in HLR for a UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param vlrEntry  Pointer to the entry in VLR
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param cellId  cellId of the nodeB
// \param nodeId  Node id of Nodeb
// \param rncId  Node Id of RNC
//
static
...
// \param nodeId  Node id of Nodeb
// \param rncId  Node Id of RNC
// \param queryRncId  querying RND's Node  Id
//
static
...
// Handle a Mobility Management message from a UE .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
// \param msg  Pointer to the NAS message contents
...
// Handle a CM SERVICE REQUEST from a UE .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ti  transaction Id
...
// Handle a PAGING RESPONSE from a UE .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ti  transaction Id
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param pktBuff  Pointer to the packet
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param gsnL3  GSN layer3 data
// \param attachResult  attach result
// \param ueId  UE Id
//
static
...
// Handle a GPRS Mobility Management message from a UE .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msgType  Message type
...
// Handle a T3350 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
//
// \return msg need to be reused or not
static
...
// Handle a HLR CELL UPDATE timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// SM
////////
// Send a accept message for PDP Context Activation Req
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param gsnL3  gsn data
// \param flowInfo  Info of the SM session
// \param rabId  Allocated RAB ID
...
// Send a reject message for a PDP Context Activation Req
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param gsnL3  gsn data
// \param flowInfo  Info of the SM session
// \param rejectCause  Reason of the rejection
//
static
...
// \param umtsL3  Pointer to L3 data
// \param gsnL3  gsn data
// \param srcDestType  app src-dest type
...
// Send a Deactivate PDP Context Request
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to L3 data
// \param gsnL3  gsn data
// \param flowInfo  Pointer to flow
// \param deactCause  deactivation cause
//
static
...
// Handle SM Deactivate PDP Context Accept from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transactId  Transaction ID
...
// Handle a T3313 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a T3385 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a T3395 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
///***************************************************************
// Send a CC CALL PROCEEDING message to the UE
//
// \param node  Pointer to node.
// \param gsnL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
// \param ueFlow  app info
//
static
...
// Send a CC ALERTING message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
// \param ueFlow  app info
//
static
...
// Send a CC CONNECT message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// Send a SETUP message to the UE to establish a mobile
// terminating call
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
// \param ueFlow  Pointer to the application flow
//
static
...
// Send a CONNECT ACKNOWLEDGE message to the UE to establish a
...
// Send a DISCONNECT message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
// \param ueFlow  Pointer to the application flow
// \param clearType  Call clear type
//
static
...
// Send a RELEASE message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// Send a RELEASE COMPLETE message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// Initiate Call clearing procedure from the network
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// MSC sends a call setup to GMSC to
...
// MSC sends an ALERTING message to the GMSC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// MSC sends a CONNECT message to the GMSC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueNas  Pointer to the UE info data
...
// MSC sends a DISCONNECT message to the GMSC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
...
// GMSC sends an ALERTING to MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueId  Node Id of UE
// \param mobOrigcall  Info of the MO call
//
static
...
// GMSC sends a DISCONNECT to MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueId  Node Id of UE
// \param clearingTermCall  info of the TO call
// \param clearType  call clear type
//
static
...
// GMSC sends a call setup MSC to
// set up a mobile terminating call
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the GSN Layer3 data
// \param ueId  Node Id of UE
// \param mobTermCall  Info of the MT call
//
static
...
// Handle a CC T301  timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CC T303 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CC T310 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CC T313 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CC T305 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CC T308 timer expired msg
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  UE data
...
// Handle a CALL SETUP message from the GMSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
// \param packet  Pointer to the message content
// \param pktSize  Message size
//
static
...
// Handle an ALERTING  message from the GMSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle a CONNECT message from the GMSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle a DISCONNECT message from the GMSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle a CALL SETUP message from the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
// \param ti  Transaction ID
// \param packet  Pointer to the NAS message contents
// \param pktSize  Message size
// \param srcMscAddr  MSC address the message is from
//
static
...
// Handle an ALERTING message from the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle an CONNECT message from the MSC originated from the
...
// Handle an DISCONNECT message from the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// \param packet  Pointer to the NAS message contents
// \param pktSize  Message size
// \param srcMscAddr  source MSC address
//
static
...
// Handle a backbone CS domain data packet from the RNC .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle a backbone CS domain data packet from GGSN(GMSC) .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// Handle a backbone CS domain data packet from SGSN(MSC) .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the UMTS Layer3 data
// \param ueId  UE ID
...
// handle NAS  msg
////////
// Handle a NAS stratum message from a UE.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Pointer to the NAS message contents
...
// Handle a Initial UE RANAP message from one RNC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Direct Transfer RANAP message from one RNC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RAB_ASSIGNMENT_RESPONSE for voice call set up
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RAB_ASSIGNMENT_RESPONSE message.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a IU RELEASE reported by the RNC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a Iur message encasulated in the RANAP message.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RANAP message from one RNC.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
// \param nsapi  NSAPI of the PDP
// \param dlTeId  dl TEID
// \param ulTeId  ul TEID
// \param qosInfo  QoS Info
//
// \return Newly added PDP info
static
...
// \param teId  Te Id
// \param ueId  UE Id
// \param upLink  Is it uplink
//
// \return Founded PDP Info
static
...
// Handle a GTP CreatePDPContextResponse msg at SGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
// \param msg  Message containing the packet
// \param srcAddr  src adrress
// \param gtpHeader  GTP header
// \param extHeader  extended header
// \param extHeaderSize  size of the extended header size
//
static
...
// Handle a GTP PDU Notification Request msg at SGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
...
// Handle a GTP CreatePDPContextRequest msg at GGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
          ...
          Address srcAddr)
{
    ...
    IpHeaderType ip4Header;
    ip6_hdr ip6Header;
    int ipVersion = IpHeaderGetVersion(reinterpret_cast<const void*>(payload));
    switch (ipVersion)
    {
    case 4:
        ip4Header = *reinterpret_cast<const IpHeaderType*>(payload);
        interfaceIndex = NetworkGetInterfaceIndexForDestAddress(
                            node, ip4Header.ip_dst);
        break;

    case 6:
        ip6Header = *reinterpret_cast<const ip6_hdr*>(payload);
        interfaceIndex = Ipv6GetInterfaceIndexForDestAddress(
                            node, ip6Header.ip6_dst);
        break;

    default:
        interfaceIndex = -1;
        ERROR_ReportWarningArgs("unknown IP version:%d", ipVersion);
        break;
    }
    ...
    UmtsLayer3BuildFlowClassifierInfo(
            node,
            interfaceIndex,
            (ipVersion == 4) ? NETWORK_IPV4 : NETWORK_IPV6, //networkType,
            msg,
            &tos,
            &appClsInfo,
            &payload);
...
// \param gtpHeader  GTP header
// \param extHeader  extended header
// \param extheaderSize  size of the extended header
//
static
...
// Handle a GTP CreatePDPContextResponse msg at GGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
...
// Handle a PDU Notification Response msg at GGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
// \param msg  Message containing the packet
// \param srcAddr  From which the msg come
// \param gtpHeader  GTP header
// \param extHeader  Extended header
// \param extHeaderSize  Size of extended header
//
static
...
// Handle a GTP msg at GGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
// \param msg  Message containing the packet
// \param interfaceIndex  interface Index where the msg coming
// \param srcAddr  Source node address
//
static
...
// Handle a GTP msg from GGSN/SGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  GSN layer 3 data
...
// Handle a packet of a CS flow from outside net
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param flowClsInfo  Classifier of flow
// \param msg  Message containing the packet
// \param internal  If the packet from internal UE
//
// \return msg need ot be reused or not
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param pdpInfo  PDP info stored at GGSN
// \param msg  Message containing the packet
// \param internal  If the packet from an internal UE
//
// \return msg need ot be reused or not
static
...
// Handle a hello packet from neighbor RNCs.
...
// Handle packets from outside PDNs to the cellular
//
// \param node  Pointer to node.
// \param msg  Message to be handled
// \param inIfIndex  Interface from which the packet was received
         ...
         BOOL internal)
{
    ...
    {
    case NETWORK_DUAL:
        ipVersion = IpHeaderGetVersion(reinterpret_cast<const void*>(payload));
        break;
    ...
    default:
        ERROR_ReportWarningArgs("incorrect IP version (hdr version:%d, network type:%d)", ipVersion, netType);
        break;
    }
    ...
    if (pdpInfo == NULL)
    {
        ...
        {
        case 4:
            SetIPv4AddressInfo(&pdpInfo->uePdpAddr, ip4Header.ip_dst);
            break;

        case 6:
            SetIPv6AddressInfo(&pdpInfo->uePdpAddr, ip6Header.ip6_dst);
            break;
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param gsnL3  POinter to PHY UMTS GSN data
//
static
...
// Initialize GSN data at UMTS layer 3 data.
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to node input.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle GSN specific timers and layer messages.
//
// \param node  Pointer to node.
...
// Print GSN specific stats and clear protocol variables.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
...
// \param netType  network type. IPv4 or IPv6
//
