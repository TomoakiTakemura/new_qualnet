...
/// Used for generating a random delay before power on an UE
#define UMTS_LAYER3_UE_START_JITTER    (1 * MICRO_SECOND)


/// MM sublayer main states in the mobile station
typedef enum
{
    UMTS_MM_MS_NULL = 0,
...
/// MM sublayer substates in IDLE state in the mobile station
typedef enum
{
...
/// MM sublayer update status in the mobile station
typedef enum
{
    UMTS_MM_UPDATED = 1,
...
// GMM 
///////////
/// GMM sublayer main states in the mobile station
typedef enum
{
    UMTS_GMM_MS_NULL,
...
/// GMM sublayer substates in the state DEREGISTERED
...
/// GMM sublayer substates in the state 
...
/// GMM sublayer update status in the mobile station
typedef enum
{
    UMTS_GMM_UPDATED = 1,
...
/// Call control substates in the mobile station
typedef enum
{
    UMTS_CC_MS_NULL = 0,
...
/// Session management states in the mobile station
typedef enum
{
...
/// Structure of the UE specific MM data in the MS side
typedef struct 
{
    UInt32 tmsi; 
...
/// Structure of the UE specific GMM data in the MS side
typedef struct 
{
...
/// Structure of the UE specific CC data 
typedef struct 
{
    UmtsCcMsState state;
...
/// Structure of the UE specific SM data 
typedef struct 
{
...
/// Structure of the UE call management 
typedef struct
{
    UmtsCcMsData* ccData;
    UmtsSmMsData* smData;
...
/// Structure of the application information at UE
...
/// Structure of the UE specific layer 3 data UMTS UE node
...
/// \param msg  Message to be sent over the air interface
