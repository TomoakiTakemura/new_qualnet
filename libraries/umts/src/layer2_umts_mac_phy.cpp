...
// \param priSc  primary scrambling code
//
// \return Ue Info at nodeB
static
...
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param phyUmts  UMTS Phy data
// \param phyDataNodeB  NodeB Phy data
//    + scCodeIndex  : unsigned int : scrambling code index 
// \param sinr  sinr of the received signal
// \param rxPower_mW  signal strength of the received signal
...
// \param phyVar  phy data
// \param chType  physical channel type
// \param scCodeIndex  channel Idetifier
// \param phChCode  phsical channel code for
//    the incoming burst
// \param sfFactor  Spreading factor
static
...
// Get the transport channel info from the channel info list
//
...
// \param node  Pointer to node.
// \param interfaceIndex  interface Index
// \param phyChList        : std:  Phy ch list
// \param chType  Channel type
// \param phChId  channel Id
//    + burstStartTime   : clocktype         : start time of the burst 
// \param burstEndTime  end time of the burst
// \param burstInfo  burstInfo to create
//
static
...
// \param node  Pointer to node.
// \param interfaceIndex  interface Index
// \param phyDataUe  PhyUeData
// \param priScCode  primary Sc Code
//
// \return cqiVal
static
...
// Handle Interlayer CPHY-RL-SETUP-REQ at NodeB
// or CPHY-RL-MODIFY_REQ
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param umtsMacData  Umts Mac Data
// \param nodeBMacVar  NodeB mac var
// \param cmd  cmd to handle
// \param isRlSetup  IS RL setup
//
static
...
// Handle Interlayer CPHY-RL-RELEASE-REQ at Ue
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
// \param umtsMacData  Umts Mac Data
...
// \param node  Pointer to node.
// \param interfaceIndex  interface Index
// \param nodeBMacVar  NodeB Mac Data
// \param phyType  Physical channel type
...
//
// \param node  Pointer to node.
// \param phyDataUe  UE PHY data
// \param msg  PSCH Packet received from PHY
//
static
...
// \param interfaceIndex  interface Index
// \param phyDataUe  UE PHY data
// \param msg  CPICH Packet received from PHY
//
static
...
// Receive a power control command from network
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface Index
// \param phyDataUe  Phy Data at UE
// \param priSc  primary scrambiling code
// \param pcCmd  power control cmd
//
static
...
// Handle Interlayer command at Ue
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
...
// release  dedicated physical channel
//
// \param node  Pointer to node.
// \param interfaceIndex  interface index
//
