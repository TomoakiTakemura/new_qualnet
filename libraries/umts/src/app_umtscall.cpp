...
#define DEBUG_APP   0
//***********************************************************************
// Retrive the application info from the app List.
//
// \param node  Pointer to node.
// \param appId  id of the application.
// \param appSrcNodeId  src node id, who generate this app
...
//
// \return success or fail when looking for the app in the list
//************************************************************************
static BOOL
...
//**************************************************************
// Schedule a call end timer
//
// \param node  Pointer to node.
// \param callApp  Pointer to the umts call app
// \param delay  delay for the timer
//
//*************************************************************
static
...
//**************************************************************
// Start to generate voice packet and send them to lower layer
//
// \param node  Pointer to node.
// \param appUmtsCallLayerData  Pointer to the app data
// \param callApp  Pointer to the umts call app
//
//*************************************************************
static
...
//**************************************************************
// Handle call start timer expiration event
//
// \param node  Pointer to node.
// \param msg  Point to the Callstart Msg
//
//*************************************************************
static
...
//*****************************************************************
// Handle Call end timer expiration event
//
// \param node  Pointer to node.
// \param msg  Point to the CallEnd Msg
//
//****************************************************************
static
...
//**************************************************************
// Handle talk start timer expiration event
//
// \param node  Pointer to node.
// \param msg  Point to the Callstart Msg
//
...
//**************************************************************
// Handle Call Accept msg from netowrk
//
// \param node  Pointer to node.
// \param msg  Point to the call accept
//
//***************************************************************
static void
...
//**********************************************************************
// Handle Call Dropped msg from netowrk
//
// \param node  Pointer to node.
// \param msg  Point to the call accept
//
...
//**********************************************************************
// Handle Call Reject msg from netowrk
//
// \param node  Pointer to node.
// \param msg  Point to the call accept
//
...
//**********************************************************************
// Handle Packet arrival from the lower layer
//
// \param node  Pointer to node.
// \param msg  Point to the call accept
//
...
//***********************************************************************
// Init the statistic of app layer
//
// \param node  Pointer to node.
// \param nodeInput  Point to the input
//
//***********************************************************************
static
