...
// Attempt to remove a nodeb into the active set
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  The UE RRC data in RNC
// \param nodebInfo  The monitored nodeb info
//
static
...
// Attempt to add a nodeb into the active set
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  The UE RRC data in RNC
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param rncL3  Pointer to the RNC data
//
static
...
// Finish the current RAB assigment procedure,
// Check RAB request serving queue to see if there is new
// RAB request to be served
//
// \param node  Pointer to node.
...
// Remove queued RAB request upon RRC CONN release
//
// \param node  Pointer to node.
// \param rncL3  Pointer to RNC layer3 data
// \param ueId  UE Id
...
// Check NodeB resources for CAC (UL)
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to the NodeB data in RNC
// \param ulBwAlloc  UL bandwidth allocated
// \param ulBwReq  UL bandwidth requested
//
// \return TRUE if resources can be allocated
...
// Check NodeB resources for CAC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to nodeB data in RNC
// \param dlBwAlloc  DL bandwidth allocated
// \param dlBwReq  DL bandwidth requested
// \param hsdpaRb  HSDPA radio bearer or not
//
// \return TRUE if resources can be allocated
...
// Print out RNC specific parameters
//
// \param node  Pointer to node.
// \param rncL3  Pointer to UMTS RNC Layer3 data
//
static
...
// Initialize RNC specific parameters
//
// \param node  Pointer to node.
...
// Print the whole code tree at RNC for one NodeB
//
// \param node  Pointer to node.
// \param codeTree  Binary tree maintains alloc condition
// \param nodebId  ID of the NodeB that this code tree belongs to
//
static
...
// Mark the code tree accordingly
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the layer3 data
// \param codeTree  Binary tree maintains alloc condition
// \param spreadFactor  level of spread factor in tree
// \param numCodeAlloced  Number of codes alloced
// \param hsdpaRb  HSDPA RB or not
//
static
...
// Allocate one or multiple codes with given spread factor.
...
// \param codeTree  Binary tree maintains alloc condition
// \param spreadFactor  level of spread factor in tree
// \param numCodeNeeded  Number of codes needed
// \param allocCodeList  To store codes allocated
// \param hsdpaRb  HSDPA RB or not
//
// \return Actual number of codes allocated
static
...
// Allocate ovsf code and spreading factor at NodeB side given
// requested data rate.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the layer3 data
// \param nodebRrc  Pointer to the UE data in RNC
// \param dataRate  Requested data bit rate (bps)
//    + sfs       : UmtsSpreadFactor*      : For returning of the allocated 
//    spread factors
// \param codes  For returning of the allocated
//    OVSF code indexes
...
// \param hsdpaRb  HSDPA Rb or not
//
// \return TRUE, if new code assigned
static
...
// Release ovsf code at NodeB side at RNC node
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the layer3 data
// \param nodebRrc  Pointer to the NodeB data at RNC
// \param numCodes  # of codes to be released
// \param codeList  List of codes to be released
//
static
...
// Initialize a UE RRC data for an UE connecting to this RNC
//
// \param node  Pointer to node.
// \param ueId  UE ID
// \param nodebRrc  NodeB Data at RNC
//
// \return The created UE RRC data
static
...
// Finnalize UE RRC data
//
// \param node  Pointer to node.
// \param rrcData  The created UE RRC data
//
static
...
// Find a UE RRC data in RNC layer3 data structure
//
// \param node  Pointer to node.
// \param rncL3  Pointer to UMTS RNC Layer3 data
// \param ueId  UE Id
...
// Find a NodeB RRC data in RNC layer3 data structure
//
// \param node  Pointer to node.
// \param rncL3  Pointer to UMTS RNC Layer3 data
// \param nodebId  NodeB Id
//
// \return The nodeb RRC data
static
...
#if 0
// Create a UE RRC data for a newly connected UE
// add into the UE RRC data list
//
// \param node  Pointer to node.
// \param rncL3  Pointer to UMTS RNC Layer3 data
// \param ueRrc  The ue RRC data
//
...
// Remove a UE RRC data from the UE RRC data list
// and detroy the data
//
// \param node  Pointer to node.
// \param ueId  UE Id
...
// preallocate some resource in a NodeB RRC data
//
// \param node  Pointer to node.
// \param nodebRrc  Pointer to the rrcData
//
static
...
// Initialize a NodeB RRC data
//
// \param node  Pointer to node.
// \param nodebId  NodeB ID
//
// \return The created Nodeb RRC data
static
...
// Finnalize NodeB RRC data
//
// \param node  Pointer to node.
// \param rrcData  The Nodeb RRC data
//
static
...
// Delete RAB control data after releasing RAB
//
// \param node  Pointer to node.
// \param ueData  UE data structure in RNC
//
static
...
// Print out RNC specific statistics
//
// \param node  Pointer to node.
// \param rncL3  Pointer to UMTS RNC Layer3 data
//
...
// Send a NBAP message to a Nodeb
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the NBAP message
// \param msgType  NBAP message type
// \param transctId  message transaction Id
// \param nodebId  The NodeB ID
// \param ueId  The UE ID associated in the message
//
static
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the NBAP message
// \param ueId  The destination UE Id
// \param rbId  The destination RB Id
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Msg containing the NBAP message
// \param ueId  UE ID
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Msg containing the NBAP message
// \param destRnc  Destination RNC ID
// \param msgType  RANAP message type
//
// \return MESSAGE*
static
...
#if 0
// Send a IUR message a DRNC to update the SRNC
...
// Send JOIN ACTIVE SET RESPONSE from Nodeb back to SRNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param success  Join active set result
// \param ueId  The ue id originating the msg
// \param cellId  Cell Id of the nodeB
...
// Send LEAVE ACTIVE SET RESPONSE from Nodeb back to SRNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the message
// \param cellId  Cell Id of the nodeB
// \param cellInfo  Cell Info
//    + cellInfoSize   : int                    : Size of cell info 
//
...
// Send IUR NODEB RB SETUP RESPONSE to SRNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param success  setup successully or not
// \param ueId  The ue id originating the message
// \param rbSetupPara  RB Setup parameters
//
// \return : void
static
...
// Send a RAB_ASSIGNENT_RESPOND to 
// reply RAB_ASSIGNMENT_REQUEST .
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID
// \param setupSuccess  whether RAB setup is success
// \param domain  domain ID
// \param connMap  RAB connection map
// \param rabId  Assigned RAB ID
//
static
...
// Send a IU_RELEASE or IU_RELEASE_COMPlETE to the SGSN
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  NodeId of the UE
// \param domain  domain ID
// \param reply  reply or not
//
static
...
// Configure RB parameters based on QoS and domain information
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  Ue Data at RNC
// \param ulRabPara  UL RAB QoS requirement param
// \param dlRabPara  DL RAB QoS requirement param
// \param domain  Domain ID
// \param rlcType  RLC type
// \param ueRlcConfig  RLC config for UE
// \param nodeBRlcConfig  RLC cofnig for nodeB
//    + ulTransFormat : UmtsTransportFormat& : UL transport format 
// \param dlTransFormat  DL transport format
//
// \return Qos Support or not
...
// Check if there is ongoing RAB est/release process
...
// Initiate Cell lookup located outside current RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to the layer3 data
// \param cellId  CELL ID of this NodeB to be searched (not nodebId)
//
static
...
// Send RR Msg
//
// Build RRC_CONNECTION_SETUP message with specificaion mode
// set as "Preconfiguration"
//
// \param node  Pointer to node.
// \param transctId  transaction id
// \param initUeId  Initial UE identifier
// \param stateIndi  RRC state indicator
// \param preConfigMode  Preconfiguration mode
// \param ueScCode  UE primary scrambling code
// \param dlDpdchInfo  downlink DPDCH information
//
// \return Point to the message containing DSC-REQ PDU
static
...
// Build RRC_CONNECTION_REJECT message
//
// \param node  Pointer to node.
// \param transctId  transaction id
// \param initUeId  Initial UE identifier
...
// Send RRC CONNECTION SETUP message to UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID the message to be sent
// \param dlDpdchInfo  downlink DPDCH information
//
static
...
// Send RRC_CONNECTION_REJECT message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
// \param ueId  UE identifier
// \param nodebId  The nodeb Id the msg to be sent to
//
static
...
// Send RRC_CONNECTION_RELEASE message to the UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  transaction id
// \param ueRrc  UE RRC data at RNC
//
static
...
// Send RB SETUP message to UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data at RNC
// \param pendingRab  Rab info
// \param rabId  Rab ID
//
static
...
// Send ACTIVE SET UPDATE message to UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  UE ID the message to be sent
// \param addCell  add cell or not
// \param cellInfo  cell info
// \param cellIfnoSize  size of the cell info
//
static
...
// Send SIGNAL CONNECTION RELEASE message to UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data at RNC
...
// Send RRC CONNECTION SETUP message to NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to UE RRC data in RNC
// \param ueId  The UE ID associated with the
...
// Send RB setup to the Nodeb
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  NodeB data in RNC
// \param nodebPara  Nodeb RB setup parameters
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to the NodeB RRC data
// \param nodebPara  Nodeb RB setup parameters
//
static
...
// Release NodeB resources for releasing SRB1-3 for a UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to the NodeB RRC data
// \param ueId  Node Id Of UE
// \param nodebPara  Nodeb RB setup parameters
//
static
...
// Check NodeB resources for setting SRB1-3 for a UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Pointer to the NodeB RRC data
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  Pointer to the UE RRC data
//
static
...
// Send RRC CONNECTION RELEASE message to Nodeb
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  Node ID of UE
// \param cellId  cell ID of NodeB
// \param nodebSrbConfig  configuration parameters
//
static
...
// Send RRC CONNECTION RELEASE message to Nodeb through
// IUR interface
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param cellId  cell ID of NodeB
// \param drncId  Drift RNC id
// \param ueId  Node ID of UE
// \param nodebSrbConfig  configuration parameters
//
static
...
// Request to Nodeb to release SRB 1-3
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data
...
// Initiate configuring signaling RB 1-3 by sending
// NBAP RADIO LINK SETUP REQUEST message to the related
// NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The UE Id to be set up
// \param ueRrc  The UE RRC data stored in the RNC
// \param nodebId  The Nodeb Id to be set up
//
// \return TRUE if resources can be allocated
static
...
// Start to config UE RRC CONNECTION
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The UE Id to be set up
// \param nodebRrc  Node RRC data at RNC
//
// \return TRUE if resources can be allocated
static
...
// Initiate releasing signaling RB 1-3
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  The UE RRC data stored in the RNC
//    + nodebRrc  : UmtsRrcNodebDataInRnc* : Pointer to the NodeB RRC data 
// \param BOOL  rlease UE res. for SRB?
//
// \return Pointer to the message to 
...
// Check NodeB resources for Radio Bearer Setup
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebId  The Nodeb Id to be set up
...
// Check Ue resources for Radio Bearer Setup
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  Pointer to the UE RRC data
// \param rbSetupPara  RB setup parameters
// \param ulRabPara  UL RAB para
//
// \return TRUE if resources can be allocated
static
...
// Store Nodeb Resource channges for RB Setup
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  NodeB RRC data
// \param nodebPara  NodeB RB setup parameters
//
static
...
// \param nodebRrc  NodeB RRC data
// \param nodebPara  NodeB RB setup parameters
// \param dlRabPara  DL RAB parameters
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE Data In RNC
// \param uePara  UE RB Setup para
// \param domain  Domina ID
// \param connMap  Rb conn Map
// \param rabPara  RAB Info
//
static
...
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data in RNC
// \param rabId  RAB Id
...
// Handle RB setup response from one Nodeb, it may
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data in RNC
// \param initNodebPara  init Rb setup para
// \param ulRabPara  UL RAB info
// \param dlRabPara  DL RAB info
//
// \return TRUE if resource can be allocated in the nodeB
static
...
// Initiate Radio Access Bearer Setup process, invoked
...
// Initiate Radio Access Bearer Release process,
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the msg
...
// Release network side resource for RRC CONNECTION RELEASE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param rncL3  RNC layer3 data
// \param ueRrc  Pointer to the UE rrc data
//
static
...
// The RNC request a NodeB to join the active set
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param nodebRrc  Nodeb RRC data in RNC
// \param ueId  Nodeid of NodeB
// \param nodebSrbConfig  Singalling Rb setup para
// \param nodebParaVec : std:  nodeB BR setup
//    parameters
//
static
...
// The RNC request the NodeB cease to be the primary cell
// or a NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param rncL3  RNC layer data
// \param ueRrc  UE RRC data in RNC
// \param cellId  cellId of NodeB
// \param enableCell  enabel cell or not
// \param extraInfo  extra information of the switch
// \param extraInfosize  size of the extra info
//
static
...
// Remove radio link info of a cell from stored RAB info
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data in RNC
...
// Add radio link info of a cell from stored RAB info
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data in RNC
// \param cellId  cellId of NodeB
// \param cellInfo  cell info
// \param cellifnoSize  size of cell info
//
static
...
// Handle JOIN/LEAVE ACTIVE SET RESPONSE from Nodeb, it may
// come indirectly from a Nodeb through a drifting RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param cellId  Cell Id
// \param success  Join succesfully or not
// \param ueId  The ue id originating the msg
// \param join  join or not
// \param cellinfo  cell info
// \param cellInfoSize  size of cell Info
//
static
...
// \param nodebRrc  NodeB data in RNC
// \param ueId  Ue Id
// \param nodebSrbConfig  signallign RB setup para
// \param rabParaVec  : const std:  RAB info
// \param nodebParaVec : std:  nodeb RB setup
//
static
...
// The RNC request a NodeB to join the active set through
// IUR interface
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param cellId  Cell Id
// \param drncId  Drgift RNC node Id
// \param ueId  Ue Id
// \param nodebSrbConfig  signallign RB setup para
// \param rabParaVec  : const std:  RAB info
// \param nodebParaVec : std:  nodeb RB setup
...
// Complete the Primary Cell Switch process
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueRrc  UE RRC data at RNC
...
// Send a PAGE TYPE 1 or PAGE TYPE 2 message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the msg
...
// handle RRC Msg
//
// Handling RRC CONNETION REQUEST message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param interfaceIndex  Interface from which packet was received
// \param msg  RRC message.
//
static
...
// Handling RRC CONNETION SETUP COMPLETE message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param transctId  Transaction Id
// \param interfaceIndex  Interface from which packet was received
// \param ueId  The ue id originating the message
// \param rbId  RB ID the message belongs to
// \param msg  RRC message.
//
static
...
// Handling RRC CONNETION RELEASE COMPLETE message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
// Handling a RRC Initial Direct Transfer message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param interfaceIndex  Interface from which packet was received
...
// Handling a RRC Uplink Direct Transfer message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param interfaceIndex  Interface from which packet was received
...
// Handling RADIO Bearer Setup Complete message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the message
...
// Handling RADIO Bearer Release Complete message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the message
...
// update the monitored Cell Info for UE
// + node      : Node*        : Pointer to node.
// + umtsL3    : UmtsLayer3Data * : Pointer to UMTS Layer3 data
...
// Handling MEASUREMENT REPORT message from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the message
...
// Handling SIGNAL CONNECTION RELEASE INDICATION msg from UE
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param ueId  The ue id originating the message
...
// handle NBAP message
//
// Handling RRC CONNETION SETUP RESPONSE message from NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
//
// Handling RADIO BEARER SETUP RESPONSE message from NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
// Handling RADIO BEARER RELEASE RESPONSE message from the NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
// Handling SWITCH CELL RESPONSE message from NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
// \param ueId  UE ID
//
// \return whether message is reused in the function
static
...
// Handling REPORT RLC ERROR message from NodeB
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  RRC message.
...
//
// Handle a Direct Transfer RANAP message from the SGSN.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RANAP Paging message from the SGSN.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a RAB ASSIGNMENT REQUEST message from the SGSN.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle an IU RELEASE COMMAND message from the SGSN.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// \param ueId  The ue id originating the message
// \param rbId  RB ID the message belongs to
// \param msgType  Radio resource control msg type
// \param transactId  Message transation Id
...
// \param ueId  The ue id originating the message
// \param rbId  RB ID the message belongs to
// \param srcAddr  Source node address
//
static
...
// Handle Iur Messag
//
// Handle a JOIN ACTIVE SET IUR message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a LEAVE ACTIVE SET IUR message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a hello packet from neighbor NodeBs or RNCs.
...
// Handle a IUR message from another RNC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
// \param msgType  Iur message type
// \param ueId  UE ID
// \param additionInfo  additonal information
// \param additionInfoSize  size of additional info
// \param srcAddr  Source node address
//
static
...
// Handle a Iub message from Nodeb, it may be a NBAP
...
// \param umtsL3  Pointer to UMTS Layer3 data
// \param interfaceIndex  Interface from which packet was received
// \param srcNodeId  The source node id of the message
// \param rbIdOrMsgType  RB ID or NBAP message type
// \param srcAddr  Source node address
//
static
...
// Handle a RANAP message from the SGSN.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
// Handle a GTP message
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
// \param ueId  ID of the UE
...
// Handle a CS data packet from the MSC
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
// \param msg  Message containing the packet
...
//  Key API functions
//--------------------------------------------------------------------------
// Initialize RNC data at UMTS layer 3 data.
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to node input.
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle RNC specific timers and layer messages.
//
// \param node  Pointer to node.
// \param msg  Message for node to interpret
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Handle packets received from wired network
//
// \param node  Pointer to node.
// \param msg  Message containing the packet
// \param umtsL3  Pointer to UMTS Layer3 data
...
// Print RNC specific stats and clear protocol variables.
//
// \param node  Pointer to node.
// \param umtsL3  Pointer to UMTS Layer3 data
//
