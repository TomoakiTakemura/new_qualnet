...
/// Default value of the interval between system info msgs
#define UMTS_RNC_DEF_SYSTEM_INFO_BROADCAST_INTERVAL (30 * SECOND)

/// Default value of the AS threshold for Soft Handover
#define UMTS_RNC_DEF_SHO_AS_THRESHOLD (3.0)

/// Default value of the hysteresis of SHO AS Threshold
#define UMTS_RNC_DEF_SHO_AS_THRESHOLD_HYSTERESIS (1.0)

/// Default value of the replace hysteresis for SHO
#define UMTS_RNC_DEF_SHO_AS_REPLACE_HYSTERESIS (1.0)


/// Maximum spending factor of the code. This must be
/// power of 2.
#define UMTS_RNC_MAX_SPREAD_FACTOR     256

/// Level of maximum spread factor in the code tree. This one
...
/// Level of minimum spread factor in the code tree. This one
...
/// The maximum hs-dsch code supported in the system
#define UMTS_RNC_MAX_HSDSCH_CODE 5

/// Max number of codes can be allocated once
#define UMTS_RNC_MAX_NUM_CODE_PER_ALLOC     15

/// Maximum duration allowed to switch a primary cell
...
/// Status of a code in the code tree. Used for allocation
...
/// Monitored NodeB information for a UE
...
//--------------------------------------------------------------------------
/// Uplink DCH info for each UE
struct  UmtsUlDchInfo
{
    UInt32 rbBitSet;                        //RB bitset
};

/// Downlink DCH info for each NodeB
...
/// Uplink DPDCH info for each UE
struct  UmtsUlDpdchInfo
{
    UInt32 rbBitSet;                        //RB bitset
};

/// Downlink DPDCH info for each NodeB
...
/// Downlink HS-SCCH info for each NodeB
...
/// RAB info in pending state(to setup or release)
...
/// RRC data structure per UE at RNC
...
/// RRC Connection Release Request related inforamtion
...
/// RAB assignment request info at RNC
...
/// Structure of the RNC specific layer 3 data UMTS RNC node
