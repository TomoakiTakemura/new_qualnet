...
/// RLC sublayer stat structure at a UE & NodeB
typedef struct
{
    // to add mac stats here
} UmtsMacStats;

/// Umts logical Channel Info
...
/// Function struct to compare to UmtsLogChInfo
...
/// Function struct to compare to UmtsTransChInfo
...
/// MAC sublayer structure at a UE
...
/// MAC sublayer structure at a NodeB
typedef struct
{
...
/// MAC sublayer structure at a UE & NodeB
typedef struct
{
