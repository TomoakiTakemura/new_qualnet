...
/// \defgroup Package_UMTS_CONSTANTS UMTS_CONSTANTS

/// \file
/// \ingroup Package_UMTS_CONSTANTS
/// Defines constants in UMTS Model
...
/// max number of CN domains, standard is 4
#define UMTS_MAX_CN_DOMAIN 2

// 2. UTRAN mobility infomation

/// max number of URAs in a cell
#define UMTS_MAX_URA 8

/// max number of RABs to be established 
...
/// max number of predefined  configuration
#define UMTS_MAX_PREDEF_CONFIG 16

/// max number of RBs
#define UMTS_MAX_RB 32

/// max number of Signaling RBs
#define UMTS_MAX_SRB_SETUP 8

/// max number of RBs per RAB
#define UMTS_MAX_RB_PER_RAB 8

/// max number of non Signaling RBs
#define UMTS_MAX_RB_ALL_RAB 27

/// max number of RBs per TrCh
#define UMTS_MAX_RB_PER_TRCH 16

/// max number of Logical Channel ID per type per direction
#define UMTS_MAX_LOCH 16

/// max number of Log. Ch. ID per type per direction per cell
#define UMTS_MAX_LOCH_PER_CELL 256

/// max number of Logical Channel type
#define UMTS_MAX_LOCH_TYPE 10

/// max number of LogCh per RLC
#define UMTS_MAX_LOCH_PER_RLC 2

// 5. TrCh information

/// max number of trCh per type used in one direction UL/DL
#define UMTS_MAX_TRCH 32

/// max number of DL trCh per cell for each type 
#define UMTS_MAX_DL_TRCH_PER_CELL 256

/// max number of trCh type 
#define UMTS_MAX_TRCH_TYPE 9

/// max number of preconfiged trCh used in one direction UL/DL
#define UMTS_MAX_TRCH_PRECONFIG 16

/// max number of CCTrCh
#define UMTS_MAX_CCTrCH 8

/// max number of transport format can be included in the 
/// transport format set for one transport channel
#define UMTS_MAX_TF 32

/// max number of transport format combination
#define UMTS_MAX_TFC 1024

/// max number of transport format combination subset
#define UMTS_MAX_TFC_SUB 1024

/// max number of complete system information blocks per 
/// SYSTEM INFORMATION msg
#define UMTS_MAX_SIB_PER_MSG 16

/// max number of references to other 
...
/// Default value of the system information broadcast interval
...
/// Dl DPCH field format defined in standard, total 49
...
/// UL DPDCH field format defined in the standard
...
/// UL DPCCH slot format defined in standard 
...
/// PRACH slot format defined in standard 
...
/// HS-DSCH slot format defined in the standard 
...
// CONSTANT
/// Default slot flomat for various channel type
// DL
...
// CONSTANT
/// Default transport format for differnt channel and services
