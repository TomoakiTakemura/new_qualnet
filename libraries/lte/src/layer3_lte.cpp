...
//--------------------------------------------------------------------------
// Initialize configurable parameters of Layer 3.
//
...
// \param interfaceIndex  Interface index
// \param rnti  RNTI
// \param connectedInfo  Connected Info
//
...
// Get Connected Information which is specified RNTI
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface Index
// \param rnti  RNTI
...
void Layer3LteProcessEvent(Node* node, UInt32 interfaceIndex, Message* msg)
{
    ...
    switch (eventType)
    {
        ...
        {
            Layer3LteProcessRadioLinkFailure(node, interfaceIndex, rnti);
            break;
        }
        default:
        {
...
// \param node  Pointer to node.
// \param interfaceIndex  Interface Index
// \param ueRnti  RNTI for which radio link failure is detected
//
...
void Layer3LteNotifyRadioLinkFailure(
    Node* node, int interfaceIndex, LteRnti oppositeRnti)
{
    // Actual process of radio link failure is invoked later as different event
    Layer3LteSetTimerForRrc(
            node, interfaceIndex, oppositeRnti, MSG_RRC_LTE_RadioLinkFailureEvent, 0);
}
