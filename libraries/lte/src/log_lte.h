...
// For complie error at app_dns.h on windows 
#ifdef IN
#undef IN
#endif
...
public:
    ...
    bool loadTopologyFile(const char* fn, const BaseConnectionInfo** dest, int* len);
...
private:
    ...
    const BaseConnectionInfo* validationPatternBCI;
    int validationPatternBCILen;
