    ...
    Node* node, int interfaceIndex, const LteRnti& oppositeRnti)
{
    ...
    if ((node->getNodeTime()/(double)SECOND) < startTime)
    {
        return valData;
    }
                                   ...
                                   Message* msg)
{
    ...
    MacLteReceiveTransportBlockFromPhy(
        node, interfaceIndex, srcRnti, msg);
}
...
void LteLayer2Finalize(Node* node, UInt32 interfaceIndex)
{
    ...
    delete layer2Data->rrcConfig;
    layer2Data->rrcConfig = NULL;

    delete layer2Data->layer3Filtering;
    layer2Data->layer3Filtering = NULL;

    delete layer2Data->lteMacData;
    layer2Data->lteMacData = NULL;

    delete layer2Data->lteRlcVar;
    layer2Data->lteRlcVar = NULL;

    delete layer2Data->ltePdcpData;
    layer2Data->ltePdcpData = NULL;

    delete layer2Data->lteLayer3Data;
    layer2Data->lteLayer3Data = NULL;
}
...
void LteLayer2ProcessEvent(Node* node, UInt32 interfaceIndex, Message* msg)
{
    switch (msg->eventType)
    {
        ...
        case MSG_RRC_LTE_RadioLinkFailureEvent:
        ...
        const Message* pdcpPdu)
{
    ...
    UInt16 sn = (pdcpHeader->octet[0] << 8) | pdcpHeader->octet[1];
