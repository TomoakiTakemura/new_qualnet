...
// \param expiredTimer  expired discard timer message
//
static
...
// \param rnti  rnti
// \param expiredTimer  expired discard timer message
// \param before  current ho status
// \param after  next ho status
//
static
...
// add pdcp header to pdcp sdu
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param dstRnti  destination RNTI
// \param bearerId  Radio Bearer ID
// \param pdcpSdu  pdcp sdu
// \param sn  pdcp pdu sn
//
static
...
// \param dstRnti  destination RNTI
// \param bearerId  Radio Bearer ID
// \param discardTimer  discard timer message
// \param pdcpSdu  pdcp sdu
// \param sn  pdcp pdu sn
//
static
...
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param srcRnti  source RNTI
// \param bearerId  Radio Bearer ID
// \param hoManager  ho manager
// \param rxSn  sn of received message
// \param isReEstablishment  whether pdcp pdu received is re-establishment
//
// \return TRUE
// otherwise              : FALSE
static
...
// \param srcRnti  source RNTI
// \param bearerId  Radio Bearer ID
// \param pdcpEntity  pdcp entity
// \param reorderingBuffer  reordering buffer
// \param itr : list<Message*>:  iterator of reordering buffer
//
static
...
// dequeue msg from such buffer and insert forwarding list
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param rnti  RNTI
// \param bearerId  Radio Bearer ID
// \param forwardingList  forwarding list
// \param hoManager  ho manager
// \param bufferType  buffer type of dequeued msg
//
static
...
// \param retransmissionBuffer  retransmission buffer
//
static
...
// discard pdcp pdu or enqueue in reordering buffer,
...
// \param bearerId  Radio Bearer ID
// \param isReEstablishment  whether pdcp pdu received is re-establishment
// \param pdcpEntity  pointer to pdcp entity
// \param reorderingBuffer  reordering buffer
//    + pdcpPdu        : Message*       : pdcp pdu 
//
static
...
// enqueue pdcp pdu in reordering buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param srcRnti  Source RNTI
// \param bearerId  Radio Bearer ID
// \param hoManager  ho manager
// \param buffer  reordering buffer
// \param itr ; list<Message*>:  iterator of reordering buffer
// \param msg  pdcp pdu
//
static
...
// enqueue pdcp pdu in retransmission buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param srcRnti  Source RNTI
// \param bearerId  Radio Bearer ID
// \param hoManager  ho manager
// \param buffer  retransmission buffer
// \param msg  pdcp pdu
//
static
...
// dequeue pdcp pdu in reordering buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param srcRnti  Source RNTI
...
// \param hoManager  ho manager
// \param buffer  reordering buffer
// \param msg            : list<Message*>:  iterator of pdcp pdu
//
...
// dequeue pdcp pdu in retransmission buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param rnti  RNTI
...
// dequeue pdcp sdu in transmission buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param rnti  RNTI
...
// dequeue pdcp sdu in holding buffer
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param rnti  RNTI
...
// \param bearerId  Radio Bearer ID
// \param hoManager  ho manager
// \param discardTimer  discard timer
// \param itr            : list<Message*>:  iterator of discard timer
//
// \return dequeued message
static
...
// discard pdcp pdu due to retransmission buffer overflow
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param dstRnti  Destination RNTI
...
// discard pdcp pdu due to RLC's tx buffer overflow
//
// \param node  pointer to the network node
// \param interfaceIndex  index of interface
// \param dstRnti  Destination RNTI
                  ...
                  const NodeInput* nodeInput)
{
    ...
    pdcpData->stats.numPktsDiscardDueToAckReceived = 0;
...
//    + void           :
//
// \return current "next PDCP tx SN"
UInt16 LtePdcpEntity::GetAndSetNextPdcpTxSn()
{
        ...
        Message* expiredTimer)
{
    ...
    switch (hoManager.hoStatus) {
        ...
        case PDCP_LTE_UE_IDLE: {
            ...
            ERROR_Assert(itr != discardTimer.end(),
                    "discard timer is not managed");
...
// \param forwardingList  forwarding list
// \param hoManager  ho manager
// \param forwardingType  forwarding type of dequeued msg
//
static
void PdcpLteInsertMsgInForwardingList(
        Node* node,
...
// \param bearerId  Radio Bearer ID
// \param hoManager  ho manager
// \param pdcpPdu  discard pdcp pdu
//
static
void PdcpLteRetransmissionBufferOverflow(
        Node* node,
