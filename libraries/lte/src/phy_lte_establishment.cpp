...
// Append the information of the preamble
//
// \param node  Pointer to node.
// \param phyIndex  Index of the PHY
// \param preamble  Information of the RA preamble to append.
// \param msg  Tx Message
//
//
...
// Append the information of the delay
//
// \param node  Pointer to node.
// \param phyIndex  Index of the PHY
// \param txPreamble  RA preamble to transmit
...
// IF for RRC to setup intra-freq meas config
//
// \param node  Pointer to node.
// \param phyIndex  Index of the PHY
// \param intervalSubframeNum  interval of measurement
// \param offsetSubframe  offset of measurement subframe
// \param filterCoefRSRP  filter Coefficient RSRP
// \param filterCoefRSRQ  filter Coefficient RSRQ
// \param gapInterval  non Serving Cell Measurement Interval
//
