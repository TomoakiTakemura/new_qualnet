...
/// Different types of Urban propagation pathloss models.
...
/// Initialize Urban Propagation Models
///
...
/// Calculate Urban Propagation Pathloss
...
/// \param propProfile  Pointer to propagation profile
/// \param pathProfile  Pointer to propagation path profile
///
...
/// Initialize Street Microcell model
///
/// \param propChannel  Pointer to propagation channel
/// \param channelIndex  Channel Index
...
/// Propagation pathloss for LoS, Street Microcell model
///
/// \param h1  Height of node first node
/// \param h2  Height of node second node
/// \param waveLength  wavelength
/// \param distance  distance between nodes or from wall corner
///    (when called from Pathloss_StreetMicrocell_NLoS())
///
/// \return Pathloss value
/// 
...
/// Propagation pathloss for NLoS, Street Microcell model
///
/// \param h1  Height of node first node
/// \param h2  Height of node second node
/// \param waveLength  wavelength
/// \param txDistanceToBuilding  Transmitter distance from building corner
/// \param rxDistanceToBuilding  Receiver distance from building corner
/// \param distanceThruBuilding  Distance through building
///
/// \return Pathloss value
/// 
...
/// Initialize Street mobile-to-mobile model
///
/// \param propChannel  Pointer to propagation channel
/// \param channelIndex  Channel Index
/// \param nodeInput  Node input
...
/// Propagation pathloss for mobile-to-mobile in urban canyon
///
/// \param numBuildingsInPath  number of buildings in propagation path
/// \param h1  Height of node first node
/// \param h2  Height of node second node
/// \param buildingHeight  Average building height in propagation path
/// \param streetWidth  Average street-width height in propagation path
/// \param txRxdistance  distance between nodes
/// \param waveLength  waveLength
///
/// \return Pathloss value
/// 
...
/// Check if propagation path is through freespace
///
/// \param h1Effective  Height of node first node
/// \param h2Effective  Height of node second node
/// \param maxRoofHeight  Maximum roof height between nodes
///
/// \return TRUE if Freespace path exists, FALSE otherwise
/// 
...
/// Check if propagation path is through urban canyon
///
/// \param groundHeight  Height of ground
/// \param effectiveHeight  Effective height of node (antenna+node height)
/// \param minRoofHeight  Minimum roof height between nodes
///
/// \return TRUE if path through Canyon exists, FALSE otherwise
/// 
...
/// Prints model information for debugging purposes
///
/// \param isFreeSpace  Flag to indicate Freespace
/// \param isLoS  Flag to indicate LoS
/// \param isCanyon1  Flag to indicate Node 1 in Canyon
/// \param isCanyon2  Flag to indicate Node 2 in Canyon
/// \param urbanModelType  Urban Model Type
///
/// 
