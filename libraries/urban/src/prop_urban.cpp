...
// \param txPosition  Transmitter position
// \param rxPosition  Receiver position
                             ...
                             SelectionData* urbanStats)
{
    ...
    UrbanPathPropertiesPointer pathProperties;
    ...
    maxFresnelZone1Radius = 0.5 * sqrt(wavelength * distance);
    ...
    if (DEBUG) 
    {
        printf("dist = %f, freq = %f, Fresnel Radius = %f\n",
               distance, frequencyMhz, maxFresnelZone1Radius);
    }
    ...
    pathProperties = terrainData->getUrbanPathProperties(
        &adjustedTxPosition,
        &adjustedRxPosition,
        maxFresnelZone1Radius,
        false,
        node->partitionData);

    assert(pathProperties.get() != NULL);
    ...
    if (!isFreeSpace) {
        ...
        UrbanPathPropertiesPointer simplePathProperties;
...
// Calculate Foliage Propagation Pathloss
// by calling environment specific model
//
// \param node  Pointer to Node
// \param distance  Distance between the transmitter and receiver
// \param wavelength  wavelength
// \param txAntennaHeight  Transmitter Antenna Height
// \param rxAntennaHeight  Receiver Antenna Height
                              ...
                              UrbanModelType urbanModelType)
{
    ...
    switch (urbanModelType)
    {
        ...
        case URBAN_STREET_M_TO_M:
            ...
            break;
        case COST231_INDOOR:
            ModelName="COST231_INDOOR";
            break;
        case ITU_R_INDOOR:
            ModelName="ITU_R_INDOOR";
            break;
        default:
            ModelName="unknown";
            break;
