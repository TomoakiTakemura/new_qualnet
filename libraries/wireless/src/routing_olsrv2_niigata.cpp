  ...
  /*      sprintf(errStr, "TC Interval Parameter not specified"
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        IO_ReadTime(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-REFRESH-TIMEOUT-INTERVAL-IPv4",
            &wasFound,
    ...
    else
    {
        ...
        IO_ReadTime(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-REFRESH-TIMEOUT-INTERVAL-IPv6",
            &wasFound,
            (clocktype *)&qual_cnf->timeout_interval);
   ...
   /*     sprintf(errStr, "Start TC Interval Parameter not specified"
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        ...
        IO_ReadTime(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-START-REFRESH-TIMEOUT-IPv4",
            &wasFound,
    ...
    else
    {
        ...
        IO_ReadTime(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-START-REFRESH-TIMEOUT-IPv6",
            &wasFound,
            (clocktype *)&qual_cnf->start_timeout);
  ...
  /*      sprintf(errStr, "Start Timeout Interval Parameter not specified"
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        ...
        IO_ReadTime(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-NEIGHBOR-HOLD-TIME-IPv4",
            &wasFound,
    ...
    else
    {
        ...
        IO_ReadTime(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-NEIGHBOR-HOLD-TIME-IPv6",
            &wasFound,
            (clocktype *)&qual_cnf->neighbor_hold_time);
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        ...
        IO_ReadTime(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-TOPOLOGY-HOLD-TIME-IPv4",
            &wasFound,
    ...
    else
    {
        ...
        IO_ReadTime(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-TOPOLOGY-HOLD-TIME-IPv6",
            &wasFound,
            (clocktype *)&qual_cnf->topology_hold_time);
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        ...
        IO_ReadTime(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-DUPLICATE-HOLD-TIME-IPv4",
            &wasFound,
    ...
    else
    {
        ...
        IO_ReadTime(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-DUPLICATE-HOLD-TIME-IPv6",
            &wasFound,
            (clocktype *)&qual_cnf->duplicate_hold_time);
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        IO_ReadString(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-LINK-LAYER-NOTIFICATION-IPv4",
            &wasFound,
            buf);
    ...
    if (olsr_cnf->ip_version == AF_INET)
    {
        IO_ReadString(
            ...
            NetworkIpGetInterfaceAddress(node, interfaceIndex),
            nodeInput,
            "OLSRv2-PACKET-RESTORATION-IPv4",
            &wasFound,
            buf);
    ...
    else
    {
        ...
        IO_ReadString(
            ...
            &address.interfaceAddr.ipv6,
            nodeInput,
            "OLSRv2-PACKET-RESTORATION-IPv6",
            &wasFound,
            buf);
                                   ...
                                   NetworkType networkType)
{
  ...
  if (olsr->qual_cnf->link_layer_notification)
  {
      ...
      {
        olsr_error("Link Layer Notification: Not Support IPv6!!\n");
      }
  }
