...
#define AODV_RREP_ACK_PACKET_SIZE 2

/// Address and sequence number for AODV for IPv4
...
/// Address and sequence number for AODV for IPv6
/// to be used in Packets.
typedef struct
{
    in6_addr address;
...
/// AODV Route Request Message part which is same for
/// both IPv6 and IPv4.
typedef struct
{
...
/// AODV for IPv4 route request message format.
typedef struct
{
...
/// AODV for IPv6 route request message format.
typedef struct
{
    AodvRreqPacketInfo info;
...
/// AODV for IPv4 route reply message format.
typedef struct
{
    // Next 32-bit variable will be used as
    // First 8-bits for type
...
/// AODV for IPv6 route reply message format.
typedef struct
{
    // Next 32-bit variable will be used as
    // First 8-bits for type
...
/// AODV for IPv4/IPv6 route error message format.
typedef struct
{
...
/// AODV for IPv4/IPv6 route acknowledgement
/// message format.
typedef struct
{
    UInt8 type;
...
/// AODV for IPv4/IPv6 List of neighboring nodes which
...
/// AODV for IPv4/IPv6 List to store precursor nodes
typedef struct
{
...
/// AODV for IPv4/Ipv6 Blacklisted node
...
/// AODV for IPv4/Ipv6 List to store blacklisted nodes whose
...
/// Aodv for IPv4/IPv6 routing table entry for
/// a destination
...
/// Aodv for IPv4/IPv6 routing table
typedef struct
{
...
/// AODV IPv4/IPv6 Structure to store <source, floodingId>
...
/// AODV for IPv4/IPv6 Route Request Seen Table
typedef struct
{
...
/// AODV for IPv4/IPv6 Structure to store packets
...
/// AODV IPv4/IPv6 Structure to store information about
...
/// AODV IPv4/IPv6 structure for Sent node entries
typedef struct
{
...
/// AODV IPv4/IPv6 Structure to store the statistical
/// informations.
typedef struct
{
...
/// AODV IPv4/IPv6 structure to store all necessary
/// informations.
