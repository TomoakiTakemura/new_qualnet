...
/// Retrieve the list item related to given address
///
/// \param node  Node Pointer
/// \param dot11  Structure of dot11.
/// \param lookupAddress  Lookup Node Address
...
/*** UAPSD *********************************START*******************/
/// \brief Declaration of Dot11_CreateEDCAParameterSet function
///
/// This API adds EDCA Parameter Set in beacon packet
///
/// \param node  Pointer to the node
/// \param element  Pointer to the information element
