...
#define PHY802_11b_CHANNEL_BANDWIDTH    20000000 // 20 MHz
...
#define PHY802_11a_DEFAULT_RX_SENSITIVITY__6M_dBm  -82.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY__9M_dBm  -81.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_12M_dBm  -79.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_18M_dBm  -77.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_24M_dBm  -74.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_36M_dBm  -70.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_48M_dBm  -66.0
#define PHY802_11a_DEFAULT_RX_SENSITIVITY_54M_dBm  -65.0

#define PHY802_11b__1M  0
#define PHY802_11b__2M  1
#define PHY802_11b__5_5M  2
...
#define PHY802_11b_DATA_RATE__5_5M  5500000
...
#define PHY802_11b_NUM_DATA_BITS_PER_SYMBOL__5_5M   5.5
...
#define PHY802_11b_DEFAULT_TX_POWER__5_5M_dBm  15.0
#define PHY802_11b_DEFAULT_TX_POWER_11M_dBm  15.0

#define PHY802_11b_DEFAULT_RX_SENSITIVITY__1M_dBm  -82.0
#define PHY802_11b_DEFAULT_RX_SENSITIVITY__2M_dBm  -80.0
#define PHY802_11b_DEFAULT_RX_SENSITIVITY__5_5M_dBm  -78.0
#define PHY802_11b_DEFAULT_RX_SENSITIVITY_11M_dBm  -76.0

// Legacy Phy802.11b RX sensitivity values for different data rates
#define LEGACY_PHY802_11b_DEFAULT_RX_SENSITIVITY__1M_dBm  -94.0
#define LEGACY_PHY802_11b_DEFAULT_RX_SENSITIVITY__2M_dBm  -91.0
#define LEGACY_PHY802_11b_DEFAULT_RX_SENSITIVITY__5_5M_dBm  -87.0
#define LEGACY_PHY802_11b_DEFAULT_RX_SENSITIVITY_11M_dBm  -83.0
...
struct PhyData802_11 {
    ...
    double    rxSensitivity_mW[PHY802_11a_NUM_DATA_RATES];
    ...
    Phy802_11Manager* pDot11Base;
    Phy802_11Stats  stats;
    StatsController* sController;

    unsigned char rxPhyType;
    unsigned char txPhyType;
};
...
BOOL Phy802_11CarrierSensing(Node* node,
                             PhyData802_11* phy802_11,
                             int phyIndex);
...
void Phy802_11SetTxDataRateType(PhyData* thisPhy,
                                int dataRateType,
                                unsigned char phyType = k_Dot11b);
...
//
void Phy802_11aAddBerTable(PhyData* thisPhy);
void Phy802_11bAddBerTable(PhyData* thisPhy);
...
// 802_11ac functions
clocktype Phy802_11GetFrameDuration(PhyData* thisPhy,
                                      const MAC_PHY_TxRxVector& txVector);
void Phy802_11SetTxVector(PhyData* thisPhy,
                                      const MAC_PHY_TxRxVector& txVector);
void Phy802_11GetTxVector(PhyData* thisPhy,
