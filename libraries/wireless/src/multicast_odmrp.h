...
/// The maximum value of the array index of
...
/// This constant value is being used in order
...
/// Max number of sources of a given multicast
...
/// Max number of multicast groups. This constant value
...
/// Max number of Routing Table entries. This constant
...
/// Checking Time for sending "Join Query" message

#define ODMRP_TIMER_INTERVAL                (10 * MILLI_SECOND)

//  CONSTANT    :  ODMRP_JR_PAUSE_TIME  : (25 * MILLI_SECOND)
/// Time for intermediate Forwarding Nodes to wait before
...
/// Time to send "Join Reply" after receiving
...
/// Odmrp Specific IP Option Name. This Option
...
/// This value is used to populate "GatewayInfo"
...
/// Passive Clustering Specific IP Option Name. This
/// Option is present while sending Passive Clustering
/// Related Information.

#define IPOPT_ODMRP_CLUSTER 119

/// Internal and External states of "Pasive Clustering"
/// Enabled nodes.
...
/// Passive Cluster Related Information.
...
/// Returns the value of state for OdmrpPassiveClsPkt
///
...
/// Returns the value of giveUpFlg for OdmrpPassiveClsPkt
///
///    + opcp          : The variable containing the value of state,
///    giveUpFlg,helloFlg and reserved
...
/// Returns the value of helloFlg for OdmrpPassiveClsPkt
///
///    + opcp          : The variable containing the value of state,
///    giveUpFlg,helloFlg and reserved
...
/// Returns the value of reserved for OdmrpPassiveClsPkt
///
///    + opcp          : The variable containing the value of state,
///    giveUpFlg,helloFlg and reserved
...
/// ODMRP options fields for IP Header
...
/// ODMRP options fields for "Join Query" message
...
/// It is Source Address and Next Address
...
/// Constant part of ODMRP "Join Reply" message.
/// 
...
/// Set the value of ackReq for OdmrpJoinReply
///
...
/// Set the value of IAmFG for OdmrpJoinReply
///
///    + ojr           : The variable containing the value of ackReq,IAmFG and
///    reserved
...
/// Set the value of reserved for OdmrpJoinReply
///
///    + ojr           : The variable containing the value of ackReq,IAmFG and
///    reserved
///    + reserved      : Input value for set operation
...
/// Returns the value of ackReq for OdmrpJoinReply
///
///    + ojr           : The variable containing the value of ackReq,IAmFG and
///    reserved
///
...
/// Returns the value of IAmFG for OdmrpJoinReply
///
///    + ojr           : The variable containing the value of ackReq,IAmFG and
///    reserved
///
...
/// Returns the value of reserved for OdmrpJoinReply
///
///    + ojr           : The variable containing the value of ackReq,IAmFG and
///    reserved
///
...
/// Ack Table Structure is populated when
...
//-----------------------------------------------------------
/// This structure is populated when a node
...
//--------------------------------------------------------
/// Member Table Structure is populated when
...
//----------------------------------------------------
/// Response Table Structure is populated when
/// a node receives a "Join Query" message.
...
//----------------------------------------------------------
/// Temp Table Structure is populated when
...
//-----------------------------------------------------------
/// Route Table Structure is populated when
/// a node receives a "Join Query" message.
...
//---------------------------------------------------------
/// Message Cache Structure. It is populated
...
//---------------------------------------------------------
/// Message Cache Delete Entry. A particular
...
/// It contains Node-Ids of two cluster Heads.
...
/// It contains Cluster Head Related Information.
...
/// It contains Gateway related Information.
...
/// It contains Dist Gateway related Information.
...
/// It contains total Odmrp related Information
...
/// Event handler function of user protocol
///
...
/// Process a user protocol generated control packet.
///
...
void OdmrpHandleProtocolPacket(Node* node,
                               ...
                               NodeAddress srcAddr,
                               NodeAddress destAddr);
/// Route the packet according to the Routing information.
///
/// \param node  this node
/// \param msg  message that is being received.
///    + destAddr           : IP Address of Destination
...
/// A particular node joins a particular
/// multicast group.
///
/// \param node  this node
///
...
void OdmrpJoinGroup(Node* node,
                    NodeAddress mcastAddr);
/// A particular node leaves a particular
/// multicast group.
///
/// \param node  this node
...
/// Print the trace info. of ODMRP packets.
///
/// \param node  this node
/// \param msg  packet to be traced.
///
