...
/// A data structure that describes the set of parameters
...
/// An enumerated list of modulation types for the system.
...
/// An enumerated list of convolutional coding
...
/// The set of block codes support by the physical
/// layer process.
...
/// The number of modulation profiles supported in this
/// model.

#define PhySatelliteRsvDefaultModulationProfileCount (4)

/// The default transmission power in the BPSK modulation
/// profile.

static double const PhySatelliteRsvBpskDefaultTransmitPowermW = 3000.0;

/// The default sensitivity of the BPSK receiver.
...
/// The default data rate for the BPSK modulator.
...
/// The default transmit power for the QPSK modulator.

static double const PhySatelliteRsvQpskDefaultTransmitPowermW = 3000.0;

/// The default sensitivity of the receiver.
...
/// The default signaling rate of the QPSK modulator
/// in bits/sec.
...
/// The default transmitter power for the 8PSK transmitter.

static double const PhySatelliteRsv8pskDefaultTransmitPowermW = 3000.0;

/// The default sensitivyt of the 8PSK receiver.
...
/// The default data rate for the 8PSK transmitter
...
/// The default channel width (in Hz) of available
/// bandwidth.

static double const PhySatelliteRsvDefaultChannelBandwidth = 1280.0e3;

/// The default directional antenna gain above omnidirectional
/// gain in dBi.
...
/// The default preamble size for transmissions expressed in
...
/// This is the default time added to each transmission to
...
/// The default flag to indicate to the system whether
...
/// The PHY header applied to all MAC SDUs
...
/// This data structure holds all counters for
...
/// The state data for the Satellite RSV physical
...
/// A list of enumerated events in this physical
/// layer process.
...
/// This function translates a PhyStatusType enumeration
/// into a human-readable text string.
///
/// \param       type  An enumerated value indicating
