...
// Whether debugging the group node distribution.
//
//
...
// Whether debugging the group mobility.
//
...
// One group definition is treated as one group under
// group mobility model. This function parse one group line.
//
// \param nodeInput  Pointer to NodeInput
// \param groupLine  One line of a group definition
// \param groupIndex  The index of the group
// \param nodeIdList  A pre-allocated list for returing node IDs
//    defined in this group.
// \param numNodeIds  For returning how many node IDs in the nodeIdList
// \param groupTerrainOrigin  For returning the origin of the
//    corresponding group area, if defined.
// \param groupTerrainDimensions  For returning the dimensions
//    of the corresponding group area, if defined.
// \param nodePositions  The list of node positions
// \param numNodes  Number of nodes
//
// \return TRUE, group area information is defined
...
// Distribute nodes as groups according to their group area
...
// Generate all intermediate positions for current node
// according to the group mobility model.
//
// \param nodeId  Node ID of the node
// \param mobilityData  pointer to the mobility data
// \param terrainData  pointer to terrain data
// \param nodeInput  Pointer to NodeInput
// \param maxSimClock  The maximum simulation clock
// \param int groupIndex  the index of the group
// \param groupTerrainOrigin  Origin of the initial group area
// \param groupTerrainDimensions  Dimensions of the initial
//    group area
//
...
// Initialization Function for group mobility model
//
// \param nodeId  node ID
// \param mobilityData  Pointer to mobility data
// \param terrainData  Pointer to terrain data
// \param nodeInput  Pointer to NodeInput
// \param maxSimClock  The maximum simulation clock
// \param nodePositions  The list of node positions
