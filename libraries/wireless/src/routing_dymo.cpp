               ...
               NetworkRoutingProtocolType dymoProtocolType)
{
    ...
    if (dymoProtocolType == ROUTING_PROTOCOL_DYMO)
    {
        IO_ReadString(
            node->nodeId,
            &interfaceAddr,
            nodeInput,
            "DYMO-APPEND-SELF-ADDRESS-IPv4",
            &wasFound,
            buf);
    }
    else if (dymoProtocolType == ROUTING_PROTOCOL_DYMO6)
    {
        IO_ReadString(
            node->nodeId,
            &interfaceAddr,
            nodeInput,
            "DYMO-APPEND-SELF-ADDRESS-IPv6",
            &wasFound,
            buf);
    }
              ...
              NetworkRoutingProtocolType dymoProtocolType)
{
    ...
    if (dymoProtocolType == ROUTING_PROTOCOL_DYMO)
    {
        IO_ReadString(
            ...
            &interfaceAddr,
            nodeInput,
            "DYMO-INCREASE-SEQ-NUM-IN-APPENDING-IPv4",
            &wasFound,
            buf);
    }
    else if (dymoProtocolType == ROUTING_PROTOCOL_DYMO6)
    {
        IO_ReadString(
            ...
            &interfaceAddr,
            nodeInput,
            "DYMO-INCREASE-SEQ-NUM-IN-APPENDING-IPv6",
            &wasFound,
            buf);
    }
               ...
               NetworkRoutingProtocolType dymoProtocolType)
{
    ...
    if (dymoProtocolType == ROUTING_PROTOCOL_DYMO)
    {
        IO_ReadString(
            ...
            &interfaceAddr,
            nodeInput,
            "DYMO-RERR-INCLUDE-ALL-UNREACHABLES-IPv4",
            &wasFound,
            buf);
    }
    else if (dymoProtocolType == ROUTING_PROTOCOL_DYMO6)
    {
        IO_ReadString(
            ...
            &interfaceAddr,
            nodeInput,
            "DYMO-RERR-INCLUDE-ALL-UNREACHABLES-IPv6",
            &wasFound,
            buf);
    }
    ...
    NetworkRoutingProtocolType dymoProtocolType)
{
    ...
    dymo->Dflag = DymoCheckDFlag(node,
                                 nodeInput,
                                 interfaceAddr,
                                 dymoProtocolType);
    dymo->Aflag = DymoCheckAFlag(node,
                                 nodeInput,
                                 interfaceAddr,
                                 dymoProtocolType);
    dymo->Iflag = DymoCheckIFlag(node,
                                 nodeInput,
                                 interfaceAddr,
                                 dymoProtocolType);
    dymo->Eflag = DymoCheckEFlag(node,
                                 nodeInput,
                                 interfaceAddr,
                                 dymoProtocolType);
    ...
    if (dymoProtocolType == ROUTING_PROTOCOL_DYMO)
    {
        ...
        IO_ReadTime(
            ...
            &interfaceAddr,
            nodeInput,
            "DYMO-DELETE-ROUTE-TIMEOUT-IPv4",
            &wasFound,
        ...
        if (dymo->isGatewayEnabled)
        {
            ...
            IO_ReadInt(
                ...
                &interfaceAddr,
                nodeInput,
                "DYMO-GATEWAY-PREFIX-LENGTH-IPv4",
                &wasFound,
                &gatewayPrfixLength);
    ...
    else if (dymoProtocolType == ROUTING_PROTOCOL_DYMO6)
{
    ...
    IO_ReadTime(
        ...
        &interfaceAddr,
        nodeInput,
            "DYMO-DELETE-ROUTE-TIMEOUT-IPv6",
            &wasFound,
            &dymo->deleteRouteTimeout);
    ...
    dymo->gatewayPrfixLength = (UInt8)0;
        ...
        IO_ReadInt(
            ...
            &interfaceAddr,
            nodeInput,
                "DYMO-GATEWAY-PREFIX-LENGTH-IPv6",
                &wasFound,
                &gatewayPrfixLength);
