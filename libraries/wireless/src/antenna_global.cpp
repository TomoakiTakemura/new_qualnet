...
//    contents of input
//    file
// \param antennaModelName  contains the name of the antenna
                                ...
                                char* antennaPatternName)
{
          ...
          strcmp(patternType, "TRADITIONAL") == 0))
    {
        ...
        int n = (int)(2 * MAX_STRING_LENGTH - strlen(antennaPatternName));
        int advance = (int)(strlen(elevPatternName) - n);
        if (advance > 0)
        {
