...
/// \defgroup Package_ENERGY_MODELS_for_RADIO_and_PHYSICAL_LAYERS ENERGY MODELS for RADIO and PHYSICAL LAYERS

/// \file
/// \ingroup Package_ENERGY_MODELS_for_RADIO_and_PHYSICAL_LAYERS
/// This file describes data structures and functions used by the Radio Energy Models.
...
struct EnergyModelGeneric 
{
  ...
  double Psp;
  double Vs;
  EnergyModelGeneric() : alpha_amp(0.0), Pct(0.0), Pcr(0.0), Pid(0.), Psp(0.0), Vs(0.0) { ; }
};
...
void
Phy_ReportStatusToEnergyModel(Node* node, const int phyIndex, 
                              unsigned char prevStatus, unsigned char newStatus);
