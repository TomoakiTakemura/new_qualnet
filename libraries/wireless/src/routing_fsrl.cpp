...
// Used for debugging purposes for the configuration variables.
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to print out topology table debug information
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to print out more detailed debug information
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to print out neighbor list debug information
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to debug the shortest path calculation
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to debug data packet forwarding
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to debug routing packet
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to debug landmark updates
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Whether to debug landmark election
//
// \param node  Node pointer that the protocol is being instantiated in
//
// \return TRUE for debugging, FALSE for no deubgging
...
// Print local scope routing table entries
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Print local scope topology table entries
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Print fisheye topology update packet
//
// \param node  Node pointer that the protocol is being instantiated in
...
// See if two addresses are in the same subnet
//
// \param landmarkAddr  The first node address
// \param destAddr  The second node address
// \param numHostBits  Host bits for indicating address structure
//
// \return TRUE for in the same subnet, FALSE for not
...
// Determine if we are a drifter.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param lower  lower bound of scope
// \param upper  upper bound of scope
//
// \return TRUE for is drifter, FALSE for not drifter
...
// Check if a node exists in drifter table
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param nodeAddr  node address for checking
//
// \return TRUE for in drifter table, FALSE for not in table
...
// Update or insert node into drifter table
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Drifter node's address
// \param nextHop  Next hop to this drifter node
// \param outgoingInterface  interface index
// \param distance  distance to this drifter node
// \param comingSeq  sequence number
//
...
// Delete node from drifter table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Drifter node's address
//
...
// Check for expired drifter entries in drifter table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Find one entry in landmark table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param nodeAddr  landmark node address
//
...
// Update our own landmark member count in landmark table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param numLandmarkMember  Number of members
//
...
// See if we need to update who's the landmark winner.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param currentLandmark  current landmark entry
// \param destAddr  nodes competing for landmark
// \param memberNum  Number of members of the competing node
// \param A  parameter for landmark election alg.
// \param N  parameter for landmark election alg.
//
// \return TRUE, needs to update, FALSE, keep current landmark
...
// Update entry in landmark table via landmark election.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  landmark node address
// \param nextHop  next hoop to the landmark node
// \param outgoingInterface  interface index
// \param distance  distance to landmark node
...
// Check for expired entries in landmark table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param needDelete  Whether need to delete the expired entry.
//
...
// Set a landmark entry's distance metric to infinity.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param nodeAddr  Node address of the landmark entry
//
...
// Delete entries from landmark table if distance is infinity.
//
// \param node  Node pointer that the protocol is being instantiated in
//
...
// Delete node from landmark table if it exists in table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param nodeAddr  Landmark node to be deleted
//
...
// Get one entry in topology table.
//
...
// Return the Topology list row whose neighbour matches with
...
// Count how many group members in scope we have
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Check for expired entries in topology table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Init. array that is used for shortest path calculation.
//
...
// Print array that is used for shortest path calculation.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param list  Pointer to the list
//
...
// Free array that is used for shortest path calculation.
//
// \param list  Pointer to the list
//
...
// Insert to array used for shortest path calculation.
//
// \param list  Pointer to the list
// \param nodeAddr  Node address to be inserted
// \param index  Address of pointer to return index in the list
//
...
// Calculate shortest path base on the current linke state
...
// Get next hop to a specified landmark.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Destnation node address.
// \param nextHop  For returning next hop to the landmark
// \param distance  For returning distance to the landmark
//
// \return TRUE means find landmark, FALSE means no
...
// Find route using local fisheye routing table
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Destination node
// \param nextHop  For returning next hop to destination
// \param outgoingInterface  For returning interface to destination
// \param distance  For returning distance to destination
//
// \return TRUE means route found, FALSE means no route found
...
// Find route to destinaiton from drifter table
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Destination node
// \param nextHop  For returning next hop to destination
...
// Find route to destinaiton using landmark table
//
// \param node  Node pointer that the protocol is being instantiated in
// \param destAddr  Destination node
// \param nextHop  For returning next hop to destination
...
// Update neighbor info. based on control packets received.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param nodeAddr  Neighbor node address
// \param incomingInterface  Interface index the control packet from
//
...
// Delete a neighbor from topology table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param neighborAddr  Neighbor node address
//
...
// Send landmark update packet.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param lower  Lower bound of the scope
// \param upper  Upper bound of the scope
//
...
// Insert or update one entry in topology table.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param tmp  Pointer to the entry
//
// \return TRUE, entry is updated, FALSE, no update
...
// Send toplogy table update packets within scope
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
// \param lower  Lower bound of scope
...
// Handle timer to start sending out Fisheye update pkts.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Handle fisheye update that has just been received.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param msg  Pointer to the message strucutre of the packet
// \param srcAddr  Source node of the packet
// \param destAddr  Destination node of the packet
// \param incomingInterface  Interface index pkt is recved from
// \param ttl  TTL value from IP header of the packet
//
...
// Handle timer to send out LANMAR update packet.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param fisheye  Pointer to LANMAR routing data structure
//
...
// Handle landmark update packet just received.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param msg  Pointer to the message strucutre of the packet
// \param srcAddr  Source node of the packet
...
// Print out statistics at end of simulation.
//
// \param node  Node pointer that the protocol is being instantiated in
//
...
// Handle event that MAC layer dropped packets.
//
// \param node  Node pointer that the protocol is being instantiated in
// \param msg  Pointer to message structure of the event
// \param nextHop  Next hop node of dropped packet
// \param interfaceIndex  Interface index the pkt is sent on
//
