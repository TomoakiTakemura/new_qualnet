...
// Execute logic to determine whether or not the local
// interface is interested in accepting frames for
// the indicated IPv4 address.
//
// \param        mac  A pointer to a data structure representing
//    the local set of MAC-protocol-specific state machine variables.
// \param        dstAddr  An abstract representation
...
//
// \return A boolean quantity that indicates whether the local
                ...
                double dt)
{
    ...
    clocktype ctdelay = 100 * clockround(nsdt / 100.0);
