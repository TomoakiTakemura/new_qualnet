...
//
// \param        node  A pointer to the local node data structure
// \param        phyNum  The integer index of the interface associated
//    with
//    this physical layer process.
...
//
// \param        node  A pointer to the local node data structure
// \param        phyIndex  The integer index of the interface
//    associated with
//    this physical layer process.
...
//
// \param        node  A pointer to the local node data structure
// \param        phyIndex  The integer index of the interface associated with
//    this physical layer process.
// \param        status  The new status of the physical
//    interface.
//
                   ...
                   const NodeInput* nodeInput)
{
    ...
    ERROR_Assert(PHY_CanListenToChannel(node, phyIndex, uplinkChannel),
                 "The transmission channel must be listenable to"
                 " support this full-duplex PHY");

    ERROR_Assert(PHY_CanListenToChannel(node, phyIndex, downlinkChannel),
    ...
    if (PHY_CanListenToChannel(node, phyIndex, uplinkChannel))
    {
    ...
    if (PHY_CanListenToChannel(node, phyIndex, downlinkChannel))
    {
...
// This function returns the current transceiver status
// for the
...
// \param        phyIndex  The logical index of the current interface
//
// \return This function returns the instantaneous
// sample
...
// This function implements the model logic to be executed
// when
...
// This function implements the algorithm to transmit
// a signal
...
// \param        msg  A pointer to a data structure representing
//    the
