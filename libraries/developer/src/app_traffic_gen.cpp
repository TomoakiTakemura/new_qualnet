...
// TrafficGen initialization  for tracing
//
    ...
    TrafficGenClient* clientPtr)
{
    ...
    if (node->appData.appStats)
    {
        ...
        TrafficGenData* trafficGenData = new(MESSAGE_AddInfo(
                node,
                message,
                sizeof(TrafficGenData),
                INFO_TYPE_SuperAppUDPData))(TrafficGenData);
...
#ifdef MILITARY_RADIOS_LIB
// Retrieve the NPGId stored in the traffic_gen data
//
//    +node:              Node pointer
...
// Create an packet to send in Tadil network
//
//    +node:              Node pointer
//    +srcAddr:           The address of the gateway IP interface
//    that forwards fragment
...
// Gateway calls this function to forward TrafficGen
