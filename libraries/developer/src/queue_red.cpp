...
//
// \param queueIsEmpty  If queue empty it returns TRUE elae FALSE.
// \param numPackets  Number of packets in queue
// \param queueWeight  Weight of that perticular queue
// \param smallPktTxTime  Packet transmission time
// \param startIdleTime  Queue idle time
// \param avgQueueSize  Average queue size
...
// \param infoField  Default value 0
...
// \param randomSeed[]  randomSeed[]; Node seed[] value
...
// \param redConfigParams  Pointer of pointer to
