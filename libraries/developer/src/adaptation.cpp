...
// Calls finalize function of ATM.
//
// \param node  Pointer to node.
//    RETURN       : void : None
...
// Adaptation-layer receives packets from Transport
...
// Adaptation-layer handed over the packet to upper layer
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param interfaceIndex  Interface index.
// \param previousHopAddress  Previous hop address.
//    RETURN       : void : None
...
// Adaptation-layer receives packets and handed
// it to the Network Layer
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param incomingIntf  Incommingnterface index.
//    RETURN       : void : None
