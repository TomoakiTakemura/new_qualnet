...
// It initializes the client messenger application when
// the application is in standalone mode
//
// \param node  Pointer to the node running the messenger app.
// \param srcAddr  Source address
// \param destAddr  Destination address
// \param t_type  Transport Type
// \param app_type  Application Type
// \param lifeTime  Life Time
// \param startTime  Start Time
// \param interval  Interval
// \param fragSize  Fragmentation Size
// \param fragNum  Fragmentation Number
// \param destNPGId  Destination NPG index
...
// It initializes the Server into Listen state.
...
// It initializes the Server end. This function is called
// when server receive packet for first time.
//
// \param node  Pointer to the node running the messenger app.
//
// \return pointer of MessengerState.
static
