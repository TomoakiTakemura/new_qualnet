...
/// This structure contains statistics for Fair schedulers
...
/// This structure contains the Queue finish number
...
/// This structure helps to sort Queue finish number
...
/// The base class for Fair Schedulers, e.g., WFQ, SCFQ
