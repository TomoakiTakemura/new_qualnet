...
/// The maximum avgidle value for the queue

#define MAX_IDLE 2.5

/// The minimum avgidle value for the queue
...
/// Structure for Agency behavior estimation
...
/// Structure for an Agency in resource sharing structure
