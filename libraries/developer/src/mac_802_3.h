...
/// Unknown event ID at 802.3 trace.
...
/// Length Field value for protocol IP
#define MAC802_3_PROTOCOL_TYPE_IP                   0x0800


/// Length Field value for protocol RARP
#define MAC802_3_PROTOCOL_TYPE_RARP                 0x08035

//--------------------------------------------------------------------------


/// Different status types of a station.
...
/// Different types of frames to be transferred to the
...
/// Elements of 802.3 frame header.
...
/// Structure to keep statistics for full duplex.
...
/// Get bandwidth and propagation delay for a given subnet.
///
/// \param nodeInput  Pointer to node input.
/// \param address  Pointer to IpAddress Information.
/// \param subnetBandwidth  Get bandwidth for this subnet.
/// \param subnetPropDelay  Get prop. delay for this subnet.
/// \param forLink  Whether for Link (Full Duplex Point to Point Link) or
///    Subnet.
///
...
/// Initialize 802.3 protocol at a given interface.
///
/// \param node  Pointer to node.
/// \param nodeInput  Pointer to node input.
/// \param interfaceIndex  Interface index
/// \param nodeList  Pointer to subnet member list
/// \param numNodesInSubnet  Member count in subnet.
/// \param forLink  Whether for link or Subnet.
///
void Mac802_3Init(
    Node* node,
    const NodeInput* nodeInput,
...
/// Finalize routine for 802.3 protocol.
///
/// \param node  Pointer to node.
/// \param interfaceIndex  Interface index
///
...
/// Layer routine for 802.3 protocol.
///
/// \param node  Pointer to node.
/// \param interfaceIndex  Interface index
...
/// This function is called by a station tosense channel.
///
/// \param node  Pointer to node.
/// \param mac802_3  Pointer to 802.3 data at an interface.
///
void Mac802_3SenseChannel(
    Node* node,
    MacData802_3* mac802_3);

/// This function is called to convert a frame to packet.
///
/// \param node  Pointer to node.
/// \param interfaceIndex  Interface index
/// \param msg  Pointer to message.
/// \param tagInfo  Get VLAN info if present in  header.
///
...
/// Sending frame to the other node in full duplex mode
///
