...
/// Weight multipier for service count calculation

#define WRR_WEIGHT_MULTIPLIER 100


/// This structure contains statistics for the scheduler
...
/// This structure contains service count information
...
/// Weighted Round Robin Scheduler Class
