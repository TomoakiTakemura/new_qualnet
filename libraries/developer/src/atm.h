...
/// Event/message types exchanged in the simulation in ATM
...
/// Information related to ATM DATA in between ALL and LAYER2
...
// STRUCTURE   :: AtmBWInfo
/// Information of connection setup or release
...
/// \param outgoingIntf  Which interface
