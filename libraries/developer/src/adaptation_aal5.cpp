...
// To print Aal5 connection table
//
// \param node  Pointer to node.
//    RETURN       : void : None
...
// Get the related adaptation layer Ptr for this ATM Node
//
// \param node  Pointer to node.
...
// Get the outgoing Interface & the next op from
// the forwarding table of the node
//
// \param node  Pointer to node.
// \param destAtmAddr  Pointer to Destination Address
// \param outIntf  Pointer to outgoing interface index.
// \param nextHop  Pointer to nextHop
//    RETURN       : void : None
...
// Set value for VPI & VCI for this application
//
// \param node  Pointer to node.
// \param appSrcAddr  Source address of application.
// \param appDstAddr  Destination address of application.
// \param appSrcPort  Source port of application.
// \param conncId  Connection ID
//    RETURN       : void : None
...
// Check If the dest and the node is in same network
//
// \param node  Pointer to node.
// \param addrPtr  Pointer to ATM address
//    RETURN       : BOOL
...
// Initialize the parametrs associated
...
// Update address table with information
//
// \param node  Pointer to node.
// \param intfId  Interface Identifier.
// \param destAtmAddr  Pointer to destination address.
// \param destIpAddr  Pointer to destination IP address.
//    RETURN       : void : None.
...
// Handling all initializations needed by ATM-ARP.
//
// \param node  Pointer to node.
// \param intfId  Interface Identifier.
//    RETURN       : void : None.
...
// Initialize the parameter associated
...
// Initialize Atm Translation Table
//
// \param node  Pointer to node.
//    RETURN       : void : None.
...
// Initialize the parameter associated with Connection Table
//
// \param node  Pointer to node.
//    RETURN       : void : None.
...
// Create/Modify entry in Forwarding table
//
// \param node  Pointer to node.
// \param outIntf  Outgoing Interface
// \param destAtmAddr  Pointer to destination address
// \param nextAtmNode  Pointer to next ATM node
//    RETURN       : void : None
...
// Create/Modify entry in Translation table
//
// \param node  Pointer to node.
// \param VCI  VCI value
// \param VPCI  VPCI value
// \param finalVPI  finalVPI value
// \param outIntf  Outgoing Interface
//    RETURN       : void : None
...
// Set status for this application
//
// \param node  Pointer to node.
// \param VCI  VCI value
// \param VPI  VPI value
...
// Search the Translation Table for matching Entry
//
// \param node  Pointer to node.
// \param VCI  VCI value
// \param VPI  VPI value
...
// Search the Connection-Table for matching Entry
//
// \param node  Pointer to node.
// \param appSrcAddr  Source Address
// \param appDstAddr  Destination Address
// \param appSrcPort  Source Port
// \param appDstPort  Destination port
...
// AAL5 function to get logical IP address for destination
//
// \param node  Pointer to node.
// \param destIP  Logical Ip Address for destination.
// \param atmAddr  Pointer to ATm address.
//    RETURN       : void : None
...
// Initializing AAL5 parameter for this node
//
// \param node  Pointer to node.
// \param nodeInput  Pointer to config file.
//    RETURN       : void : None
...
// Reassemble the segmented packets
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param aalMsgInfo  Pointer to message information
...
// Once the packet is formed after reassembly
// it is cleared from the reassembly list
//
// \param node  Pointer to node.
// \param incomingVCI  Incomming VCI value
// \param inIntf  incoming Intf
//    RETURN       : void : None
...
// Pass the upper layer message to CPCS sublayer
// for processing
//
// \param node  Pointer to node.
// \param msg  Pointer to message
...
// Pass the upper layer message to SAR sublayer
// for processing
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param cpcsPrimitive  pointer to CPCS primitive
//    RETURN       : void : None
...
// Pass the upper layer message to
// ATM layer2 for processing
//
// \param node  Pointer to node.
// \param sarPdu  Pointer to SAR PDU
// \param primitive  pointer to aal5
//    to ATM layer2 data
// \param aalMsgInfo  Pointer to aal5 message information.
// \param orgMsg  Pointer to origianl packet
//    RETURN       : void : None
...
// Pass the lower layer message to CPCS for processing.
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param sarPrimitive  SAR primitive pointer
// \param aalMsgInfo  Pointer to aal5 message information.
//    RETURN       : void : None
...
// Pass the message to upper layer from CPCS
//
// \param node  Pointer to node.
// \param cpcsPdu  Pointer to cpcs PDU
// \param payloadLength  Length of payload.
// \param sarPrimitive  pointer to SAR primitive
// \param aalMsgInfo  Pointer to aal5 message information.
// \param msgInfo  First fragment for copy over info
//    RETURN       : void : None
...
// AAL5 handed over the packet to Adaptation layer
// to send it to the upper layer
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param incomingIntf  Incomming interface.
//    RETURN       : void : None
...
// After reassembly & other checking CPCS sublayer
// finaly deliver packet to AAl5 layer
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param incomingIntf  Incomming interface.
// \param inVCI  incoming VCI for this application
//    RETURN       : void : None
...
// ATM start processing the Data Packet
//
// \param node  Pointer to node.
// \param msg  Pointer to message
// \param VCI  Virtual Connection Identifier
// \param VPI  Virtual Path Identifier
// \param row  Pointer to transfer-table row.
//    RETURN       : void : None
...
// Keep the data packet in the buffer
//
// \param node  Pointer to node.
// \param VCI  Virtual Connection Identifier
// \param VPI  Virtual Path Identifier
...
// Remove the data packet from the Buffer
//
// \param node  Pointer to node.
// \param VCI  Virtual Connection Identifier
// \param VPI  Virtual Path Identifier
...
// A packet is received from the network layer
...
// After creating a signaling message it needs to be passed
// thru various sublayer for processing
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param srcIdentifier  Pointer to ATM source.
// \param destIdentifier  Pointer to ATM destination.
...
// Add CPCS specific tailer and send the msg to SAR Sub-Layer
//
// \param node  Pointer to node.
// \param msg  Pointer to message
//    RETURN       : void : None
...
// Process the packet in SAR sub layer.
...
// Aal5 receives message from ATM Layer2
//
// \param node  Pointer to node.
// \param msg  Pointer to message
//    RETURN       : void : None
...
// Extract CPCS trailer after receiving this signal
//
// \param node  Pointer to node.
// \param msg  Pointer to message
//    RETURN       : void : None
...
// Process the received packet in CPCS sublayer
//
// \param node  Pointer to node.
// \param msg  Pointer to message
//    RETURN       : void : None
...
// Collect the datat packet from buffer after
// path establishment
//
// \param node  Pointer to node.
// \param VCI  VCI value
...
// Handle the received protocol specific primitive
// in various sublayer
//
// \param node  Pointer to node.
// \param msg  Pointer to message
...
// Process the packet depending upon the type of ATM packet
//
// \param node  Pointer to node.
// \param msg  Pointer to message
//    RETURN       : void : None
...
// Finalize call for printing Aal5 statistics
//
// \param node  Pointer to node.
//    RETURN       : void : None
void
