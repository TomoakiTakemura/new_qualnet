...
/// Length of protocol data unit for segmentation and
/// reassamble.
#define SAR_PDU_LENGTH                  48


/// Maximum deliver length for Service data unit.
#define MAX_SDU_DELIVER_LENGTH          3000


/// Initial table size of adaptetion layer.
#define AAL_INITIAL_TABLE_SIZE          10


/// ATM adaptetion layer signalling ttl.
...
/// Minimum ATM data for vitual cunnecting interface.
#define ATM_DATA_MIN_VCI                32


/// Maximum ATM data for vitual cunnecting interface.
#define ATM_DATA_MAX_VCI                65535


/// Timeout time for default ATM connection.
#define ATM_DEFAULT_CONNECTION_TIMEOUT_TIME     (1 * MINUTE)


/// Refresh time for default ATM connection.
#define ATM_DEFAULT_CONNECTION_REFRESH_TIME     (5 * MINUTE)


/// Various service type for adaptetion protocol AAL5.
typedef enum
{
    AAL5_MESSAGE_MODE,
    AAL5_STREAMING_MODE
...
/// Various signaling type for adaptetion protocol AAL5.
typedef enum
{
    SIGNALING_PVC,
    SIGNALING_SVC
...
/// Cpcs protocol data unit trailer for Aal5.
...
/// Associated IP list item for Aal5.
...
/// Row structure for address info table of Aal5.
...
/// Row structure for forwarding table of Aal5.
...
/// Row structure for connection table of Aal5.
...
/// Finalize function for ATM adaptation layer.
// ARGUMENTS   ::
/// + node       : Node* : Pointer to node.
/// RETURN       : void : None
void
