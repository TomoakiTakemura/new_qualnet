...
/// The class A network ID 127.0.0.0 is reserved for loopback.
...
/// The class A network mask 255.0.0.0.

#define IP_LOOPBACK_MASK            0xFF000000

/// The default loopback address  255.0.0.1.

#define IP_LOOPBACK_DEFAULT_INTERFACE  0x7F000001

/// Minimum number of rows in loopback table.
