...
/// ATM cell length in bytes

#define ATM_CELL_LENGTH 53


/// ATM cell header in bytes

#define ATM_CELL_HEADER 5


/// Number of ATM Cell in per Frame

#define ATM_NUM_CELL_IN_FRAME 4


/// Interface state of ATM layer2
...
/// Union of UNI and NNI part of Atm cell
...
/// Main data structure of ATM LAYER2
...
///
/// \return pointer to AtmLayer2Data
