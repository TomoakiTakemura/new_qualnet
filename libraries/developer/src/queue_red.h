...
/// Denotes the default number of packets in the queue that
...
/// This class is derived from Queue to Simulate RED Queue
class RedQueue:public Queue
{
    ...
    public:
        RedQueue(Node* node,
                ...
                const RedParameters* configInfo = NULL
#ifdef ADDON_DB
