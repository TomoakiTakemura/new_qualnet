...
/// Invalid VPI for SAAL is 255.
#define SAAL_INVALID_VPI 255


/// Busy path value for SAAL
#define SAAL_BUSY_PATH 1


/// Idle path value for SAAL
#define SAAL_IDLE_PATH 0


/// It is assumed that each application requires 0.5 Mbps
/// of BandWidth
#define SAAL_DEFAULT_BW 500 // in bps


/// Various timer used for controlling signalling
/// behaviour in ATM.
#define SAAL_TIMER_T301_DELAY  (3 * MINUTE)  //Minimum3 min


/// T303 delay for SAAL timer.
#define SAAL_TIMER_T303_DELAY  (4 * SECOND)


/// T306 delay for SAAL timer.
#define SAAL_TIMER_T306_DELAY  (30 * SECOND)


/// T310 delay for SAAL timer.
#define SAAL_TIMER_T310_DELAY  (10 * SECOND)


/// T313 delay for SAAL timer.
...
/// Maxium sequence number.
#define MAX_SEQ_NUMBER 250


/// Invalid SAAL interface.
#define SAAL_INVALID_INTERFACE  -1


/// Various signalling status for SAAL
typedef enum
{
    SAAL_INVALID_STATUS,
...
/// Various call endpoints foe SAAL
typedef enum
{
    CALLING_USER,
        CALLING_NET_SWITCH,
...
/// Information element identifire for SAAL
typedef enum
{
...
/// Set the value of ext for SaalInformationElement
///
...
/// Set the value of codeStd for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
...
/// Set the value of flag for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
...
/// Set the value of res forSaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
...
/// Set the value of actionInd forSaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
...
/// Returns the value of ext for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
///    RETURN       : BOOL
...
/// Returns the value of codeStd for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
///    RETURN       : UInt8
...
/// Returns the value of flag for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
///    RETURN       : BOOL
...
/// Returns the value of res for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
///    RETURN       : BOOL
...
/// Returns the value of actionInd for SaalInformationElement
///
///    + saalIele   : The variable containing the value of ext,codeStd,flag,res
///    and actionInd
///    RETURN       : UInt8
...
/// Information element AAL Parameters
...
/// Information element ATM Traffic Descriptor.
...
/// Information element Broadband bearer Capability
...
/// Set the value of ext1 for SaalIEBrBearerCapability
///
...
/// Set the value of spare1 for SaalIEBrBearerCapability
///
///    + sIeBCap    : The variable containing the value of ext1,spare1 and
///    bearerC1
...
/// Set the value of bearerC1 for SaalIEBrBearerCapability
///
///    + sIeBCap    : The variable containing the value of ext1,spare1 and
///    bearerC1
...
/// Set the value of ext2 for SaalIEBrBearerCapability
///
...
/// Set the value of spare2 for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
...
/// Set the value of TrType for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
...
/// Set the value of TimeRq for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
...
/// Returns the value of ext1 for SaalIEBrBearerCapability
///
///    + sIeBCap    : The variable containing the value of ext1,spare1 and
///    bearerC1
///    RETURN       : BOOL
...
/// Returns the value of spare1 for SaalIEBrBearerCapability
///
///    + sIeBCap    : The variable containing the value of ext1,spare1 and
///    bearerC1
///    RETURN       : UInt8
...
/// Returns the value of bearerC1 for SaalIEBrBearerCapability
///
///    + sIeBCap    : The variable containing the value of ext1,spare1 and
///    bearerC1
///    RETURN       : UInt8
...
/// Returns the value of ext2 for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
///    RETURN       : BOOL
...
/// Returns the value of spare2 for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
///    RETURN       : UInt8
...
/// Returns the value of TrType for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
///    RETURN       : UInt8
...
/// Returns the value of TimeRq for SaalIEBrBearerCapability
///
///    + sIeBearerCap : The variable containing the value of ext2,spare2,TrType
///    and TimeRq.
///    RETURN       : UInt8
...
/// Information element Broadband high layer info
...
/// Set the value of ext for SaalIEBrHighLayerInfo
///
...
/// Set the value of HighLrInfoType for SaalIEBrHighLayerInfo
///
///    + sIeHlInfo  : The variable containing the value of ext and
///    HighLrInfoType.
...
/// Returns the value of ext for SaalIEBrHighLayerInfo
///
///    + sIeHlInfo  : The variable containing the value of ext and
///    HighLrInfoType.
///    RETURN       : BOOL
...
/// Returns the value of HighLrInfoType for
/// SaalIEBrHighLayerInfo
///
///    + sIeHlInfo  : The variable containing the value of ext and
///    HighLrInfoType.
...
/// Information element Broadband low layer info
...
/// Set the value of ext1 for SaalIEBrLowLayerInfo
///
...
/// Set the value of layer1Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo1 : The variable containing the value of ext1,layer1Id and
///    layer1Protocol.
...
/// Set the value of layer1Protocol for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo1   : The variable containing the value of ext1,layer1Id and
///    layer1Protocol.
...
/// Set the value of ext2 for SaalIEBrLowLayerInfo
///
...
/// Set the value of layer2Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo2 : The variable containing the value of ext2,layer2Id and
///    layer2Protocol.
///    + layerId     : Input value for set operation
...
/// Set the value of layer2Protocol for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo2   : The variable containing the value of ext2,layer2Id and
///    layer2Protocol.
///    + layerProtocol : Input value for set operation
...
/// Set the value of ext3 for SaalIEBrLowLayerInfo
///
...
/// Set the value of layer3Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo3 : The variable containing the value of ext3,layer3Id and
///    layer3Protocol.
///    + layerId     : Input value for set operation
...
/// Set the value of layer3Protocol for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo3   : The variable containing the value of ext3,layer3Id and
///    layer3Protocol.
///    + layerProtocol : Input value for set operation
...
/// Returns the value of ext1 for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo1 : The variable containing the value of ext1,layer1Id and
///    layer1Protocol.
///    RETURN       : BOOL
...
/// Returns the value of layer1Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo1 : The variable containing the value of ext1,layer1Id and
///    layer1Protocol.
///    RETURN       : UInt8
...
/// Returns the value of layer1Protocol for
/// SaalIEBrLowLayerInfo
///
///    + sIeBllInfo1 : The variable containing the value of ext1,layer1Id and
///    layer1Protocol.
...
/// Returns the value of ext2 for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo2 : The variable containing the value of ext2,layer2Id and
///    layer2Protocol.
///    RETURN       : BOOL
...
/// Returns the value of layer2Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo2 : The variable containing the value of ext2,layer2Id and
///    layer2Protocol.
///    RETURN       : UInt8
...
/// Returns the value of layer2Protocol for
/// SaalIEBrLowLayerInfo
///
///    + sIeBllInfo2 : The variable containing the value of ext2,layer2Id and
///    layer2Protocol.
...
/// Returns the value of ext3 for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo3 : The variable containing the value of ext3,layer3Id and
///    layer3Protocol.
///    RETURN       : BOOL
...
/// Returns the value of layer3Id for SaalIEBrLowLayerInfo
///
///    + sIeBllInfo3 : The variable containing the value of ext3,layer3Id and
///    layer3Protocol.
///    RETURN       : UInt8
...
/// Returns the value of layer3Protocol for
/// SaalIEBrLowLayerInfo
///
///    + sIeBllInfo3 : The variable containing the value of ext3,layer3Id and
///    layer3Protocol.
...
/// Information element Call state Information Element
...
/// Set the value of spare for SaalIECallStateInfo
///
...
/// Set the value of callStateValue for SaalIECallStateInfo
///
///    + saalIeSInfo : The variable containing the value of spare and
///    callStateValue
...
/// Returns the value of spare for SaalIECallStateInfo
///
///    + saalIeSInfo : The variable containing the value of spare and
///    callStateValue
///    RETURN       : UInt8
...
/// Returns the value of callStateValue for SaalIECallStateInfo
///
///    + saalIeSInfo : The variable containing the value of spare and
///    callStateValue
///    RETURN       : UInt8
...
/// Information element CalledParty Number
...
/// Set the value of ext for SaalIECalledPartyNumber
///
...
/// Set the value of typeOfNumber for SaalIECalledPartyNumber
///
///    + sIeCalledPn  : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
...
/// Set the value of AddrPlanId for SaalIECalledPartyNumber
///
///    + sIeCalledPn : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
...
/// Set the value of Flag for SaalIECalledPartyNumber
///
...
/// Set the value of numberDigit for SaalIECalledPartyNumber
///
///    + sIeCalledPnum : The variable containing the value of Flag and
///    numberDigit.
...
/// Returns the value of ext for SaalIECalledPartyNumber
///
///    + sIeCalledPn : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
///    RETURN       : BOOL
...
/// Returns the value of typeOfNumber for
/// SaalIECalledPartyNumber
///
///    + sIeCalledPn : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
...
/// Returns the value of AddrPlanId for
/// SaalIECalledPartyNumber
///
///    + sIeCalledPn : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
...
/// Returns the value of numberDigit for
/// SaalIECalledPartyNumber
///
///    + sIeCalledPnum : The variable containing the value of Flag and
///    numberDigit.
...
/// Information element CallingParty Number
...
/// Set the value of ext for SaalIECallingPartyNumber
///
...
/// Set the value of typeOfNumber for SaalIECallingPartyNumber
///
///    / + sIeCallingPn  : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
...
/// Set the value of AddrPlanId for SaalIECallingPartyNumber
///
///    / + sIeCallingPn  : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
///    + apid           : Input value for set operation
...
/// Set the value of Flag for SaalIECallingPartyNumber
///
...
/// Set the value of numberDigit for SaalIECallingPartyNumber
///
///    + sIeCallingPnum : The variable containing the value of Flag and
///    numberDigit.
...
/// Returns the value of ext for SaalIECallingPartyNumber
///
///    / + sIeCallingPn  : The variable containing the value of ext,typeOfNumber
///    and AddrPlanId.
///    RETURN       : BOOL
...
/// Information Element Calling party sub-address
...
/// Set the value of ext for SaalIECallingPartySubAddr
///
...
/// Set the value of type for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
...
/// Set the value of indicator for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
...
/// Set the value of spare for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
///    + spare      : Input value for set operation
...
/// Returns the value of ext for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : BOOL
...
/// Returns the value of type for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : UInt8
...
/// Returns the value of indicator for
/// SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
...
/// Returns the value of spare for SaalIECallingPartySubAddr
///
///    + sIeCalling : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : UInt8
...
/// Set the value of ext for SaalIECalledPartySubAddr
///
...
/// Set the value of type for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    + type       : Input value for set operation
...
/// Set the value of indicator for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    + ind        : Input value for set operation
...
/// Set the value of spare for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare..
///    + spare      : Input value for set operation
...
/// Returns the value of ext for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : BOOL
...
/// Returns the value of type for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : BOOL
...
/// Returns the value of indicator for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : BOOL
...
/// Returns the value of spare for SaalIECalledPartySubAddr
///
///    + sIeCalled  : The variable containing the value of ext,type,indicator
///    and spare.
///    RETURN       : BOOL
...
/// Information element Connection Identifier
...
/// Set the value of ext for SaalIEConncIdentifier
///
...
/// Set the value of spare for SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
///    + spare      : Input value for set operation.
...
/// Set the value of VPAssocSignalling for
/// SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
...
/// Set the value of preferred for
/// SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
...
/// Returns the value of ext for SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
///    RETURN       : BOOL
...
/// Returns the value of spare for SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
///    RETURN       : UInt8
...
/// Returns the value of VPAssocSignalling for
/// SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
...
/// Returns the value of preferred for SaalIEConncIdentifier
///
///    + sIeIdent   : The variable containing the value of ext,spare,
///    VPAssocSignalling and preferred.
///    RETURN       : UInt8
...
/// Information element EndToEnd Transit Delay
...
/// Information element QoS Parameter
...
/// Set the value of callRefValue1 for SaalMsgHeader
///
...
/// Set the value of flag for SaalMsgHeader
///
///    + saalMsgHdr : The variable containing the value of callRefValue1 and
///    flag.
///    +  flag      : Input value for set operation
...
/// Returns the value of flag for SaalMsgHeader
///
///    + saalMsgHdr : The variable containing the value of callRefValue1 and
///    flag.
///    RETURN       : BOOL
...
/// Returns the value of callRefValue1 for SaalMsgHeader
///
///    + saalMsgHdr : The variable containing the value of callRefValue1 and
///    flag.
///    RETURN       : UInt8
...
/// SAAL connecting packet structure
...
/// Packet structure for acknowledging SAAL connection
...
/// Packet structure for complete release of SAAL connection
...
/// Packet structure for VPI list item for SAAL.
...
/// Data structure for SAAL interface.
...
/// Data structure for SAAL application.
...
/// Innitialization of SAAL in ATM
///
/// \param node  Pointer to node.
/// \param saalLayerPtr  SAAL layer pointer.
...
/// Protocol event handelling function for SAAL.
///
/// \param node  Pointer to node.
...
/// Protocol packet handelling function for SAAL.
///
/// \param node  Pointer to node.
/// \param msg  Pointer to message
...
/// To start signaling process.
///
/// \param node  Pointer to node.
/// \param VCI  Virtual connection identifire.
/// \param VPI  VPI value for SAAL.
