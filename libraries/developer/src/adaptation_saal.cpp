...
// Free all the network resources reserved for this connc
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
// \param intfId  Interface identifire
//    RETURN       : void : None
...
// Check if BW is available for this application
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
// \param outIntf  interface thru which packet transfer
...
// check if I am U-UNI or N-NNI on calling
// side or called side
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
...
// Check if all the necessary IE are present in Setup Msg
// & they are valid
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
...
//
// \param node  Pointer to node.
// \param entry  Pointer to SAAL app data.
// \param intfId  Interface identifire
//    RETURN       : void : None
...
// Create a new entry in app list to store
// this application related information
//
// \param node  Pointer to node.
// \param clientAddr  client for this application
// \param serverAddr  server for this Application
// \param entryPoint  entry point to ATM cloud
// \param exitPoint  exit point from ATM cloud
// \param prevHop  prevHop Address for this entry
// \param intfId  Interface identifire
// \param VCI  Virtual connection identifire.
// \param VPI  VPI value for SAAL.
//    RETURN       : void : None
...
// Create Header for Saal control Message
//
// \param node  Pointer to node.
// \param pktHdr  Pointer to message header
// \param type  SAAL message type.
// \param ieLength  Information elemnt header length
//    RETURN       : void : None
...
// Cancel the message pointer for this self-timer
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
// \param intfId  Interface identifire
// \param type  The type of Timer used
//    RETURN       : void : None
...
// Allocate & Send Self Timer for SAAL
// ARGUMENTS   ::
...
// Fill the common part of IE header part
// for each information element in a message
//
// \param node  Pointer to node.
// \param type  type of IE identifier
// \param ieFieldPtr  Informatiuon field pointer
// \param thisIEContentLn  Information element length
//    RETURN       : void : None
...
// Saal search for matching timer
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
// \param intfId  Interface identifire
// \param type  type of Saal timer used
...
// Saal can terminate connection for resource unavialability
...
// Create & send Release Complete message
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
//    RETURN       : void : None
...
// Send Alert message during connection setup
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
//    RETURN       : void : None
...
// Send Connect Message during connection setup
//
// \param node  Pointer to node.
// \param saalAppData  Pointer to SAAL app data.
//    RETURN       : void : None
...
// Send ConnectAcknowledgeMessage after
// receiving connect message
//
// \param node  Pointer to node.
// \param prevHop  Pointer to previous hop
...
// CallingUser Process ReleaseComplMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Called Network Process ReleaseComplMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledNetwork Process Release Message
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Common network element Process Release Message
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledUser Process ReleaseMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CallingNetwork Process ReleaseMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CallingNetworkProcess SetupMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Common network element Process SetupMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledNetwork Process SetupMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Checking if the final destination is
...
// CalledUser Process SetupMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledNetwork process ConnectMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Common network element process ConnectMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CallingNetwork Process ConnectMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CallingUser Process ConnectMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledUser Process ConnectAckMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CalledNetwork process AlertMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Common network element process AlertMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// CallingNetwork Process AlertMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Calling user receieve Alert message
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Calling User receieve call proceeding Message
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Called Network Receive Call Proceeding message
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Common Network element ReceiveCallProcMessage
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
// \param saalAppData  Pointer to SAAL app data.
...
// Connection table is refreshed here
//
// \param node  Pointer to node.
// \param msg  Pointer to message.
//    RETURN       : void : None
