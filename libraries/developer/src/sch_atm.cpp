...
// Denotes for debuging ATM.

#define ATM_DEBUG 0


// Returns Greatest Common Divisor of two integer.
//
//    + a : int
//    + b : int
//
...
// Allocate or deallocate bandwidth for a specific queue
//
// \param queueIndex  Queue Index
// \param bandwidth  bandwidth
// \param isAdd  Is add
//
// \return If operation successful then return TRUE
// otherwise FALSE
...
// Checks if need to resets all weightCounter for all queues
...
// Schedules for a queueIndex And packetIndex to be dequeued
//
// \param index  Index
// \param queueIndex  Queue Index
//
...
// Inserts a packet in the queue
//
// \param msg  Message Pointer
// \param QueueIsFull  Checkinh for Queue is full
// \param queueIndex  Queue Index
// \param infoField  Pointer to Info field
...
//
// \param priority  Queue Pririty
// \param index  Index
// \param msg  Pointer to Message
// \param msgPriority  message Priority
// \param operation  next header field
// \param currentTime  Current Simulation Time
//
// \return BOOL
// NOTE       This function prototype determines the arguments that need
...
// Addes a Queue to the Scheduler
//
// \param queue  Queue
...
// Only define this function because
// this is pure virtual function in scheduler.h
//
...
// \param invokingProtocol  Invoking Protocol
//
...
// Class Constructor
//
// \param enableSchedulerStat  Enable Scduler Stat
//
// \return constructer
