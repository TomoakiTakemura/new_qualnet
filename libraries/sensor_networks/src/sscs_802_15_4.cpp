...
// Returns Status string for a given status
//
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #SetTimer#\n",node->getNodeTime(),node->nodeId);
}
...
// Start a PAN and PAN co-ordinator
//
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #StartPANCoord#\n",node->getNodeTime(),node->nodeId);
}
    ...
    switch(sscs802_15_4->state)
    {
        ...
        case S802_15_4SCANREQ:
        {
            ...
            if (sscs802_15_4->t_BO < 15)    // Transmit beacons
            {
                ...
                {
                    mac->gtsSpec.queue[i] = new Queue(node,
                                                     "FIFO",
...
//
// \param node  Node receiving call
// \param assoPermit  Whether association is permitted
// \param status  Status of request
//
static
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #StartDevice#\n",node->getNodeTime(),node->nodeId);
}
    ...
    switch(sscs802_15_4->state)
    {
        ...
        case S802_15_4ASSOREQ:
        {
            ...
            else
            {
                ...
                for (i = 0; i < 2; i++)
                {
                    mac->gtsSpec2.queue[i] = new Queue(node,
                                                      "FIFO",
                                                      M802_15_4BROADCASTQUEUESIZE);
                }
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #StopDevice#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #PoolRequest#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #IsDeviceUp#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MCPS_DATA_indication#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_ASSOCIATE_indication#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_ASSOCIATE_confirm#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_ORPHAN_indication#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_RESET_confirm#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_SCAN_confirm#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_COMM_STATUS_indication#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_START_confirm#\n",node->getNodeTime(),node->nodeId);
}
...
// Resets GTS chracteristic at a node
//
// \param node  Node receiving call
// \param interfaceIndex  Interface Index
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_SYNC_LOSS_indication#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #MLME_POLL_confirm#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #PrintStats#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #Init#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #Layer#\n",node->getNodeTime(),node->nodeId);
}
...
{
if (KANDEB){
	printf("%" TYPES_64BITFMT "d : Node %d: sscs.cpp in the #Finalize#\n",node->getNodeTime(),node->nodeId);
}
