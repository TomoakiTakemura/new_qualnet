...
/// max # of octets added by the MAC sublayer to the payload of
/// its beacon frame
const UInt8 aMaxBeaconOverhead     = 75;

/// Define MACADDR as unsinged int16. Should be 64-bit but use
...
/// MAC enumerations description (Table 78), 2006
typedef enum
{
    M802_15_4_SUCCESS = 0,
...
/// MAC PIB attributes (Tables 86,88), 2006
typedef enum
{
