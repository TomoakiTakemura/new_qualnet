...
// Deletes or update device link at the node
//
...
// Returns number of current device links at the node
//
// \param deviceLink1  Device Link structure
//
// \return Int32
...
// Returns a pending packet from transaction link
//
// \param transacLink1  Transaction Link structure
//    + pendAM         : UInt8                  :
// \param pendAddr  MAC address
...
// Deletes or updates transaction link
//
// \param node  Node pointer
// \param oper  Operation
// \param transacLink1  Transaction Link structure
...
// To update or delete transaction list
//
// \param node  Node pointer
// \param oper  Operation
// \param transacLink1  Transaction Link structure
...
// Returns number of current transaction links at the node
//
// \param node  Node pointer
// \param transacLink1  Transaction Link structure
// \param transacLink2  Transaction Link structure
...
// Checks and add transaction link at the node
//
// \param node  Node pointer
// \param transacLink1  Transaction Link structure
// \param transacLink2  Transaction Link structure
