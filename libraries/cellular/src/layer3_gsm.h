...
typedef struct struct_gsm_layer3_bs_info_str
{
    ...
    GsmTrafficConnectionDescription trafficConnectionDesc[GSM_MAX_TRAFFIC_CONNECTION_ID];
...
typedef struct struct_gsm_msc_info_str
{
    ...
    GsmTrafficConnectionInfo    trafficConnInfo[GSM_MAX_TRAFFIC_CONNECTION_ID];
