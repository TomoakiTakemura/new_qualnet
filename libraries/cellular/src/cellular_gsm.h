...
/// \defgroup Package_GSM GSM

/// \file
/// \ingroup Package_GSM
/// This file defines the data structures used by GSM models.

#ifndef _GSM_H_
#define _GSM_H_

/// GSM burst size in bytes
#define     GSM_BURST_SIZE                  19 // bytes , ~156.25 bits

/// Size of usable part of a GSM burst bytes
#define     GSM_BURST_DATA_SIZE             14 // bytes , ~114 bits

/// GSM Channel Bandwidth in Hz
#define     GSM_CHANNEL_BANDWIDTH           200000

/// Defines the Hyperframe size (3h 28m 53s 760ms)
/// Maximum Frame Number FN_MAX: 0 to (26 x 51 x 2048 - 1)
#define     GSM_MAX_FRAME_SIZE              2715647

/// Number of superframes in a hyperframe
#define     GSM_MAX_SUPERFRAME              2048

/// Defines the size of GSM superframe
// 6.12s, 26 x 51 multiframes
#define     GSM_SUPERFRAME_SIZE             1326

/// Defines GSM SACCH MULTIFRAME SIZE
// 26 x 4 FRAMES = 480MS
#define     GSM_SACCH_MULTIFRAME_SIZE       104

/// Defines the GSM CONTROL MULTIFRAME SIZE
// ~235ms
#define     GSM_CONTROL_MULTIFRAME_SIZE     51

/// Specifies the GSM TRAFFIC MULTIFRAME SIZE
// 120ms
#define     GSM_TRAFFIC_MULTIFRAME_SIZE     26

/// Defines the number of slots per GSM frame
/// 4.61ms (577us x 8)
#define     GSM_SLOTS_PER_FRAME             8

/// Defines the maximum no of MSC
#define     GSM_MAX_NUM_MSC             1


/// Specifies maximum number of base stations per MSC
#define     GSM_MAX_BS_PER_MSC              7

/// Specifies SCCP connection limit
...
/// Defines the GSM number of measurement samples constant
#define     GSM_NUM_MEAS_SAMPLES            32

/// Defines the default GSM minimum receive level
/// Mapped value
#define     GSM_RXLEV_MIN_DEF               20 // Mapped value

/// Defines  downlink receive level
#define     GSM_L_RXLEV_DL_H                -90 // -103 to -73 dBm

/// Defines the GSM uplink receive level constant
#define     GSM_L_RXLEV_UL_H                -80 // -103 to -73 dBm

/// Defines the GSM DL receive quality for handover
#define     GSM_L_RXQUAL_DL_H               0.08 // ~ mapped 6

/// Defines the GSM UL receive quality for handover
#define     GSM_L_RXQUAL_UL_H               0.08 // ~ mapped 6

/// Defines GSM handover required average
...
/// Defines GSM INVALID SLOT NUMBER
#define     GSM_INVALID_SLOT_NUMBER     -1

/// Defines the GSM INVALID CHANNEL INDEX
#define     GSM_INVALID_CHANNEL_INDEX   -1

/// Defines the GSM INVALID CELL IDENTITY
#define     GSM_INVALID_CELL_IDENTITY   -1

/// Defines GSM INVALID LAC_IDENTITY    -1
#define     GSM_INVALID_LAC_IDENTITY    -1

/// Defines the GSM INVALID CHANNEL TYPE
...
/// Defines the GSM Transmission integer
#define     GSM_TX_INTEGER              8

/// Defines the GSM maximum retransmission value
#define     GSM_MAX_RETRANS             4

/// Defines the 'S' parameter from Table 3.1
#define     GSM_RANDACCESS_S            55

/// GSM 03.22, section 3.5.2.2
...
/// Defines the default Periodic Location Update Timer duration
...
/// Defines the default CM Service Request Timer duration
static const clocktype  DefaultGsmCmServiceRequestTimer_T3230Time       = (
        15 * SECOND );

/// Defines the default Timer T3240 duration
...
/// Identifies node type in MacDataGsm struct
typedef enum
{
    GSM_MS  = 1,
    GSM_BS  = 2,
...
/// Identifies the call type in MS
typedef enum
{
...
/// Specifies the type of identity used for a MS
typedef enum
{
    GSM_IMSI,
    GSM_MSISDN
...
/// Identifies the type of GSM control channel
enum
{
    GSM_CHANNEL_FCCH,
    GSM_CHANNEL_SCH,
...
/// Defines GSM SPEECH CALL channel request cause
...
/// Defines GSM location updating cause
#define GSM_EST_CAUSE_LOCATION_UPDATING 0x00

/// Defines establishment cause to paging channel request
...
/// Defines the local user of GSM public network
#define GSM_LOCATION_PUBLIC_NETWORK_LOCALUSER    0x02

/// Defines cause value for call clearing: normal
...
/// Defines cause value for call clearing: due to radio link failure
#define GSM_CAUSE_CALL_COMPLETION_FAILED        0x11


/// Defines cause value for call clearing: user not responding
// May refer GSM 04.08, Section 10.5.4.11 'Cause' sub-element: cause value
// Cause number 18 in Table 10.86
#define GSM_CAUSE_VALUE_USER_NOT_RESPONDING     0x12


/// Defines cause value for call clearing: no response to alert
// May refer GSM 04.08, Section 10.5.4.11 'Cause' sub-element: cause value
// Cause number 19 in Table 10.86
#define GSM_CAUSE_VALUE_USER_ALERTING_NO_ANSWER     0x13


/// Defines cause value for call rejection
// May refer GSM 04.08, Section 10.5.4.11 'Cause' sub-element: cause value
...
/// Idetifies the Call control related message types
...
/// Identifies Mobility management related messages types
typedef enum
{
...
/// Identifies the Radio Resource management message types
typedef enum
{
...
/// Defines  CM Service Type :ref GSM 04.08, sec 10.5.3.3
#define GSM_CM_SERVICE_REQUEST_TYPE_MO_CALL  0x01

/// Identifies GSM A interface (BSC-MSC) message types
...
/// Describes the cause of GsmAInterface message
...
/// Defines type of Gsm sccp message
typedef enum
{
...
/// Used for setting up & conveying traffic messages
/// between the BS & MSC
typedef enum
{
...
/// Provides a variety of information about a cell.
