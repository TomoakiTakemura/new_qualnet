...
// Transmit a packet on the traffic channel (TCH)
...
// \param node  Pointer to node
// \param interfaceIndex  index of the interface where the MAC is running
// \param msg  Packet to be sent on TCH
//
static
...
// Calculate the signal strength. In theory, the strength
// should be reported by the PHY model. Here, we simply
// estimate signal strength by calculating the distance to BS
//
// \param bsLocation  location of the BS
// \param msLocation  location of myself (MS)
// \param signalStrength  for return the signal strength calculated
// \param numSector  number of sectors of this BS
// \param sectorId  for return sector id of this measurement
//
static
...
// Measure the signal strength when a packet is received
// from the BCCH channel
//
// \param node  Pointer to node.
// \param interfaceIndex  interface running this MAC
// \param msg  Packet received from BCCH
//
static
...
// Build a downlink measurement report to layer3
//
// \param node  Pointer to node.
// \param interfaceIndex  Interface index
// \param msg  packet to be sent to layer3
// \param noSignal  whether a signal is present in the report
//
...
// Scheudle TCH transmission
//
// \param node  Pointer to node.
// \param msg  Packet received from PHY
// \param delay  delay for the TCH transmission
//
...
// modified insert function, based on SPLAY_Insert
...
// \param splayNodePtr  Point to the node
// \param newTime  New Time or not
//
...
//
// \param node  Pointer to node.
// \param interfaceIndex  interface to handle the message
//
