...
/// \defgroup Package_CELLULAR_ABSTRACT CELLULAR_ABSTRACT

/// \file
/// \ingroup Package_CELLULAR_ABSTRACT
/// Defines the data structures used in all layers of the abstract cellualr model
...
/// Specifies the default CellularSlotDuration
static const clocktype  DefaultCellularSlotDuration = (577 * MICRO_SECOND);

/// Establishment cause for a RR connection
typedef enum
{
...
/// Define the types of applications supported by the MS
typedef enum
{
...
/// Define the types of service supported by the BS
typedef enum
{
...
/// Define the types of cellular protocol message
typedef enum
{
...
/// Define the types of channel requested by the transaction
...
/// Define the call control state at the network side
typedef enum
{
...
/// Define the call control state at the MS side
typedef enum
{
...
/// Define the type of info delivered between MAC and LAYER3
...
/// Define the type of applicaitons' src and dest
typedef enum
{
...
/// Define the types of indication transmitted
...
/// Define the types of logical channel,
typedef enum
{
...
/// Definition of the MS's status: active or inactive
typedef enum
{
...
/// Definition of the call admission control
...
/// Definition of the congestion control
/// policy supported in the system
typedef enum
{
...
/// Definition the structure of layer 3 header
...
/// Definition the structure of system information of BS
...
/// Definition the structure of measurement report
...
/// Definition the structure of cell and sector
...
/// Definition the structure of info field
