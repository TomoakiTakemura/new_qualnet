...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline void Mpls_Shim_LabelStackEntrySetLabel(UInt32 *shimStack,
                                              UInt32 Label)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline void Mpls_Shim_LabelStackEntrySetExp(UInt32 *shimStack, UInt32 Exp)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline void Mpls_Shim_LabelStackEntrySetS(UInt32 *shimStack, BOOL S)
{
    unsigned int x = S;
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline void Mpls_Shim_LabelStackEntrySetTTL(UInt32 *shimStack, UInt32 TTL)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline UInt32 Mpls_Shim_LabelStackEntryGetTTL(UInt32 shimStack)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline UInt32 Mpls_Shim_LabelStackEntryGetLabel(UInt32 shimStack)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline UInt32 Mpls_Shim_LabelStackEntryGetExp(UInt32 shimStack)
{
...
// ASSUMPTION   : None
//-------------------------------------------------------------------------
inline BOOL Mpls_Shim_LabelStackEntryGetS(unsigned int shimStack)
{
    UInt32 S = shimStack;
