...
/// Maximum number of hops a sip packet can travel
#define     SIP_MAX_FORWARDS                70

/// Maximum number of simultaneous dialogs per proxy
#define     MAX_CONCURRENT_DLGS_PER_PROXY   20

/// Number of hostbits
#define     NUMBER_OF_HOSTBITS              32

/// Signalling protocol type definition for SIP
#define     SIG_TYPE_SIP                    2

/// string size of 16 bits
#define     SIP_STR_SIZE16                  16

/// IP address length of dotted decimal format a.b.c.d
#define     IP_ADDRESS_LENGTH               16

/// string size of 32 bits
#define     SIP_STR_SIZE32                  32

/// string size of 64 bits
#define     SIP_STR_SIZE64                  64

/// Max no.of UA nodes alloted per one block
#define     MAX_HOSTS_PER_PROXYBLOCK        10

/// Transport protocol used by sip
#define     SIP_TRANS_PROTOCOL              TCP

/// Initializer used to init connectionId
#define     INVALID_ID                      -1

/// Maximum sip packet size
#define     MAX_SIP_PACKET_SIZE             2560

/// Count of number of vias
#define     SIP_VIA_COUNT                   4

/// Min. sip message length
#define     MIN_SIP_HDR_SIZE                50


/// structure holding SipVia field
struct SipVia
{
...
/// Type of sip response(For details refer sec.21 of RFC3261)
enum SipResType
{
    INVALID_RES             = 0,
...
/// Represents generic sip message structure
class SipMsg
{
    char*       pBuffer;
