...
/// Maximum number of queue for DIFFSERV Scheduler

#define DIFFSERV_MAX_NUM_QUEUE              8

/// Minimum number of queue for inner and outer scheduler

#define DIFFSERV_FIRST_SCHED_MIN_QUEUE      1

/// Maximum number of queue for inner and outer scheduler.
