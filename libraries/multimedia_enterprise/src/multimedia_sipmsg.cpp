...
// Constructor of the SipMsg class
//
//
SipMsg :: SipMsg()
{
...
// Destructor of the SipMsg class
//
//
SipMsg :: ~SipMsg()
{
...
// Update via field with the received Ip
//
//
...
// Get the respone string corresponding to an enum
//
...
// Create Sip Invite request packet
//
...
// create a sip Acknowledge request packet for 2xx response
//
//    +node       : Node*        : Pointer to the node
//    +sip        : SipData*     : Pointer to SipData
//
...
// create a sip Acknowledge request packet for Non2xx response
...
// Check the type of received sip message
//
...
// Init and allocate memory for the Via field
//
//
...
// Parse for fields of the sip message
//
...
// Parse sip message to fill components
//
//
...
// create response packet for forwarding
//
//    +node       : Node* : Pointer to the node
...
// Create Invite request packet for forwarding
//
//    +node       : Node* : Pointer to the node
//
...
// Set proper connection Id in the sip message
//
//    +node       : Node* : Pointer to the node
