...
// Print Database summary list of the Router.
//
// \param node  Pointer to node.
// \param DBSummaryList  Pointer to List.
//
static
...
// Print Database Description Packet.
//
// \param node  Pointer to node.
...
// Print Router LSA List of an Area.
//
// \param node  Pointer to node.
...
// Print Inter Area Prefix LSA List of an Area.
//
// \param node  Pointer to node.
// \param thisArea  Pointer to Area Structure.
//
...
// Print Inter Area Router LSA List of an Area.
//
// \param node  Pointer to node.
// \param thisArea  Pointer to Area Structure.
//
...
// Print Intra Area Prefix LSA List of an Area.
//
// \param node  Pointer to node.
// \param thisArea  Pointer to Area Structure.
//
...
// Print Router LSA List of all the Area to which node belongs.
//
// \param node  Pointer to node.
//
static
...
// Print Network LSA List of all the Area to which node belongs.
//
// \param node  Pointer to node.
//
...
// Print Inter Area Prefix LSA List of all the Area to which
// node belongs.
//
// \param node  Pointer to node.
//
...
// Print Inter Area Router LSA List of all the Area to which
// node belongs.
//
// \param node  Pointer to node.
//
...
// Print AS-External LSA List of the Router.
//
// \param node  Pointer to node.
//
static
...
// Print Link LSA List of the Router.
//
// \param node  Pointer to node.
//
static
...
// Print Intra Area Prefix LSA List of the Router.
//
// \param node  Pointer to node.
//
static
...
// Print Link State Database of the Router.
//
// \param node  Pointer to node.
//
static
...
// Change Neighbor State into String Printable format.
//
...
// Print Vertex List formed during SPF calculation of the node.
//
...
// Print shortest path list of the node.
//
//    +Node  : Node*   : Pointer to node.
// \param shortestPathList  Pointer to list.
//
static
...
// Print candidate list of the node.
//
//    +Node  : Node*   : Pointer to node.
// \param candidateList  Pointer to list.
//
static
...
//
// \param node  Pointer to Node.
// \param helloPkt  Pointer to hello packet.
//
static
...
// Print Neighbor List of the node.
//
// \param node  Pointer to Node.
//
static
...
// Read user specified interface related parameters from file.
//
// \param node  Pointer to Node.
...
// Initialize Area configuration from chached .ospf file.
//
// \param node  Pointer to Node.
// \param ospfConfigFile  Pointer to chached input file.
// \param interface  Interface Identifier.
...
// Add interface to the List of connected interface in the Area.
//
// \param node  Pointer to Node.
// \param areaId  Area Id.
// \param interface  Interface Identifier.
...
// Allocate memory for initial routing table.
//
// \param node  Pointer to Node.
//
// ** /
...
// Parse Nexthop Network Address.
//
// \param addrString  Pointer to string.
// \param ipAddress  Ip Address.
// \param isIpAddr  Is Ip address or something else.
// \param isNodeId  Pointer Node Id.
//
static
...
// BGP-OSPF Patch Start
// Inject "External Route" into Routing Table
// for AS Boundary Router.
//
// \param node  Pointer to Node.
// \param ospfExternalRouteInput  Pointer to chached External
//    Static Route File.
//
static
...
// Initialize OSPFv3 protocol Trace.
//
...
// ********************** Event Processing*********************************//
// Get area structure pointer by area Id.
//
...
// Fill the neighbors to be sent in hello packet.
//
//    +node:  Node* : Pointer to node, used for debugging.
...
// Get the AllSPFRouters multicast group.
//
...
// Get the AllDRouters multicast group.
//
//    +multicastAddress:  in6_addr* : Pointer to Ip Address.
//
static
...
// Get the neighbor structure from the neighbor list using
...
// This function is used to schedule Inactivity Timer and
...
// Broadcast Hello Packet on all OSPFv3 interfaces.
//
//    +node:  Node* : Pointer to node.
//
static
...
// Send DD Packet on specified interface.
//
//    +node:  Node* : Pointer to node.
//    +neighborId:  unsigned int : Neighbor Id.
//    +interfaceId:  int : Interface Id.
...
// Schedule an interface event to be executed later.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
...
// Return Interface Id to which the neighbor is connected.
//
//    +node:  Node* : Pointer to node.
//    +neighborId:  unsigned int : neighbor Id.
//
...
// Attempt Adjacency with the eligible neighbor.
//
//    +node:  Node* : Pointer to node.
...
// Create Link State Request Object.
//
//    +node:  Node* : Pointer to node.
//    +nbrInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
...
// Send Link State Request. Parameter retx indicates whether
...
// Send Update Packet on specified interface.
//
//    +node:  Node* : Pointer to node.
...
// Send Acknowledgment Packet on specified interface.
//
//    +node:  Node* : Pointer to node.
...
// Send Link State Update Packet on the specified interface.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
//
...
// Set Neighbor State. Also call scheduler
...
// Destroy Adjacency with the neighbor.
//
//    +node:  Node* : Pointer to node.
//    +neighborInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
//
...
// Check if Adjacency is required with the neighbor.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
//    +neighborInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
...
// Remove a neighbor from neighbor List.
//
//    +node:  Node* : Pointer to node.
...
// BGP Patch
// Check if Neighbor is in stub Area.
//
//    +node:  Node* : Pointer to node.
//    +nbrInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
//
...
// Add an LSA in the retransmission List.
//
//    +node:  Node* : Pointer to node.
//    +nbrInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
//    +LSA:  char* : Pointer to LSA byte.
...
// Update Database Summary List List.
//
//    +node:  Node* : Pointer to node.
...
// Create Database Summary List List.
//
//    +node:  Node* : Pointer to node.
//    +nbrInfo:  Ospfv3Neighbor* : Pointer to Neighbor Info.
//
...
// Handle neighbor event and change neighbor
// state accordingly.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
...
// Called from Ospfv3DRElection. Calculate Designated Router.
...
// Determine if an IP address is my own.
//
//    +node:  Node* : Pointer to node.
...
// Called from Ospfv3OriginateIntraAreaPrefixLSAForRouter.
...
// Verify if the interface belong to this area.
//
//    +node:  Node* : Pointer to node.
//    +areaId:  unsigned int : Area Id.
...
// Originate Intra Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
//    +areaId:  unsigned int : Area Id.
...
// Check if the Router is fully adjacent with Designated Rtr.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
...
// Flush LSA from Area routing domain.
//
//    +node:  Node* : Pointer to node.
...
// Schedule Router or Network LSA.
//
//    +node:  Node* : Pointer to node.
//    +LSHeader:  Ospfv3LinkStateHeader* : Pointer to LS header.
//    +areaId:  unsigned int : Area Id.
...
// Refresh LSA after refreshing interval.
//
//    +node:  Node* : Pointer to node.
...
// Increment the link state age field of LSAs stored in the
...
// Increment the link state age of all the LSA in Database.
//
//    +node:  Node* : Pointer to node.
//
static
...
// Check if the SPF tree calculating vertex has back link with
// other vertex.
//
//    +node:  Node* : Pointer to node.
...
// Check if the vertex is in Shortest Path List.
//
//    +node:  Node* : Pointer to node.
...
// Get interface for connected vertex.
//
...
// Check Router LSA and Check the Network is set Transit.
//
//    +node:  Node* : Pointer to node.
...
// Check Link with Network Vertex.
//
//    +node:  Node* : Pointer to node.
//    +vertexId:  Ospfv3VertexId : Vertex Id.
//
...
// Return Neighbor Info on particular interface.
//
//    +node:  Node* : Pointer to node.
//    +nbrId:  unsigned int : Neighbor Id.
//    +interfaceId:  int : Interface Id.
...
// Find Candidate in candidate list.
//
...
// Update Candidate List Using Router LSA.
//
//    +node:  Node* : Pointer to node.
...
// Check if network vertex is transit.
//
//    +node:  Node* : Pointer to node.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
//    +candidateList:  LinkedList* : Pointer to candidate List.
...
// Update Candidate List Using Network LSA.
//
//    +node:  Node* : Pointer to node.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
//    +candidateList:  LinkedList* : Pointer to candidate List.
...
// To Get Node Interface For Neighbor.
//
//    +node:  Node* : Pointer to node.
...
// To Add Route for Border Router
//
//    +node:  Node* : Pointer to node.
...
// To Update Intra Area Prefix Destination
//
//    +node:  Node* : Pointer to node.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
//
...
// To Find Shortest Path For This Area.
//
//    +node:  Node* : Pointer to node.
//    +areaId:  unsigned int : Area Id.
//
...
// To Examine Inter Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
//
...
// To Get Route For AS Boundary Router.
//
//    +node:  Node* : Pointer to node.
...
// To Reset advertise to Area flag within Area Address Range
...
// To check if Next Hop Belongs To This Area.
//
//    +node:  Node* : Pointer to node.
...
// To Schedule Inter Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
...
// To Originate Inter Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
...
// To Originate Inter Area Router LSA.
//
//    +node:  Node* : Pointer to node.
//    +advRt:  Ospfv3RoutingTableRow* : Pointer to Routing Table Row.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
...
// To Get Maximum Metric For The Range.
//
//    +node:  Node* : Pointer to node.
...
// To Check For Inter Area Prefix LSA Validity.
//
//    +node:  Node* : Pointer to node.
//    +advRt:  Ospfv3RoutingTableRow* : Pointer to Routing Table Row.
//    +areaId:  unsigned int : Area Id.
...
// To Check old Inter Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
//    +thisArea:  Ospfv3Area* : Pointer to Area.
//
...
// To Handle Removed Or Changed Routes.
//
//    +node:  Node* : Pointer to node.
//
static
...
// To Originate Default Inter Area Prefix LSA.
//
//    +node:  Node* : Pointer to node.
//
static
...
// To check if the Router is Fully Adjacent With the DR.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
//
...
// Find Interface Id advertised by DR..
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  int : Interface Id.
//
...
// To Add type 1 link for originating LSA.
//
//    +node:  Node* : Pointer to node.
//    +interfaceId:  unsigned int : Interface Id.
...
// To Search Request List for LSA.
//
//    +node:  Node* : Pointer to node.
//    +list:  LinkedList* : Pointer to list.
//    +LSHeader:  Ospfv3LinkStateHeader* : Pointer to LS header.
...
// Check whether the received LSA is more recent.
//
//    +node:  Node* : Pointer to node.
//    +LSHeader:  Ospfv3LinkStateHeader* : Pointer to LS header.
...
// To Remove LSA From Request List.
//
//    +node:  Node* : Pointer to node.
//    +list:  LinkedList* : Pointer to list.
//    +LSHeader:  Ospfv3LinkStateHeader* : Pointer to LS header.
...
// Compare body of two Router LSA for change.
//
...
// Compare body of two Network LSA for change.
//
...
// Compare body of two InterAreaPrefix LSA for change.
//
...
// Compare the body of two Inter Area Router LSA.
//
...
// Compare the body of two External LSA.
//
//    +newLSHeader:  Ospfv3LinkStateHeader* : Pointer to New Link State Header.
//    +oldLSHeader:  Ospfv3LinkStateHeader* : Pointer to Old Link State Header.
//
...
// Compare the body of Two link LSA.
//
...
// Compare the body of an LSA with the already existing LSA.
//
...
// Check contents of two LSA for any mismatch. This is used
...
// Assign newLSA address into the LSOrigin which previously
...
// Handle Link State Request packet.
//
//    +node:  Node* : Pointer to Node.
//    +msg: Message* : Pointer to Message.
//    +neighborId: unsigned int : Neighbor Id.
...
// To verify for any neighbor to be in Exchange/Loading state.
//
//    +node:  Node* : Pointer to Node.
//    +interfaceId: int : Interface Id.
//
...
// To Check for Intra Area Prefix LSA Validity.
//
//    +node:  Node* : Pointer to Node.
...
// To Update node's LSDB for received LSA.
//
//    +node:  Node* : Pointer to Node.
//    +LSA:  char* : Pointer to LSA.
//    +neighborId:  unsigned int : Neighbor Id.
...
// To Send Direct Ack to a neighbor.
//
//    +node:  Node* : Pointer to Node.
...
// To Check whether requested LSA(s) has been received.
//
...
// To Handle received Update packet.
//
//    +node:  Node* : Pointer to Node.
//    +msg: Message* : Pointer to Message.
//    +sourceAddr: in6_addr : Source Address.
...
// To Remove the LSA being acknowledged
