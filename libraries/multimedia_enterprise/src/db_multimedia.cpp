                                             ...
                                             NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfNeighborStateTableDef.size(); i++)
    {
                                         ...
                                         NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfRouterLsaTableDef.size(); i++)
    {
                                          ...
                                          NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfNetworkLsaTableDef.size(); i++)
    {
                                          ...
                                          NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfSummaryLsaTableDef.size(); i++)
    {
                                           ...
                                           NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfExternalLsaTableDef.size(); i++)
    {
                                              ...
                                              NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfInterfaceStateTableDef.size(); i++)
    {
                                       ...
                                       NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfSummaryTableDef.size(); i++)
    {
                                         ...
                                         NodeInput* nodeInput)
{
    ...
    for (size_t i = 0; i < db->statsOspfTable->ospfAggregateTableDef.size(); i++)
    {
    ...
    StatsDbOspfStats* stats)
{
    ...
    int nrow;
    int ncol;
    int expectedCol = (int)db->statsOspfTable->ospfAggregateTableDef.size() - 1;
    size_t index = db->statsOspfTable->ospfAggregateTableDef.size();

    for (size_t i = 1;
         i < db->statsOspfTable->ospfAggregateTableDef.size();
         i++)
    {
       columns.push_back(db->statsOspfTable->ospfAggregateTableDef[i].first);
    }
    ...
    std::string out = Select(db, "OSPF_Aggregate", columns, qualifierColumns, qualifierValues);
    ...
    else
    {
        ...
        stats->offeredLoad += atof(resultp[index-1]);
                                            ...
                                            const StatsDbOspfStats & stats)
{
    ...
    columns.push_back("OfferedLoad");
    values.push_back(STATSDB_DoubleToString(stats.offeredLoad));
    columns.push_back("LSUpdateSent");
    values.push_back(STATSDB_Int64ToString(stats.numLSUpdateSent));
    columns.push_back("LSUpdateRecv");
    values.push_back(STATSDB_Int64ToString(stats.numLSUpdateRecv));
    columns.push_back("LSUpdateBytesSent");
    values.push_back(STATSDB_Int64ToString(stats.numLSUpdateBytesSent));
    columns.push_back("LSUpdateBytesRecv");
    values.push_back(STATSDB_Int64ToString(stats.numLSUpdateBytesRecv));

    columns.push_back("AckSent");
    values.push_back(STATSDB_Int64ToString(stats.numAckSent));
    columns.push_back("AckRecv");
    values.push_back(STATSDB_Int64ToString(stats.numAckRecv));
    columns.push_back("AckBytesSent");
    values.push_back(STATSDB_Int64ToString(stats.numAckBytesSent));
    columns.push_back("AckBytesRecv");
    values.push_back(STATSDB_Int64ToString(stats.numAckBytesRecv));

    columns.push_back("DDPktSent");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktSent));
    columns.push_back("DDPktRecv");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktRecv));
    columns.push_back("DDPktBytesSent");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktBytesSent));
    columns.push_back("DDPktBytesRecv");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktBytesRecv));
    columns.push_back("DDPktRxmt");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktRxmt));
    columns.push_back("DDPktBytesRxmt");
    values.push_back(STATSDB_Int64ToString(stats.numDDPktBytesRxmt));

    columns.push_back("LSReqSent");
    values.push_back(STATSDB_Int64ToString(stats.numLSReqSent));
    columns.push_back("LSReqRecv");
    values.push_back(STATSDB_Int64ToString(stats.numLSReqRecv));
    columns.push_back("LSReqBytesSent");
    values.push_back(STATSDB_Int64ToString(stats.numLSReqBytesSent));
    columns.push_back("LSReqBytesRecv");
    values.push_back(STATSDB_Int64ToString(stats.numLSReqBytesRecv));
    columns.push_back("LSReqRxmt");
    values.push_back(STATSDB_Int64ToString(stats.numLSReqRxmt));

    qualifiersColumns.push_back("Timestamp");
    qualifiersValues.push_back(STATSDB_DoubleToString(
        (double) node->getNodeTime() / SECOND));

    IncrementValues(db, "OSPF_Aggregate", columns, values,
