...
// Constructor of the SipData class
//
// \param hostType  host type of the node
//
...
// Destructor of the SipData class
//
//
SipData :: ~SipData()
{
...
// print node details read from the alias file
//
...
// Read statistics related configuration data
//
// \param node  Pointer to the node
// \param nodeInput  Pointer to the input config data
//
...
// Allocate the next block for storage of alias data
//
//
...
// Insert a node into a HostBlock(External Interface 1)
//
// \param pHost  Pointer to sip node
//
...
// Read hostIp from the hostAlias name(External Interface 2)
//
...
// Read relevant details from the input config
// file supplied as nodeinput
//
// \param node  Pointer to the node
// \param nodeInput  Input config file
//
...
// Read the input domain name file for domain details
//
// \param node  Pointer to the node
// \param nodeInput  Input config file
//
...
// Print DNS information read from the input DNS file
//
// \param node  Pointer to the node
//
...
// Read the input alias file for UA node
//
// \param node  Pointer to the node
// \param nodeInput  Input config file
//
...
// Read the alias file for Proxy node
//
// \param node  Pointer to the node
// \param nodeInput  Input config file
//
...
// Insert a sip message into the list
//
...
//
// \param connectionId  TCP connection Id
//
...
// Get the mirror connction Id for a node
//
// \param connectionId  TCP connection Id
//
// \return mirror connection Id
...
// search for a sip message in the list
//
// \param connectionId  TCP connection Id
//
// \return Pointer to returned sip message
...
// search for a sip message in the list
//
// \param newSipMsg  Pointer to sip message
//
// \return Pointer to sip message
...
//
// \param noOfCell  Number of cells in the generator
// \param ruleVector  Rule vector pointer to be passed
// \param seedState  State of the seed
// \param node  Pointer to the node
//
...
//
// \param size  size of the generated number
// \param bin  input binary number
//
// \return decimal number required
...
// Get Destination Proxy Ip address
//
