...
/// value of rule index1 for random no generation
#define RULE_IDX1                               17

/// value of rule index2 for random no generation
#define RULE_IDX2                               31

/// Rule vector1 value for CA size 32
#define RULE_VECTOR_VAL1                        90

/// Rule vector2 value for CA size 32
#define RULE_VECTOR_VAL2                        150

/// Number of bits of the generated output
#define CA_SIZE                                 32

/// Multiplier used for getting short values
#define RAND_MULT                               1000

/// Circular buffer size used for SIP
#define SIP_CIR_BUF_SIZE                        2048


/// structure to hold details of a sip node
struct SipHostNode
{
    unsigned hostId;
    unsigned hostIp;
...
/// structure for holding a block of sip nodes
struct SipHostBlock
{
...
/// structure holding a linked list of sipnode blocks
...
/// structure for recording the sip statistics
struct SipStat
{
    // UAC part
...
/// Type of transport layer protocol used by sip
...
/// Main Protocol Data structure required at each node
class SipData
{
