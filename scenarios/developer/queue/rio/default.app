...
FTP/GENERIC 1 4 0 1000 0S 0S
FTP/GENERIC 2 4 0 1000 0S 0S

#FTP 1 2 10 0S
#CBR 1 3 10 1024 1S 1S 600S 
#CBR 1 3 10 1024 1S 1S 600S 
#CBR 3 1 10 1024 1S 0S 600S 
#CBR 1 2 10 1460 1S 0S 600S
#FTP/GENERIC 1 2 3 512 10 150S
#FTP 1 2 10 0.000000000000000US
#TELNET 3 4 10S 150S
#CBR 2 4 10 512   1US    0.000000000000000US 150S PRECEDENCE 1
#CBR 1 2 10 512   1US    0.000000000000000US 150S PRECEDENCE 0
#CBR 2 4 10 512   1US    0.000000000000000US 150S PRECEDENCE 2

#FTP/GENERIC 1 2 0 512 0.1S 15S PRECEDENCE 1
#FTP/GENERIC 1 2 0 512 50.1S 65S PRECEDENCE 1
#FTP/GENERIC 1 2 0 512 100.1S 115S PRECEDENCE 1

#CBR 1 2 0 512   1S    0.000000000000000US 150S PRECEDENCE 2

#CBR 1 2 1000 512   1.67US    0.100000000000000US 10S PRECEDENCE 1
#CBR 1 2 1000 512   2.5US    0.200000000000000US 10S PRECEDENCE 2
...
#CBR  1 3 1000 512  .01S   7S 1000S
#CBR  3 1 1000 512  .01S   7S 1000S DSCP 12
#CBR 1 2 1000 512  .01S   7S 1000S DSCP 14


#CBR  1 2 1000 512  .01S   7S 1000S 
#CBR  1 3 1000 512  .01S   7S 1000S PRECEDENCE 1
#CBR  1 3 1000 512  .01S   7S 1000S PRECEDENCE 2
#CBR 5 4 1000 512  .01S   7S 1000S
#CBR 1 3 100 512  .01S   7S 1000S PRECEDENCE 0
#CBR 1 3 100 512  .01S   7S 1000S PRECEDENCE 1
#CBR 1 3 100 512  .01S   7S 1000S PRECEDENCE 2
# ---------------------------------------------------------------
...
#
#  To use MGEN, input for the first line
#      must be given in the following format :
#
#      mgen <nodeId> [<IP_version>] <input> <script_file> [txlog]
#                  [output <log_file>] [log <log_file>]
#
#  The successive lines specify whether a node(Receiving node) is mgen
#      enabled or not in the following format :
#
#      mgen <nodeId> [<IP_version>]
#
#
#   where,
#
#      nodeId = NodeId of the multi generator.
#      <IP_version> = ipv4 | ipv6
#      input = Keyword preceding the input driver script file.
#      <script_file> = Script file, conventionally is given suffix of "mgn"
#      txlog = For logging transmission events.
#      output = To log receive events, is followed by the log file name.
#      <log_file> = log file, conventionally is given the extension "drc"
#      log =  To log the receive events, is followed by the log file name.
#      <log_file> = log file, conventionally is given the extension "drc"
#
#
#   Note : 1. There is only one generating node.
#          2. Only the first line contains input in the above format,
#             and the node in the first line is the sending node.
#          3. Rest lines only serve to specify the mgen enabled receivers.
#          4. Currently only IP version 4 is supported.
#          5. Logging of data is optional.
#
#
#  EXAMPLE:
#
