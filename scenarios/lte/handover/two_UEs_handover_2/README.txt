...
PURPOSE:-
-------
To test the case of simultaneous handover of two UEs.
An UE move from an eNB to another using same channel.
Those two moves to the opposite direction.

SCENARIO:-
---------
One LTE subnet is present in the scenario, having two base stations (eNodeBs) 
and two user equipments (UEs). Nodes 4 and 6 are the UEs. Node 2 and 3 are eNodeBs.
