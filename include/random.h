...
/// \defgroup Package_RANDOM_NUMBERS RANDOM NUMBERS

/// \file
/// \ingroup Package_RANDOM_NUMBERS
...
/// Chooses from a set of pre-defined independent random seeds.
/// The parameter names here are recommend invariants for use
/// in selecting seeds, but other values could be used instead.
///
/// \param seed  the seed to be set.
/// \param globalSeed  the scenario's global seed, i.e. SEED in the
///    .config file, stored in node->globalSeed.
/// \param nodeId  the node's ID
/// \param protocolId  the protocol number, as defined in the layer
///    header files (e.g. MAC_PROTOCOL_CSMA in mac.h)
/// \param instanceId  the instance of this protocol, often the
///    interfaceIndex.
...
///
/// \param seed  the seed for this random stream.
///
...
///
/// \param nodeInput  the .config file
void RANDOM_LoadUserDistributions(const NodeInput* nodeInput);

/// a template class for generating various types of random
