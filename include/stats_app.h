...
/// \defgroup Package_STATS_APP STATS_APP

/// \file
/// \ingroup Package_STATS_APP
/// This file describes Application Layer stats
...
typedef struct intervalBased_AggregatedMCR
{
    STAT_AggregatedSumVariant m_IntervalBasedMessagesSent;
    STAT_AggregatedSumVariant m_IntervalBasedAggregatedEffectiveMessagesSent;
    STAT_AggregatedSumVariant m_IntervalBasedMessagesReceived;
    STAT_AggregatedAverageVariant m_IntervalBasedAverageDelay;
}AggregatedMCR_Contents_Stats;
...
/// Implements a common application layer statistics class.
...
protected:
    ...
    // Id that uniquely determines an application within a node
    Int32 m_UniqueId;
...
protected:
    ...
    STAT_AggregatedWeightedDataPointAverage m_IntervalBasedAverageDelay;
    ...
    AggregatedMCR_Contents_Stats* mcrStats;

    friend class STAT_GlobalAppStatistics;

public:
    STAT_GlobalAppAddressStatistics()
    {
        mcrStats = NULL;
    }
    AggregatedMCR_Contents_Stats* GetMcrStats()
    {
        return mcrStats;
    }
...
/// Implements global application aggregated statistics.
...
public:
    ...
    STAT_AggregatedSum& GetMessagesSent(STAT_DestAddressType type)
        { return m_AddrStats[type].m_MessagesSent; }
    STAT_AggregatedSumVariant& GetIntervalBasedMessagesSent(STAT_DestAddressType type, Int64 intervalIndex)
        { return m_AddrStats[type].mcrStats[intervalIndex].m_IntervalBasedMessagesSent; }
    STAT_AggregatedSum& GetMessagesReceived(STAT_DestAddressType type)
        { return m_AddrStats[type].m_MessagesReceived; }
    STAT_AggregatedSumVariant& GetIntervalBasedMessagesReceived(STAT_DestAddressType type, Int64 intervalIndex)
        { return m_AddrStats[type].mcrStats[intervalIndex].m_IntervalBasedMessagesReceived; }
    ...
    STAT_AggregatedWeightedDataPointAverage& GetAverageDelay(
        ...
        { return m_AddrStats[type].m_AverageDelay; }
    STAT_AggregatedAverageVariant& GetIntervalBasedAverageDelay(
        STAT_DestAddressType type, Int64 intervalIndex)
        { return m_AddrStats[type].mcrStats[intervalIndex].m_IntervalBasedAverageDelay; }
    ...
    STAT_AggregatedSumVariant &GetIntervalBasedAggregatedEffectiveMessagesSent(STAT_DestAddressType type, Int64 intervalIndex)
        { return m_AddrStats[type].mcrStats[intervalIndex].m_IntervalBasedAggregatedEffectiveMessagesSent; }
    ...
    STAT_GlobalAppAddressStatistics* GetAddrStats(STAT_DestAddressType type)
    {
        return &m_AddrStats[type];
    }
};
