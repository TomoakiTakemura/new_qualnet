...
/// \defgroup Package_CELLULAR CELLULAR

/// \file
/// \ingroup Package_CELLULAR
/// Defines the data structures used in all layers of the
/// cellualr model the data structure start with Cellular***.

#ifndef _CELLULAR_H_
#define _CELLULAR_H_

/// Enlisted different types of cellular nodes
typedef enum
{
    CELLULAR_MS=0,
    CELLULAR_BS=1,
