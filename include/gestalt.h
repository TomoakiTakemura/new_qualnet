...
namespace UTIL { namespace Gestalt {
    ...
    namespace Support
    {
        ...
        inline bool supports(std::string attr)
        {
        ...
        inline void add(std::string attr, std::string val)
        {
        ...
        inline void add(const NodeInput* nodeInput,
                        std::string attr,
                        std::string def)
        {
        ...
        inline Attribute& get(std::string attr)
        {
        ...
        inline void initialize(const NodeInput *nodeInput,
    ...
    inline bool get_b(std::string attr)
    {
    ...
    inline int get_i(std::string attr)
    {
        Support::Attribute& a = Support::get(attr);
    ...
    inline float get_f(std::string attr)
    {
        Support::Attribute& a = Support::get(attr);
    ...
    inline std::string get_s(std::string attr)
    {
        Support::Attribute& a = Support::get(attr);
