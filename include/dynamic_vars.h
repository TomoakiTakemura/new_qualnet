...
/// \defgroup Package_DYNAMIC-VARS DYNAMIC-VARS

/// \file
/// \ingroup Package_DYNAMIC-VARS
...
/// Implements a dynamically-enabled 4 byte integer
/// 
/// Variables
...
/// Implements a dynamically-enabled 4 byte unsigned integer
/// 
/// Variables
...
/// Implements a dynamically-enabled 8 byte integer
/// 
/// Variables
...
/// Implements a dynamically-enabled 4 byte floating-point
/// number
/// 
/// Variables
...
/// Implements a dynamically-enabled 8 byte floating-point
/// number
/// 
/// Variables
...
class D_StatisticObj : public D_Variable
{
    private:
        D_Statistic* value;

    public:
        D_StatisticObj(D_Statistic* newValue) : D_Variable(D_STATISTIC)
        {
            value = newValue;
#ifdef D_LISTENING_ENABLED
            value->SetObject(this);
...
/// Implements a dynamically-enabled 4 byte node
/// address
/// 
/// Variables
...
/// Implements a dynamically-enabled string
/// 
/// Variables
...
/// Implements a dynamically-enabled clocktype
/// 
/// Variables
