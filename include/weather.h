...
/// \defgroup Package_WEATHER WEATHER

/// \file
/// \ingroup Package_WEATHER
/// The Weather package includes functions for modeling
...
/// Specifies Horizontal or vertical Polarizations. 
/// 
...
/// Creates the weather patterns and starts
/// the mobility timer.
///
...
/// Processes a weather related event.
///
/// \param node  the first node in the partition
/// \param msg  an event
void WEATHER_ProcessEvent(Node*    node,
                          Message* msg);


/// Returns the combined pathloss for all weather systems
/// for a signal of interest.
///
/// \param partitionData  Contains the weather patterns.
/// \param point1  Position of the first node.
/// \param point2  Position of the second node.
/// \param channelIndex  index of the channel.
///
/// \return the combined pathloss due to weather for
