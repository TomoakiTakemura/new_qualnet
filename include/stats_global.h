...
/// Implements a map summarizer.  See the previous comment
...
/// Uniquely identifies either the sending and receiving
...
/// Uniquely identifies either the sending or receiving
/// side of a summary statistic.  Usable where there is 1
...
/// A simple class that holds all global statistics for all
/// layers.
///
...
/// Maintains all aggregated statistics.  All aggregated
    ...
    PartitionData* partition)
{
    ...
    PARALLEL_SynchronizePartitions(partition, BARRIER_TYPE_Summarize);
    ...
    PARALLEL_SynchronizePartitions(partition, BARRIER_TYPE_SummarizeBegin);
    ...
    PARALLEL_SynchronizePartitions(partition, BARRIER_TYPE_SummarizeEnd);
#endif
#endif
}
