...
/// Implements a key for a transport session.  A session
...
/// Implements statistics for one address type.  This is used
...
/// Implements statistics for a transport session.  A session
/// is defined as statistics between (source addr, source
/// port) and (dest addr, dest port) pairs.
...
/// Implements statistics for UDP or TCP.
...
/// Implements global transport aggregated statistics.
...
/// Implements statistics for one pair of (sourceAddr, sourcePort)
