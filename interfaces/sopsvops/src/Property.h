...
/// A property consists of a key string and a value. The key
...
/// The property manager maintains an associative container of 
...
/// Implements a callback function for changing states. The
