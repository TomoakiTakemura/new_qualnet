...
#if !defined(_WIN32)
// For Linux systems, returns the time of day in microseconds.
...
// Provide a common sleep call that is the same in both
...
// Split a string into a set of strings on a delimiter character.
//
