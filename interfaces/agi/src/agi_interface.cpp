    ...
    NodeInput *nodeInput)
{
    ...
    CAgiInterfaceUtil::StkVersion ver = CAgiInterfaceUtil::eStk11;

    if(retVal == TRUE)
    {
		if(strcmp(stkVer, "9") == 0)
		   ver = CAgiInterfaceUtil::eStk9;
		else if (strcmp(stkVer, "10") == 0)
			ver = CAgiInterfaceUtil::eStk10;
		else if (strcmp(stkVer, "11") == 0)
			ver = CAgiInterfaceUtil::eStk11;
	}
...
void AgiInterfaceFinalize(
    EXTERNAL_Interface *iface,
    NodeInput *nodeInput)
{
    CAgiInterfaceUtil::GetInstance().Shutdown();
}
